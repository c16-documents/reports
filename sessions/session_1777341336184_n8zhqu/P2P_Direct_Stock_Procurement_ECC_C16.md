  Direct / Stock Procurement — ECC Process Reference & C16 Value Map :root { --primary: #6B3FA0; --secondary: #B5567A; --accent: #C97B3A; --dark: #2c3e50; --light-bg: #f8f9fa; --white: #ffffff; --success: #27ae60; --warning: #e67e22; --danger: #e74c3c; --info: #3498db; } \* { margin: 0; padding: 0; box-sizing: border-box; } body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: var(--dark); background: #e9ecef; line-height: 1.7; } .doc-wrapper { max-width: 1140px; margin: 30px auto; background: var(--white); box-shadow: 0 4px 24px rgba(0,0,0,0.10); border-radius: 12px; overflow: hidden; } /\* Header Banner \*/ .header-banner { background: linear-gradient(135deg, #C97B3A, #B5567A, #6B3FA0); color: white; padding: 48px 50px 40px; position: relative; overflow: hidden; } .header-banner::after { content: ''; position: absolute; top: -60px; right: -60px; width: 250px; height: 250px; border-radius: 50%; background: rgba(255,255,255,0.06); } .header-banner h1 { font-size: 2.2em; font-weight: 700; margin-bottom: 8px; position: relative; z-index: 1; } .header-banner .subtitle { font-size: 1.15em; opacity: 0.92; margin-bottom: 16px; position: relative; z-index: 1; } .header-badge { display: inline-block; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.35); padding: 4px 16px; border-radius: 20px; font-size: 0.85em; margin-right: 10px; } .header-logo { height: 50px; margin-bottom: 14px; border-radius: 8px; display: block; } /\* Meta Bar \*/ .meta-bar { display: flex; flex-wrap: wrap; gap: 24px; padding: 18px 50px; background: #f4f0f8; border-bottom: 2px solid #e8e0f0; font-size: 0.92em; } .meta-item { display: flex; align-items: center; gap: 6px; } .meta-label { font-weight: 600; color: var(--primary); } /\* TOC \*/ .toc { padding: 30px 50px; background: var(--light-bg); border-bottom: 1px solid #e0e0e0; } .toc h2 { font-size: 1.3em; color: var(--primary); margin-bottom: 14px; } .toc-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px 30px; } .toc a { color: var(--dark); text-decoration: none; font-size: 0.93em; padding: 4px 0; border-bottom: 1px dashed #ccc; transition: all 0.2s; } .toc a:hover { color: var(--primary); border-bottom-color: var(--primary); } .toc a .toc-num { color: var(--secondary); font-weight: 700; margin-right: 8px; } /\* Sections \*/ .section { padding: 36px 50px; border-bottom: 1px solid #f0f0f0; } .section:last-child { border-bottom: none; } .section-title { font-size: 1.45em; color: var(--primary); margin-bottom: 20px; padding-bottom: 10px; border-bottom: 3px solid var(--secondary); display: flex; align-items: center; gap: 12px; } .section-num { display: inline-flex; align-items: center; justify-content: center; width: 34px; height: 34px; border-radius: 50%; background: var(--secondary); color: white; font-size: 0.8em; font-weight: 700; flex-shrink: 0; } /\* KPI Cards \*/ .kpi-row { display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 16px; margin: 20px 0; } .kpi-card { background: linear-gradient(135deg, #f8f4fc, #f0e8f5); border-left: 4px solid var(--primary); border-radius: 8px; padding: 18px 20px; text-align: center; } .kpi-value { font-size: 2em; font-weight: 800; color: var(--primary); } .kpi-label { font-size: 0.85em; color: #666; margin-top: 4px; } /\* Tables \*/ table { width: 100%; border-collapse: collapse; margin: 16px 0; font-size: 0.92em; } thead th { background: var(--primary); color: white; padding: 12px 14px; text-align: left; font-weight: 600; font-size: 0.9em; text-transform: uppercase; letter-spacing: 0.3px; } tbody td { padding: 10px 14px; border-bottom: 1px solid #eee; vertical-align: top; } tbody tr:nth-child(even) { background: #f8fafc; } tbody tr:hover { background: #edf2f7; } /\* Swim Lane Diagram Container \*/ .diagram-container { background: #fdfcff; border: 2px solid #e8e0f0; border-radius: 10px; padding: 24px; margin: 20px 0; overflow-x: auto; } .diagram-title { font-weight: 700; color: var(--primary); font-size: 1.05em; margin-bottom: 12px; display: flex; align-items: center; gap: 8px; } /\* C16 Overlay Callouts \*/ .c16-callout { background: linear-gradient(135deg, #f0e6f6, #e8f4fd); border-left: 4px solid var(--primary); border-radius: 8px; padding: 16px 20px; margin: 14px 0; display: flex; align-items: flex-start; gap: 12px; } .c16-icon { width: 36px; height: 36px; border-radius: 50%; background: var(--primary); color: white; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 0.85em; flex-shrink: 0; } .c16-callout-title { font-weight: 700; color: var(--primary); margin-bottom: 4px; } .c16-callout-body { font-size: 0.92em; color: #444; } /\* RACI \*/ .raci-r { background: #e8f5e9; color: #2e7d32; font-weight: 700; text-align: center; border-radius: 4px; padding: 2px 8px; } .raci-a { background: #e3f2fd; color: #1565c0; font-weight: 700; text-align: center; border-radius: 4px; padding: 2px 8px; } .raci-c { background: #fff3e0; color: #e65100; font-weight: 700; text-align: center; border-radius: 4px; padding: 2px 8px; } .raci-i { background: #f3e5f5; color: #7b1fa2; font-weight: 700; text-align: center; border-radius: 4px; padding: 2px 8px; } /\* Phase Headers \*/ .phase-header { background: linear-gradient(135deg, var(--primary), var(--secondary)); color: white; padding: 14px 24px; border-radius: 8px; margin: 24px 0 16px; font-size: 1.1em; font-weight: 700; } .phase-header .phase-num { opacity: 0.7; margin-right: 8px; } /\* Disclaimer \*/ .disclaimer-box { background: #fff8e1; border: 1px solid #ffcc02; border-left: 5px solid #f9a825; border-radius: 8px; padding: 20px 24px; margin: 20px 0; } .disclaimer-box h4 { color: #f57f17; margin-bottom: 8px; } .disclaimer-box p, .disclaimer-box li { font-size: 0.88em; color: #5d4037; margin-bottom: 4px; } /\* Control Tags \*/ .ctrl-tag { display: inline-block; padding: 2px 10px; border-radius: 12px; font-size: 0.78em; font-weight: 600; margin: 2px 2px; } .ctrl-sod { background: #fce4ec; color: #c62828; } .ctrl-match { background: #e8f5e9; color: #2e7d32; } .ctrl-approve { background: #e3f2fd; color: #1565c0; } .ctrl-tolerance { background: #fff3e0; color: #e65100; } .ctrl-master { background: #f3e5f5; color: #7b1fa2; } /\* Exec Summary \*/ .exec-summary { border-left: 5px solid var(--success); background: #f6fef9; padding: 20px 24px; border-radius: 0 8px 8px 0; margin: 16px 0; } /\* Footer \*/ .doc-footer { background: #2c2c3e; color: #aaa; padding: 30px 50px; font-size: 0.82em; border-radius: 0 0 12px 12px; } .doc-footer a { color: #B5567A; } /\* Print \*/ @media print { body { background: white; } .doc-wrapper { box-shadow: none; margin: 0; } .header-banner { -webkit-print-color-adjust: exact; print-color-adjust: exact; } .section { page-break-inside: avoid; } } /\* Responsive \*/ @media (max-width: 768px) { .section, .header-banner, .meta-bar, .toc { padding-left: 24px; padding-right: 24px; } .toc-grid { grid-template-columns: 1fr; } .kpi-row { grid-template-columns: 1fr 1fr; } } :root{--c16-purple-1:#6B3FA0;--c16-purple-2:#8B5CF6;--c16-ink:#1f2937;--c16-sub:#4b5563;--c16-rule:#e5e7eb;--c16-accent:#faf5ff;}
...
ECC Process Reference & C16 Value Map — Procure-to-Pay (P2P)

📦 SAP ECC 6.0 🔄 L2: Direct Procurement 📄 April 2026 🔗 C16 + Tricentis Synergy

Platform: SAP ECC 6.0 (EhP 7/8)

Module: MM (Materials Management)

Process Level: L2 — Direct / Stock Procurement

Activities: 14 L4 Activities

Transactions: 12 SAP Tcodes

## 📑 Table of Contents

[01 Executive Summary](#exec-summary) [02 Process Scope & KPIs](#process-scope) [03 End-to-End BPMN Diagram](#bpmn-overview) [04 Phase 1 — Demand & MRP Planning](#phase-plan) [05 Phase 2 — Sourcing & PO Creation](#phase-source) [06 Phase 3 — Goods Receipt & Stock](#phase-receive) [07 Phase 4 — Invoice Verification & Payment](#phase-invoice) [08 L3/L4 Activity Breakdown](#activity-detail) [09 RACI Matrix](#raci) [10 Key Controls & Compliance Points](#key-controls) [11 C16 Value Overlay — Intelligence at Every Stage](#c16-overlay) [12 C16 + Tricentis Synergy Map](#tricentis-synergy) [13 Disclaimers & Limitations](#disclaimers)

## 1 Executive Summary

**Direct / Stock Procurement** is the backbone of any manufacturing or distribution SAP ECC landscape. It covers the complete cycle from demand identification through MRP, purchase requisition creation, purchase order processing, goods receipt, and invoice verification — ultimately ending with vendor payment via the F110 payment run.

This document serves a **dual purpose**:

*   **Process Reference** — A structured L2→L4 decomposition with BPMN-style flow diagrams, RACI assignments, SAP transaction mappings, and key controls. Designed for functional consultants, process owners, and testing teams.
*   **C16 Value Map** — At each process stage, we overlay where C16's AI-driven SAP mining capabilities can detect gaps, anomalies, and optimization opportunities — and how these findings directly feed Tricentis Tosca test case design.
...
Stock materials (direct procurement for production & maintenance)

Service procurement, consignment, subcontracting, intercompany STO

**Org Levels**

Purchasing Organization, Plant, Storage Location, Company Code

Central purchasing (S/4 only), multi-system procurement

**Document Flow**

PR → PO → GR → Invoice → Payment

Returns (122/161), subsequent debits/credits, evaluated receipt settlement (ERS)

**Planning**

MRP-driven demand, manual PR creation

Demand-driven MRP (ddMRP), APO/IBP integration

**System**

SAP ECC 6.0 (EhP 7 or 8), classic GUI transactions

S/4HANA Fiori apps, SAP Ariba, SAP Fieldglass
...
EBAN.ERDAT → EKKO.AEDAT

**PO Release Turnaround**

Days from PO creation to final release

≤ 2 business days

EKKO.BEDAT → CDHDR (release timestamp)

**GR On-Time Rate**

% of GR posted within ±2 days of PO delivery date

≥ 90%

EKPO.EINDT vs EKBE.BUDAT

**Invoice Match Rate**

% of invoices auto-matched (no manual intervention)

≥ 85%

RBKP.RBSTAT = 5 (posted) vs total

**On-Time Payment Rate**

% of payments within agreed terms

≥ 95%

BSIK.ZBD1T vs BSAK.AUGDT

**Maverick Buying Rate**

% of POs created without prior PR/contract

≤ 5%

EKKO where BANFN is empty AND no outline agreement

## 3 End-to-End BPMN Diagram

The following diagram shows the complete Direct/Stock Procurement flow across four organizational swim lanes. Decision gateways (◇) represent approval and matching checkpoints.

🗺️ Direct / Stock Procurement — End-to-End Process Flow (ECC)

flowchart TB subgraph PLAN\["🏭 PHASE 1 — DEMAND & MRP PLANNING"\] direction LR A1(\[🟢 Start: Demand Identified\]) --> A2\[MRP Run  
MD01 / MD02\] A2 --> A3{MRP Exception  
Messages?} A3 -->|Yes — Shortfall| A4\[Review Stock/Demand  
MD04 / MMBE\] A3 -->|No Exceptions| A5\[No Action Required\] A4 --> A6\[Convert Planned Order  
to Purchase Requisition  
MD04 → ME51N\] A4 --> A7\[Create PR Manually  
ME51N\] end subgraph SOURCE\["🛒 PHASE 2 — SOURCING & PO CREATION"\] direction LR B1\[Assign Source of Supply  
ME56 / ME57\] --> B2\[Create Purchase Order  
ME21N\] B2 --> B3{Release Strategy  
Required?} B3 -->|Yes| B4\[PO Release Approval  
ME29N / ME28\] B3 -->|No| B5\[PO Transmitted to Vendor\] B4 --> B5 B5 --> B6\[Print / EDI / Email  
Output to Vendor  
ME9F\] end subgraph RECEIVE\["📦 PHASE 3 — GOODS RECEIPT"\] direction LR C1\[Receive Goods at Dock\] --> C2\[Post Goods Receipt  
MIGO — Mvt 101\] C2 --> C3{QM Inspection  
Required?} C3 -->|Yes| C4\[Stock → QI  
Usage Decision QA11\] C3 -->|No| C5\[Stock → Unrestricted\] C4 --> C5 C5 --> C6\[Material Document  
\+ Accounting Document Created\] end subgraph INVOICE\["💰 PHASE 4 — INVOICE & PAYMENT"\] direction LR D1\[Receive Vendor Invoice\] --> D2\[Post Invoice  
MIRO\] D2 --> D3{3-Way Match  
PO / GR / Invoice} D3 -->|Within Tolerance| D4\[Invoice Posted  
FI Document Created\] D3 -->|Variance| D5\[Invoice Blocked  
MRBR for Review\] D5 --> D6\[Release Blocked Invoice  
MRBR\] D6 --> D4 D4 --> D7\[Payment Run  
F110\] D7 --> D8(\[🔴 End: Payment to Vendor\]) end A6 --> B1 A7 --> B1 B6 --> C1 C6 --> D1 style PLAN fill:#f0f7ff,stroke:#3498db,stroke-width:2px style SOURCE fill:#f0fff0,stroke:#27ae60,stroke-width:2px style RECEIVE fill:#fff8f0,stroke:#e67e22,stroke-width:2px style INVOICE fill:#fdf0ff,stroke:#8e44ad,stroke-width:2px

C16

C16 Insight — Full Cycle Visibility

C16 mines across **all four phases simultaneously** — detecting upstream causes of downstream failures. For example, a blocked invoice in Phase 4 might trace back to an incorrect info record in Phase 2 or a partial GR in Phase 3. C16 connects these dots automatically.

## 4 Phase 1 — Demand & MRP Planning

PHASE 1 From Demand Signal to Purchase Requisition

📊 Phase 1 — Detailed Process Flow

flowchart LR subgraph Planner\["👤 Production Planner / MRP Controller"\] P1\[Review Demand  
Independent Reqts MD61  
or Dependent Reqts\] --> P2\[Execute MRP Run  
MD01 Single / MD02 Multi\] P2 --> P3\[Review Exception Messages  
MD04 — Stock/Reqts List\] P3 --> P4{Action  
Required?} P4 -->|Planned Order Exists| P5\[Convert Planned Order → PR  
MD04 or ME59\] P4 -->|Manual Need| P6\[Create PR Manually  
ME51N\] P4 -->|Adjust Plan| P7\[Reschedule / Cancel  
Planned Order\] end subgraph Master\["📋 Master Data Prerequisites"\] M1\[Material Master  
MRP Views: MM01/MM02\] M2\[BOM Explosion  
CS01/CS03\] M3\[Source List  
ME01/ME03\] end Master -.->|Drives| Planner style Planner fill:#f0f7ff,stroke:#3498db,stroke-width:2px style Master fill:#f8f8f8,stroke:#999,stroke-width:1px
...
Material Requirements Planning run at plant or single-material level. Explodes BOMs, checks stock, generates planned orders.

Processing Key (NETCH/NEUPL), Planning Mode (1/2/3), Schedule Lines, Firming parameters

**Review Exception Messages**

MD04

Stock/Requirements List showing planned orders, MRP exception messages, current stock situation.

Exception groups, rescheduling proposals, coverage days

**Review Stock Situation**

MMBE / MB52

Check current stock levels across storage locations — unrestricted, QI, blocked, in-transit.

MARD-LABST, INSME, SPEME; MCHB (batch); MKOL (consignment)

**Convert Planned Order → PR**

MD04 / ME59

Convert MRP-generated planned orders into purchase requisitions for buyer action.

Auto-conversion via ME59 (batch), or manual via MD04 context menu

**Create PR Manually**

ME51N

Manual purchase requisition for ad-hoc needs not covered by MRP (e.g., maintenance spares, project materials).

Account assignment (K/F/P), item category, delivery date, requisitioner

C16

C16 Mining — Planning Phase

**What C16 detects:**  
• **Orphan PRs:** Purchase requisitions sitting unreleased or unconverted for 30+ days (EBAN where FRGKZ ≠ released and age > 30d)  
• **MRP Master Data Gaps:** Materials missing MRP views, missing source lists, or incomplete lot-size configuration  
• **Maverick Demand:** Manual PRs created outside MRP — indicates planning process bypass  
_→ Feeds Tricentis: Test scenarios for MRP exception handling, PR release workflow, and negative testing for missing master data._

## 5 Phase 2 — Sourcing & PO Creation

PHASE 2 From Purchase Requisition to Released Purchase Order

📊 Phase 2 — Detailed Process Flow

flowchart TB subgraph Buyer\["👤 Buyer / Purchasing Agent"\] S1\[Assign Source of Supply  
ME56 — Manual  
ME57 — Auto Assign\] --> S2\[Create PO from PR  
ME21N — Ref to Requisition\] S2 --> S3\[Maintain PO Details  
Pricing, Delivery, Tax\] S3 --> S4\[Save PO — Status: Created\] end subgraph Approver\["👤 Approver / Manager"\] S4 --> S5{Release Strategy  
Triggered?} S5 -->|Yes — Value/Category| S6\[Release PO  
ME29N Individual  
ME28 Collective\] S5 -->|No Release Needed| S7\[PO Released Automatically\] S6 --> S7 end subgraph Output\["📤 Output / Transmission"\] S7 --> S8\[Determine Output Type  
NEU — New PO\] S8 --> S9{Output  
Medium?} S9 -->|Print| S10\[Print PO  
ME9F\] S9 -->|EDI/IDoc| S11\[Transmit via ALE/EDI  
WE19/BD87\] S9 -->|Email| S12\[Email to Vendor  
NACE Config\] end style Buyer fill:#f0fff0,stroke:#27ae60,stroke-width:2px style Approver fill:#f0f7ff,stroke:#3498db,stroke-width:2px style Output fill:#f8f8f8,stroke:#999,stroke-width:1px
...
Assign vendor and purchasing info record to PRs. ME57 enables mass auto-assignment based on source list / quota arrangement.

Source list (ME01), Quota arrangement (MEQ1), Info record (ME11)

**Create Purchase Order**

ME21N

Create standard PO (type NB) with reference to PR. Pricing from info record, conditions from contract.

Doc type NB, Vendor, Purch Org, Company Code, Payment terms, Incoterms

**PO Release / Approval**

ME29N / ME28

Execute release strategy based on value thresholds, material groups, or account assignment. Multi-level approval supported.

Release group, Release strategy (T16FS), Release code, Release indicator (FRGKE)

**PO Output / Transmission**

ME9F / NACE

Transmit released PO to vendor via print, fax, email, or EDI/IDoc.

Output type NEU, Medium (1=Print, 5=EDI, 7=Email), Partner function (VN)

C16

C16 Mining — Sourcing Phase

**What C16 detects:**  
• **Unreleased POs:** POs stuck in release workflow for 5+ days — EKKO.FRGKE ≠ 'R' with aging analysis  
• **Release Strategy Gaps:** PO types or value ranges not covered by any release strategy in T16FS  
• **Price Variance:** PO net price deviating > 10% from info record (EINA/EINE) — potential contract violation  
• **Vendor Master Quality:** Vendors on POs with missing payment terms, incomplete bank details, or central blocks  
_→ Feeds Tricentis: Release workflow test paths (approve, reject, escalate), price condition test data, vendor block negative tests._

## 6 Phase 3 — Goods Receipt & Stock Posting

PHASE 3 From Dock Receipt to Stock Availability

📊 Phase 3 — Detailed Process Flow

flowchart LR subgraph Warehouse\["👤 Warehouse / Stores Clerk"\] G1\[Receive Goods at Dock  
Physical Inspection\] --> G2\[Post GR with Ref to PO  
MIGO — Mvt Type 101\] G2 --> G3{Quantity  
Tolerance OK?} G3 -->|Within Tolerance| G4\[GR Posted Successfully\] G3 -->|Over-delivery| G5\[GR Blocked or Partial  
Based on EKPO.UEBTK\] end subgraph QM\["🔬 Quality (if applicable)"\] G4 --> G6{QM Inspection  
Lot Created?} G6 -->|Yes| G7\[Stock in QI  
Usage Decision QA11\] G6 -->|No| G8\[Stock → Unrestricted ✅\] G7 -->|Accept| G8 G7 -->|Reject| G9\[Stock → Blocked / Return\] end subgraph Accounting\["📗 Auto-Generated"\] G4 --> G10\[Material Document  
MKPF / MSEG\] G4 --> G11\[Accounting Document  
GR/IR Clearing Acct\] end style Warehouse fill:#fff8f0,stroke:#e67e22,stroke-width:2px style QM fill:#fff0f0,stroke:#e74c3c,stroke-width:1px style Accounting fill:#f0fff0,stroke:#27ae60,stroke-width:1px
...
Post GR with reference to PO. Creates material document + accounting document (GR/IR clearing). Updates PO history (EKBE).

Movement type 101, PO reference, Batch (if managed), SLoc, Delivery note

**Handle Over/Under Delivery**

MIGO

System checks tolerance from EKPO (over-delivery tolerance UEBTK, under-delivery tolerance UNTTO). Blocks or warns.

EKPO-UEBTK (over %), EKPO-UNTTO (under %), Delivery Completed indicator

**QM Inspection (if active)**

QA11 / QA32

If QM procurement key is set in material master, GR creates inspection lot. Usage decision determines stock disposition.

Inspection type 01 (GR insp), Inspection lot status, Valuation result

**GR Reversal (if needed)**

MIGO (Mvt 102)

Reverse incorrect GR posting. Creates offsetting material + accounting document.

Reference to original material document, Reversal reason code

C16

C16 Mining — Goods Receipt Phase

**What C16 detects:**  
• **GR/IR Imbalance:** PO line items where GR quantity ≠ IR quantity (EKBE with BEWTP = 'E' vs 'Q') — aging GR/IR clearing account  
• **Over-Delivery Patterns:** Vendors consistently delivering > 100% — tolerance settings may be too loose  
• **GR Timing Gaps:** POs with delivery date passed but no GR posted — supply chain risk  
• **Reversal Rate:** High GR reversal (102) rate indicates receiving process issues  
_→ Feeds Tricentis: GR tolerance boundary tests, QM inspection workflow paths, GR reversal regression tests._

## 7 Phase 4 — Invoice Verification & Payment

PHASE 4 From Vendor Invoice to Payment Execution

📊 Phase 4 — Detailed Process Flow

flowchart TB subgraph AP\["👤 AP Specialist"\] I1\[Receive Vendor Invoice  
Paper / EDI / Email\] --> I2\[Enter Invoice in MIRO  
with PO Reference\] I2 --> I3{3-Way Match  
PO ↔ GR ↔ Invoice} I3 -->|Match OK  
Within Tolerance| I4\[Invoice Posted ✅  
FI Document Created\] I3 -->|Price Variance| I5\[Blocked: Price  
Tolerance Exceeded\] I3 -->|Qty Variance| I6\[Blocked: Quantity  
Mismatch\] I5 --> I7\[Review & Release  
Blocked Invoice — MRBR\] I6 --> I7 I7 --> I4 end subgraph Payment\["💳 Payment Processing"\] I4 --> P1\[Open Item in BSIK  
Vendor Line Item\] P1 --> P2\[Payment Run  
F110 — Parameters\] P2 --> P3{Payment  
Method?} P3 -->|Wire / ACH| P4\[Bank Transfer  
via DME File\] P3 -->|Check| P5\[Print Payment Check  
F110 Printout\] P4 --> P6\[Payment Clearing ✅  
Item moves BSIK → BSAK\] P5 --> P6 end style AP fill:#fdf0ff,stroke:#8e44ad,stroke-width:2px style Payment fill:#f0f7ff,stroke:#3498db,stroke-width:1px
...
**Post Invoice (Logistics)**

MIRO

Enter vendor invoice with reference to PO. System performs 3-way match (PO price × GR quantity vs invoice amount).

Invoice type (RE=invoice, KG=credit memo), Tax code, Baseline date, Payment terms

**Handle Blocked Invoices**

MRBR

Review and release invoices blocked due to price/quantity variance, manual block, or stochastic block.

Block reason (price, qty, manual, random), Variance amount, Tolerance keys (T169G)

**Payment Run**

F110

Automatic payment program — selects open vendor items by due date, payment method, and company code. Generates DME or checks.

Run date, Payment method (T/C/S), House bank, Grouping criteria, Next payment date

**Payment Clearing**

F110 (auto)

Successful payment clears the vendor open item — moves from BSIK (open) to BSAK (cleared).

Clearing document number, Clearing date, Payment reference

C16

C16 Mining — Invoice & Payment Phase

**What C16 detects:**  
• **Blocked Invoice Aging:** Invoices blocked in MRBR for 15+ days — cash flow risk and vendor relationship damage  
• **3-Way Match Failure Rate:** % of invoices failing tolerance — may indicate PO price maintenance issues or GR quantity gaps  
• **Duplicate Invoice Detection:** Same vendor + amount + date combinations in RBKP — potential double payment risk  
• **Payment Gap Analysis:** Open items in BSIK with no F110 run scheduled — vendors waiting for payment  
• **Early Payment Leakage:** Payments made before net due date without discount capture — working capital opportunity lost  
_→ Feeds Tricentis: Tolerance boundary tests (exact ±threshold), duplicate invoice detection tests, payment run simulation with various methods._

## 8 L3/L4 Activity Breakdown

Complete activity inventory for Direct/Stock Procurement on SAP ECC.
...
Create / Convert Purchase Requisition

ME51N/ME59

Requisitioner / Planner
...
Review & Release Blocked Invoices
...
## 10 Key Controls & Compliance Points
...
T16FS (Release Strategies for PRs), SPRO → MM → Purchasing → PR → Release Procedure

Unauthorized purchases proceed without approval
...
T16FS (Release Strategies for POs), Release groups, codes, indicators

High-value POs bypass management approval
...
Phase 2→3 — PO Creator ≠ GR Poster

Authorization objects: M\_BEST\_BSA, M\_BEST\_WRK + role design

Fraud risk — same person creates PO and confirms receipt

C4

**Delivery Tolerance Check**

Detective

Phase 3 — GR Posting

EKPO-UEBTK (over-delivery %), EKPO-UNTTO (under-delivery %)

Vendor delivers excess quantity, inflating costs
...
Tolerance keys (BD, BW, AP, DW, KW, ST, VP) in T169G — SPRO → MM → LIV → Set Tolerance Limits

Overpayments to vendors — paying for goods not ordered or not received
...
LFB1-ZAHLS (payment block at company code level), BSIK-ZLSPR (item-level block)

Payments released to disputed or blocked vendors

## 11 C16 Value Overlay — Intelligence at Every Stage

The table below maps C16's AI-driven mining capabilities to each process phase. Every detection point produces structured findings that can directly feed test case design.

Phase

C16 Mining Capability
...
Materials missing MRP views, lot sizes, procurement types, or source lists

MRP produces incorrect planned orders → wrong quantities ordered

Orphan PR Detection

PRs older than 30 days with no PO conversion

Unmet demand — production delays or stockouts

Maverick Buying Analysis

POs created without PR or contract reference

Compliance violation — bypasses approval workflow

2\. Sourcing

Release Strategy Gap Analysis

PO value ranges or document types not covered by any release strategy

Purchases go unreviewed — audit finding risk

Vendor Master Completeness

Vendors with missing bank details, payment terms, tax codes, or blocked status

Payment failures, tax non-compliance, blocked vendor on active POs

Price Variance Mining

PO prices deviating > threshold from info record or contract price

Overspend — contract non-compliance, margin erosion

3\. GR

GR/IR Reconciliation

PO items where GR qty ≠ IR qty — aging GR/IR clearing imbalance

Financial misstatement in GR/IR clearing account (WRX)

Over-Delivery Pattern Detection

Vendors with repeated over-delivery > tolerance — tolerance too loose or vendor issue

Excess inventory carrying cost, storage constraints

4\. Invoice & Payment

Blocked Invoice Aging

Invoices blocked in MRBR for > 15 days with no resolution

Vendor late fees, strained supplier relationships, cash flow uncertainty

Duplicate Invoice Detection

Same vendor + amount + date combinations in invoice register

Double payment risk — direct financial loss

Payment Terms Compliance

Open items past net due date with no F110 run, or early payments without discount capture

Working capital leakage — paying early without benefit, or late penalties

🎯 C16 Detection Points Across the Process Flow

flowchart LR A\[📋 MRP Planning\] -->|"C16: Master Data  
Quality Audit"| B\[🛒 Sourcing & PO\] B -->|"C16: Vendor Master  
& Price Variance"| C\[📦 Goods Receipt\] C -->|"C16: GR/IR  
Reconciliation"| D\[💰 Invoice & Pay\] D -->|"C16: Duplicate Invoice  
& Payment Gap"| E\[✅ Complete\] A -.->|Orphan PRs| F\["⚠️ Finding: Demand Gap"\] B -.->|Release Gaps| G\["⚠️ Finding: Control Gap"\] C -.->|Over-delivery| H\["⚠️ Finding: Receiving Risk"\] D -.->|Blocked Aging| I\["⚠️ Finding: Cash Flow Risk"\] style A fill:#3498db,color:#fff,stroke:none style B fill:#27ae60,color:#fff,stroke:none style C fill:#e67e22,color:#fff,stroke:none style D fill:#8e44ad,color:#fff,stroke:none style E fill:#2ecc71,color:#fff,stroke:none style F fill:#ffe0e0,stroke:#e74c3c style G fill:#ffe0e0,stroke:#e74c3c style H fill:#ffe0e0,stroke:#e74c3c style I fill:#ffe0e0,stroke:#e74c3c

## 12 C16 + Tricentis Synergy Map

The following table illustrates how each C16 mining output translates into **specific Tricentis Tosca test cases**, closing the gap between process intelligence and test execution.
...
Material missing MRP views

Negative Test

Attempt MRP run for material without MRP Type → verify system error handling and exception message

High

PR without release strategy

Compliance Test

Create PR above threshold → verify release workflow triggers → verify no auto-approval bypass

High

PO price > info record + 10%

Boundary Test

Create PO at exactly tolerance limit, then +1 cent over → verify block/warning behavior

Medium

Vendor with missing bank details

End-to-End Negative

Complete P2P cycle with vendor missing LFBK → verify F110 skips vendor with meaningful log message

High

GR over-delivery > tolerance

Boundary Test

Post GR at 100%, 105%, and 110% of PO qty → verify tolerance behavior at each threshold

Medium

Invoice 3-way match variance

Boundary + Regression

Post invoice with price = PO ± tolerance key BD → verify block/post at exact boundary values
...
Enter same vendor + amount + invoice date twice → verify system duplicate check message (msg M8147)

High

Payment without discount capture

Optimization Test

Run F110 on day before discount expiry vs day after → verify discount calculation in BSAK clearing document

Low

Blocked invoice > 15 days

Process Test

Block invoice in MRBR → verify aging alert / workflow notification triggers at 7, 15, 30 day thresholds
...
Attempt to post GR with same user who created PO → verify authorization failure if SoD enforced
...
**Without C16:** Test team manually reviews process documentation, guesses which edge cases to test, creates test data by hand. Typical coverage: 40-60% of real-world scenarios.  
  
**With C16:** C16 mines the live ECC system, discovers _actual_ data anomalies and configuration gaps, and produces a prioritized list of test scenarios with real data examples. Tricentis Tosca consumes these findings and auto-generates test cases for the specific boundaries, tolerance values, and exception paths that exist in _this customer's system_. Coverage: 85-95% of real-world scenarios.

🔄 C16 → Tricentis Integration Flow

flowchart LR subgraph C16\["🧠 C16 — AI Mining"\] M1\[Connect to SAP ECC\] --> M2\[Mine Tables & Config\] M2 --> M3\[Detect Gaps & Anomalies\] M3 --> M4\[Generate Findings Report\] end subgraph Bridge\["🔗 Handoff"\] M4 --> H1\[Prioritized Test Scenarios  
with Real Data Examples\] H1 --> H2\[Boundary Values  
from Actual Tolerances\] H2 --> H3\[Negative Paths  
from Missing Config\] end subgraph Tricentis\["🧪 Tricentis Tosca"\] H3 --> T1\[Import Test Scenarios\] T1 --> T2\[Generate Test Cases  
with Parameterized Data\] T2 --> T3\[Execute Automated Tests\] T3 --> T4\[Report Pass/Fail  
with Evidence\] end style C16 fill:#f3e8ff,stroke:#6B3FA0,stroke-width:2px style Bridge fill:#f0f7ff,stroke:#3498db,stroke-width:1px style Tricentis fill:#e8f5e9,stroke:#27ae60,stroke-width:2px

## 13 Disclaimers & Limitations

#### ⚠️ General Disclaimers

*   **Reference Document Only:** This document is intended as a **reference guide** for process understanding, workshop facilitation, and test planning. It does not constitute a functional specification, blueprint, or binding deliverable for implementation.
*   **ECC Platform Specificity:** All transactions, table names, configuration paths, and process flows documented here are specific to **SAP ECC 6.0 (EhP 7/8)**. Applicability to SAP S/4HANA, SAP S/4HANA Cloud, or third-party procurement systems requires separate validation.
*   **No Customer-Specific Configuration:** The process flows represent a **representative baseline** based on SAP standard functionality. Actual customer implementations may differ due to custom enhancements, industry solutions, or organizational variants. Customer-specific configuration (release strategies, tolerance keys, output determination, payment methods) must be validated during discovery workshops.
*   **C16 Capability Statements:** C16 capabilities described in this document (data mining, anomaly detection, gap analysis) are based on C16's current feature set as of April 2026. Specific mining depths and detection accuracy depend on system connectivity, data volumes, authorization levels, and custom code complexity in the target system.
*   **Tricentis Integration:** The C16-to-Tricentis synergy described represents a **recommended approach**, not an out-of-the-box integration. Test scenario generation from C16 findings requires human review and Tosca test case design by qualified test engineers. Automated hand-off may require custom scripting or middleware.
*   **No Warranty on Completeness:** While this document covers the primary activities in Direct/Stock Procurement, it does not claim to cover every possible variant, exception path, or edge case. Scenarios such as returns processing (122/161), evaluated receipt settlement (ERS), consignment settlement, or cross-company procurement are explicitly out of scope.

#### 🔒 Security & Data Privacy

*   **No Customer Data Included:** This document contains **no customer-specific data** — no vendor numbers, material numbers, prices, quantities, or personally identifiable information (PII). All examples use generic SAP table/field references.
*   **C16 Data Handling:** When C16 connects to a customer's SAP system for mining, it operates on a **zero data-at-rest** principle — query results are processed in-memory and never persisted. All communication uses encrypted channels (TLS 1.2+). Specific data handling terms are governed by the C16 service agreement.

#### 📋 Intellectual Property

*   SAP, SAP ECC, SAP S/4HANA, MIGO, MIRO, and all SAP transaction codes are trademarks or registered trademarks of SAP SE.
*   Tricentis and Tosca are trademarks or registered trademarks of Tricentis GmbH.
*   C16 is a product of C16. All rights reserved.
*   This document may be shared with prospective customers for informational purposes. Redistribution or use in competitive contexts requires prior written consent.

**C16** — AI-Powered SAP Intelligence  
Direct / Stock Procurement — ECC Process Reference & C16 Value Map  
Document Version 1.0 — April 2026

_Generated by C16 Platform_  
