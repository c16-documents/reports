...
## 1 Bookshop CAP Application

This is a complete, ready-to-run SAP CAP (Cloud Application Programming) Bookshop application with a Fiori Elements UI. It includes:

*   **2 Entities:** Books and Authors
*   **5 Sample Books** with title, author, genre, stock, and price
*   **5 Sample Authors** with name and country
*   **Full Fiori Elements UI** — List Report with Object Page navigation
*   **Draft-enabled** for create/edit/delete operations
...
Data model — Books and Authors entities
...
## 4 Service Definition — srv/service.cds
...
## 5 UI Annotations — srv/annotations.cds
...
annotate service.Books with @(
  ...
  UI.SelectionFields: [ genre, author ],
  ...
  UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'GeneralFacet', 
  Target: '@UI.FieldGroup#General', Label: 'General Information' },
  { $Type: 'UI.ReferenceFacet', ID: 'DetailsFacet', 
  Target: '@UI.FieldGroup#Details', Label: 'Inventory Details' }
  ],
...
1;The Hitchhiker's Guide to the Galaxy;Douglas Adams;Science Fiction;42;12.99
2;1984;George Orwell;Dystopian;25;9.99
3;Pride and Prejudice;Jane Austen;Classic;30;8.49
4;The Great Gatsby;F. Scott Fitzgerald;Classic;18;10.99
5;Dune;Frank Herbert;Science Fiction;22;14.99
```
...
```
ID;name;country
1;Douglas Adams;United Kingdom
2;George Orwell;United Kingdom
3;Jane Austen;United Kingdom
4;F. Scott Fitzgerald;United States
5;Frank Herbert;United States
```

## 7 Fiori Elements App

### app/bookshop-ui/webapp/manifest.json
...
### app/bookshop-ui/webapp/Component.js
...
### app/bookshop-ui/webapp/index.html
...
<head>
  ...
  <script src="https://sapui5.hana.ondemand.com/1.120.43/test-resources/sap/ushell/bootstrap/sandbox.js"></script>
  <script src="https://sapui5.hana.ondemand.com/1.120.43/resources/sap-ui-core.js"
...
1.  Create a folder called `bookshop`
2.  Copy each file above into the matching path
3.  Open terminal in the `bookshop` folder
4.  Run: `npm init -y && npm add @sap/cds @cap-js/sqlite`
5.  Run: `npx cds watch`
6.  Open: `http://localhost:4004/bookshop-ui/webapp/index.html`

**Requirements:** Node.js 20 or 22 LTS (for SQLite prebuilds)
...
Filter bar with Genre/Author filters, sortable table with all 5 books

📖 Book Object Page

Click any book to see details in two facets: General Info + Inventory

✏️ Draft-Enabled Editing

Create, Edit, Delete books with automatic draft handling

👤 Authors List

Navigate to `/Authors` entity for author management
