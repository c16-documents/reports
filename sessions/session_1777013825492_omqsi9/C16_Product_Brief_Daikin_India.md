  C16 AI Platform — Product Brief for Daikin India \* { margin: 0; padding: 0; box-sizing: border-box; } body { font-family: 'Segoe UI', Arial, sans-serif; color: #2c3e50; background: #e9ecef; line-height: 1.7; } .doc-wrapper { max-width: 1120px; margin: 30px auto; background: #fff; box-shadow: 0 4px 24px rgba(0,0,0,0.10); border-radius: 12px; overflow: hidden; } .header-banner { background: linear-gradient(135deg, #C97B3A, #B5567A, #6B3FA0); color: #fff; padding: 50px 48px; text-align: center; } .header-banner img { height: 60px; margin-bottom: 16px; border-radius: 8px; } .header-banner h1 { font-size: 2.4em; font-weight: 700; margin-bottom: 8px; letter-spacing: -0.5px; } .header-banner .subtitle { font-size: 1.2em; opacity: 0.92; margin-bottom: 16px; } .header-banner .badge { display: inline-block; background: rgba(255,255,255,0.2); padding: 6px 18px; border-radius: 20px; font-size: 0.9em; margin: 4px; } .meta-bar { background: #f8f9fa; padding: 18px 48px; border-bottom: 1px solid #e2e8f0; display: flex; flex-wrap: wrap; gap: 28px; font-size: 0.92em; color: #64748b; } .meta-bar span strong { color: #2c3e50; } .toc { padding: 32px 48px; background: #fafbfc; border-bottom: 1px solid #e2e8f0; } .toc h2 { font-size: 1.3em; color: #6B3FA0; margin-bottom: 14px; } .toc-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 8px; } .toc a { color: #6B3FA0; text-decoration: none; font-size: 0.95em; padding: 4px 0; display: block; } .toc a:hover { text-decoration: underline; } .content { padding: 40px 48px; } .section-title { font-size: 1.5em; color: #6B3FA0; margin: 40px 0 20px 0; padding-bottom: 10px; border-bottom: 3px solid #B5567A; display: flex; align-items: center; gap: 12px; } .section-title:first-child { margin-top: 0; } .num-badge { background: #B5567A; color: #fff; width: 32px; height: 32px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; font-size: 0.75em; font-weight: 700; flex-shrink: 0; } h3 { color: #4a5568; font-size: 1.15em; margin: 24px 0 12px 0; } p { margin-bottom: 14px; } table { width: 100%; border-collapse: collapse; margin: 16px 0 24px 0; font-size: 0.93em; } thead th { background: #6B3FA0; color: #fff; padding: 12px 16px; text-align: left; font-weight: 600; } tbody td { padding: 11px 16px; border-bottom: 1px solid #e2e8f0; } tbody tr:nth-child(even) { background: #f8fafc; } tbody tr:hover { background: #edf2f7; } .kpi-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 18px; margin: 24px 0; } .kpi-card { background: linear-gradient(135deg, #f0e6ff, #fce4ec); border-radius: 12px; padding: 24px; text-align: center; border: 1px solid #e8d5f5; } .kpi-card .kpi-value { font-size: 2em; font-weight: 700; color: #6B3FA0; } .kpi-card .kpi-label { font-size: 0.88em; color: #64748b; margin-top: 6px; } .highlight-box { background: #f6fef9; border-left: 5px solid #27ae60; padding: 20px 24px; border-radius: 0 8px 8px 0; margin: 20px 0; } .highlight-box.purple { background: #f5f0ff; border-left-color: #6B3FA0; } .highlight-box.blue { background: #eff6ff; border-left-color: #3498db; } .highlight-box.orange { background: #fff8f0; border-left-color: #e67e22; } .use-case-card { background: #fff; border: 1px solid #e2e8f0; border-radius: 10px; padding: 24px; margin: 16px 0; box-shadow: 0 2px 8px rgba(0,0,0,0.04); } .use-case-card h4 { color: #6B3FA0; font-size: 1.1em; margin-bottom: 8px; } .use-case-card .tag { display: inline-block; background: #f0e6ff; color: #6B3FA0; padding: 3px 12px; border-radius: 12px; font-size: 0.82em; margin-right: 6px; margin-bottom: 6px; } .diff-table td:first-child { font-weight: 600; width: 200px; } .check { color: #27ae60; font-weight: 700; } .cross { color: #e74c3c; font-weight: 700; } .partial { color: #e67e22; font-weight: 700; } .architecture-img { text-align: center; margin: 24px 0; } ul, ol { margin: 8px 0 16px 24px; } li { margin-bottom: 6px; } .footer { background: #f8f9fa; padding: 24px 48px; border-top: 1px solid #e2e8f0; text-align: center; font-size: 0.85em; color: #94a3b8; } @media print { .doc-wrapper { box-shadow: none; margin: 0; } .header-banner { -webkit-print-color-adjust: exact; print-color-adjust: exact; } } @media (max-width: 768px) { .content, .toc, .meta-bar, .footer { padding-left: 20px; padding-right: 20px; } .header-banner { padding: 30px 20px; } .header-banner h1 { font-size: 1.6em; } }
...
Product Brief for Daikin India IT Team

🤖 Agentic AI for SAP 🔌 Live SAP Connection 📊 Process Intelligence 🛡️ Clean Core

**Prepared For:** Daikin India — IT Department **Date:** 24 April 2026 **Version:** 1.0 **Classification:** Pre-Sales — Confidential

## Contents

[1\. What is C16?](#what-is-c16) [2\. How It Works](#how-it-works) [3\. Core Capabilities](#capabilities) [4\. Use Cases for SAP Support](#use-cases) [5\. Use Cases for Process Intelligence](#use-cases-process) [6\. Key Differentiators](#differentiators) [7\. Comparison with Alternatives](#comparison) [8\. Built-in Specialist Agents](#agents) [9\. Security & Data Governance](#security) [10\. Technical Architecture](#architecture) [11\. Connection Prerequisites](#prerequisites) [12\. POC Approach](#poc-approach) [13\. Frequently Asked Questions](#faqs)

## 1 What is C16?

**C16 is an AI-powered SAP consultant** that connects directly to your live SAP system and acts as an intelligent co-pilot for your IT team, functional consultants, and ABAP developers. Unlike generic AI chatbots, C16 _understands SAP_ — it reads your programs, queries your data, analyzes your processes, and generates production-ready code.

**In simple terms:** Imagine having an expert SAP consultant available 24/7 who can instantly read any program in your system, investigate any data issue, analyze any business process, and write production-quality ABAP code — all through a simple conversation.
...
Not Days — Resolution Time

## 2 How It Works

C16 connects to your SAP system over a secure HTTPS channel and communicates using standard SAP interfaces — the same protocols used by SAP GUI, Eclipse ADT, and Fiori apps. There is **no agent installed on your SAP server**. The connection uses:
...
Read tables, call BAPIs, execute function modules

✅ Yes — standard ICF service

ADT REST APIs

Read/write ABAP source code, syntax check, ATC

✅ Yes — Eclipse ADT protocol

OData Services

Read business data (POs, vendors, materials)

✅ Yes — SAP Gateway

abapGit HTTP

Deploy code changes via version control

✅ Yes — open-source abapGit

**Key Point:** C16 uses ONLY standard SAP communication channels. No custom kernel modules, no OS-level agents, no database direct access. Your SAP system integrity is fully preserved.

## 3 Core Capabilities

### 3.1 SAP Application Support & Ticket Resolution

A user describes a problem in plain English (or forwards a support ticket). C16 autonomously:

*   **Investigates** — Reads relevant programs, queries data tables, checks configurations
*   **Diagnoses** — Identifies root cause (code bug, missing config, data issue, authorization gap)
*   **Recommends** — Proposes a fix with full technical detail
*   **Implements** — Generates and deploys the fix to your SAP system (with approval)
*   **Validates** — Runs syntax checks, ATC quality checks, and unit tests

### 3.2 Business Process Intelligence

C16 investigates business processes by reading live SAP data — not just code:

*   **Procure-to-Pay (P2P)** — PR → PO → GR → Invoice → Payment cycle analysis
*   **Order-to-Cash (O2C)** — Order → Delivery → Billing → Collection cycle
*   **Financial Close (R2R)** — GL postings, open items, reconciliation gaps
*   **Inventory & Warehousing** — Stock levels, movement patterns, dead stock
*   **Master Data Quality** — Vendor, customer, material completeness and consistency

### 3.3 Code Analysis & Clean Core Compliance

*   Reads any ABAP program/class/CDS view and produces a detailed analysis report
*   Classifies every dependency against SAP's cloudification catalog (Level A/B/C)
*   Calculates a Clean Core compliance score (0-100)
*   Identifies performance bottlenecks, security gaps, code duplication
*   Recommends specific modernization paths (BAPI rewrite, OO refactor, RAP migration)

### 3.4 Code Generation & Deployment

*   Generates production-ready ABAP programs, classes, CDS views, RAP applications
*   Deploys directly to SAP via abapGit (version-controlled, auditable)
*   Auto-corrects compilation errors (up to 5 retry cycles)
*   Runs post-deployment validation (syntax, ATC, unit tests)
*   Generates Fiori/UI5 applications with live preview

### 3.5 Documentation & Reporting

*   Generates rich HTML analysis documents with data evidence, charts, and recommendations
*   Produces functional specifications from business requirements
*   Creates migration assessments for S/4HANA readiness
*   Reads and analyzes uploaded documents (PDF, DOCX, XLSX) for review and extraction

## 4 Use Cases — SAP Application Support

#### 🎫 UC-1: Ticket Triage & Root Cause Analysis

SupportDiagnostics

**Scenario:** User reports "PO creation failing with error message X" or "Vendor payment not triggered."

**C16 Action:** Reads the relevant program source, queries the affected data tables (EKKO, BSIK, LFA1), checks configuration tables, traces the error to root cause — then presents a diagnosis with evidence.

**Value:** Reduces L2/L3 investigation time from hours/days to minutes. No need to search through code manually or log OSS notes.

#### 🐛 UC-2: Bug Fix & Code Correction

DevelopmentDeployment

**Scenario:** A custom Z-report produces wrong output or crashes with a short dump.

**C16 Action:** Reads the program, identifies the bug (wrong field reference, missing error handling, logic error), generates a corrected version, deploys to QA with syntax/ATC validation.

**Value:** Fix deployed and validated in minutes instead of a multi-day development cycle. Full audit trail via abapGit.

#### 📊 UC-3: "Why is this report slow?"

PerformanceOptimization

**Scenario:** A custom ALV report takes 15+ minutes to run.

**C16 Action:** Analyzes the program for performance anti-patterns (SELECT in LOOP, SELECT \*, missing indexes, application-level JOINs). Quantifies the impact (e.g., "18 redundant DB roundtrips per execution"). Generates optimized version.

**Value:** Performance improvements identified and implemented without engaging expensive external consultants.

#### 🔐 UC-4: Authorization & Security Review

SecurityCompliance

**Scenario:** Audit team asks "Do our custom programs have proper authorization checks?"

**C16 Action:** Scans all Z-programs, identifies those accessing sensitive data (vendor master, financial documents, HR data) without AUTHORITY-CHECK statements. Generates specific fix code with the correct authorization objects.

**Value:** Audit-ready security assessment across the entire custom code portfolio in hours, not weeks.

#### 📋 UC-5: Impact Analysis for Changes

Change ManagementRisk

**Scenario:** "We need to change field X in table Y — what programs will be affected?"

**C16 Action:** Searches the entire custom code base for references to the table/field. Lists every program, class, and function module that uses it, with line numbers and context.

**Value:** Complete impact analysis in seconds. No risk of missed dependencies during changes.

## 5 Use Cases — Business Process Intelligence

#### 💰 UC-6: Vendor Payment Diagnostics

FI-APProcess

**Scenario:** "Why are vendor payments delayed?" or "Which vendors have overdue invoices?"

**C16 Action:** Queries BSIK (open payables), BSAK (cleared items), LFB1 (vendor company data), T052 (payment terms). Identifies bottlenecks — missing bank details, payment blocks, F110 configuration gaps. Produces an evidence-based diagnostic report.

**Value:** Finance team gets a complete payables health check with specific action items — no manual SAP navigation required.

#### 📦 UC-7: Procurement Cycle Analysis

MMProcess Mining

**Scenario:** "How long does it take from PR to PO to GR? Where are the delays?"

**C16 Action:** Reads EBAN (PRs), EKKO/EKPO (POs), EKBE (GR/IR), calculates turnaround times at each stage, identifies stuck documents and bottleneck stages.

**Value:** Process mining insights without deploying a separate process mining tool. Actionable findings in minutes.

#### 🏭 UC-8: Master Data Quality Assessment

Cross-ModuleData Quality

**Scenario:** "How complete is our vendor/customer/material master data?"

**C16 Action:** Scans master data tables for completeness — missing addresses, blank tax codes, no payment terms, missing bank details. Produces a quality scorecard with specific gaps per record.

**Value:** Data quality baseline established without expensive data cleansing tools. Specific records identified for remediation.

#### 📈 UC-9: Order-to-Cash Process Health

SDProcess Mining

**Scenario:** "What's our order-to-delivery lead time? Where do orders get stuck?"

**C16 Action:** Analyzes VBAK → LIKP → VBRK flow, identifies blocked orders, delayed deliveries, unbilled shipments. Maps the complete O2C cycle with turnaround times.

**Value:** End-to-end O2C visibility without custom reports or BI tools.

#### 🔍 UC-10: Configuration Gap Discovery

Cross-ModuleFit-to-Standard

**Scenario:** "Are we using standard SAP features or have we over-customized?"

**C16 Action:** Inventories all Z/Y custom objects, classifies them against standard SAP alternatives (Fiori apps, standard transactions, released APIs). Recommends where custom code can be retired.

**Value:** Clear roadmap for simplification — reduce maintenance cost by retiring unnecessary custom code.
...
C16 connects directly to your SAP system and reads real data in real-time. It doesn't work from static exports or screenshots — it queries your actual tables, reads your actual programs, and tests against your actual system.

**🤖 Agentic — Not Just Chat**

C16 doesn't just answer questions — it _takes action_. It autonomously chains together 10-30 SAP API calls to investigate a problem, generates code, deploys it, validates it, and reports back. One user prompt → complete workflow.

**📊 Process-First, Not Code-First**

C16 understands SAP business processes (P2P, O2C, R2R) at the data level. Ask a business question → get a data-driven answer. No need to know which tables to query or which transaction to run.

**✍️ Production-Ready Code**

Generated code is not prototype-quality — it's deployed, syntax-checked, ATC-validated, and ready for production. C16 self-corrects compilation errors automatically.

**🛡️ Clean Core Native**

Every analysis includes SAP's cloudification classification (Level A/B/C). C16 inherently guides your custom code toward S/4HANA Cloud readiness — not as an afterthought, but as a core analysis dimension.

**📄 Evidence-Based Reports**

Every finding in every report cites the specific SAP table, field, and data values as evidence. No generic recommendations — only data-backed insights from your live system.

**⚡ Speed**

A typical program analysis that would take a consultant 2-3 days is completed in 3-5 minutes. Process investigations that require days of manual SAP navigation are done in minutes.

**🧠 18 Specialist Agents**

C16 has specialized expertise across multiple SAP domains — not a generic LLM with a SAP glossary. Each agent carries deep domain knowledge for its area.
...
Generate & deploy ABAP code

✅ Full lifecycle

⚠️ Snippets only

⚠️ Snippets (no deploy)

✅ Manual

Process investigation (P2P/O2C)
...
## 8 Built-in Specialist Agents

C16 includes 18 specialized agents, each with deep domain expertise:
...
Converts business requirements into structured SAP functional specs

🔍 **Code Reviewer**

ABAP Code Quality

Reviews programs for bugs, performance, security, best practices

⛏️ **Process Mining**

P2P, O2C, R2R Processes

Analyzes process cycle times, variants, bottlenecks from live data

📊 **Data Quality**

Master Data

Assesses vendor, customer, material data completeness and consistency

✅ **Compliance Auditor**

Authorization & Compliance

Scans for missing auth checks, segregation of duties issues

⚡ **Performance Profiler**

ABAP Performance

Detects N+1 SELECTs, missing indexes, pushdown opportunities

💥 **Code Impact**

Change Impact Analysis

Traces all references to a table, field, or object across the codebase

📝 **Tech Spec Writer**

Technical Documentation

Generates technical specifications from source code analysis

📦 **Mass Code Review**

Portfolio Assessment

Scans entire custom code portfolio for compliance and quality

🛡️ **Clean Core Remediation**

S/4HANA Migration

Classifies objects against SAP cloudification catalog, recommends upgrades

📄 **SmartForm Converter**

Form Migration

Converts SmartForms to Adobe Forms automatically

🖥️ **WebDynpro Migrator**

UI Migration

Analyzes WebDynpro apps for Fiori migration readiness

🏗️ **ABAP Code Factory**

Code Generation

Generates new programs, classes, RAP apps from requirements

🧪 **Unit Test Generator**

Test Automation

Creates ABAP Unit test classes for existing code

📦 **MM Consultant**

Materials Management

MM process expertise — procurement, inventory, MRP

🛒 **SD Consultant**

Sales & Distribution

SD process expertise — sales orders, deliveries, billing

💰 **FI Consultant**

Financial Accounting

FI process expertise — GL, AP, AR, asset accounting

🏭 **PP Consultant**

Production Planning

PP process expertise — BOMs, routing, production orders

## 9 Security & Data Governance

**Data Privacy Commitment:** C16 processes your SAP data only during the active session to answer your question. No SAP data is stored, logged, or used for AI model training. All communication is encrypted in transit (TLS 1.2+).
...
Uses a dedicated SAP service user with least-privilege roles. No SAP\_ALL or SAP\_NEW.

**Authorization**

The service user's SAP roles control what C16 can access. If the user can't read HR data → C16 can't read HR data.

**Network**

HTTPS only (port 443 or custom). No SSH tunnels, no VPN agents, no OS-level access.

**Code Changes**

All code modifications go through abapGit (version-controlled). Changes require explicit user approval before deployment.

**Data at Rest**

SAP connection credentials encrypted with AES-256-GCM. No SAP business data stored.

**Audit Trail**

Every tool call is logged. Every code change is traceable via abapGit commit history.

**No Kernel Modification**

Zero modification to SAP kernel, database, or OS layer. Uses only standard ICF services.

**Read-Only Option**

For POC, the service user can be configured as read-only (no S\_DEVELOP write access). C16 still provides full analysis — just without code deployment.

## 10 Technical Architecture

C16 operates as a cloud-hosted AI platform that communicates with your SAP system over standard HTTPS interfaces:
...
Large Language Model + SAP Domain Skills

48 specialized skill modules for different SAP areas

**Tool Orchestrator**

Agentic Framework

Chains 80+ SAP tools autonomously to complete complex workflows

**SAP Connector**

RFC/SOAP + ADT REST + OData

Standard SAP interfaces — no custom ABAP add-on required (only abapGit for code deploy)

**Code Engine**

Python-based Analysis + ABAP Generation

Clean Core scoring, performance analysis, CDS generation

**Document Engine**

HTML/PDF Report Generator

Professional analysis documents with data evidence and recommendations

**Preview Server**

Node.js + SAPUI5 CDN

Local preview of generated Fiori/UI5 apps before deployment

**Integration Pattern:**  
  
`[C16 Cloud Platform] ——HTTPS——▶ [SAP System (ICF)] ——▶ [RFC | ADT | OData | abapGit]`  
  
The SAP system requires only standard ICF services to be activated (which are typically already active for SAP GUI, Eclipse, and Fiori). The only optional addition is the open-source abapGit HTTP handler for code deployment.

## 11 Connection Prerequisites

### 11.1 What We Need from Daikin IT
...
Hostname + HTTPS port (e.g., https://sap-qa.daikinindia.com:44300)
...
Dedicated dialog or communication user (e.g., SVC\_C16)
...
We provide exact role template — S\_RFC, S\_DEVELOP, S\_TABU\_NAM (read), S\_CTS\_ADMI
...
Whitelist C16 IP for HTTPS access to SAP ICM port
...
Install abapGit HTTP handler for code deployment. Not needed for read-only POC.

~1 hour Basis

**Total setup time:** ~2 hours of Basis effort. No functional configuration changes. No SAP Notes required. No kernel patches.

### 11.2 What We Provide

*   Detailed service user setup guide with exact role definitions and authorizations
*   Network requirements document (IP addresses to whitelist)
*   abapGit installation guide (step-by-step, 30 minutes)
*   Dedicated support during POC setup

## 12 POC Approach for Daikin India

### Objective

Demonstrate C16's value for **SAP Application Support ticket resolution** using Daikin's QA system with real programs and real data.

### Proposed POC Plan (3 Days)
...
• Connect C16 to Daikin QA system  
• Auto-discover all custom Z/Y objects  
• Inventory the custom code portfolio  
• Identify which SAP modules are active

System Discovery Report — org structure, module usage, custom object count, data volumes

**Day 2**  
(3-4 hours)

**Live Demonstrations**  
• Pick 3-5 real support scenarios from recent tickets  
• C16 investigates and diagnoses each one live  
• Demonstrate code analysis on 2-3 complex Z-programs  
• Show process intelligence on one business cycle (P2P or O2C)

Analysis reports for each scenario. Process investigation document with data evidence.

**Day 3**  
(2-3 hours)

**Value Assessment & Next Steps**  
• Review findings with Daikin IT team  
• Quantify time savings per ticket type  
• Discuss use case prioritization  
• Define ongoing engagement model

POC Summary Report with ROI indicators and recommendation for next steps.

### Success Criteria

*   C16 successfully connects to Daikin QA system and discovers custom objects
*   C16 correctly diagnoses at least 3 real support scenarios
*   C16 generates at least 1 code fix that passes syntax/ATC validation
*   Daikin IT team agrees that C16 reduces investigation time by 50%+

**Zero Risk:** The POC runs against a QA system with a read-only service user option. No impact on production. No permanent changes. Daikin can revoke the service user at any time.

## 13 Frequently Asked Questions

Does C16 modify our SAP system?

Only if explicitly asked to deploy code — and only through the standard abapGit channel. For a read-only POC, no modifications are made. The service user can be configured without write access.

Does C16 store our SAP data?

No. C16 processes data in real-time during the active session only. No SAP business data is persisted, cached, or used for model training. When the session ends, the data is gone.

What SAP versions does C16 support?

C16 supports SAP ECC 6.0 (7.40+) and all S/4HANA versions (on-premise and Cloud). The capabilities adapt automatically to the system version — for example, RAP and CDS features are only proposed on S/4HANA systems.

Do we need to install anything on our SAP system?

For read-only analysis: No. C16 uses standard ICF services already active in most SAP systems. For code deployment: the open-source abapGit HTTP handler needs to be installed (~30 min Basis task).

How does C16 differ from SAP Joule?

SAP Joule is designed for S/4HANA Cloud users and focuses on guided experiences within standard SAP workflows. C16 is designed for SAP IT teams — it can connect to any SAP system (ECC or S/4), read custom ABAP code, investigate data issues, and generate/deploy code. C16 is an agentic platform (autonomous multi-step workflows), while Joule is a conversational assistant.

Can C16 help with S/4HANA migration planning?

Yes. C16 can assess your entire custom code portfolio for S/4HANA readiness — classifying each object against SAP's simplification list and cloudification catalog. It identifies which programs need changes, which can be retired, and which standard alternatives exist.

What's the ongoing cost after the POC?

Commercial terms will be discussed after the POC validates value. The model is consumption-based — you pay for what you use. No large upfront license fee.

**C16 AI Platform** — Product Brief v1.0 | Prepared for Daikin India IT Department | April 2026

For questions or to schedule the POC kickoff, contact your Sydler representative.

© 2026 C16. All rights reserved. This document is confidential and intended for the named recipient only.
