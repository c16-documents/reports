  C16 — How Prompt Processing Works | 5-Layer Architecture \* { margin: 0; padding: 0; box-sizing: border-box; } body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #e9ecef; color: #2c3e50; line-height: 1.7; } .doc-wrapper { max-width: 1120px; margin: 0 auto; background: #fff; box-shadow: 0 4px 24px rgba(0,0,0,0.10); border-radius: 12px; overflow: hidden; } /\* Header Banner \*/ .header-banner { background: linear-gradient(135deg, #C97B3A, #B5567A, #6B3FA0); color: #fff; padding: 48px 48px 40px; text-align: center; } .header-banner img { height: 50px; margin-bottom: 12px; border-radius: 8px; } .header-banner h1 { font-size: 2.2em; font-weight: 700; margin-bottom: 8px; letter-spacing: -0.5px; } .header-banner .subtitle { font-size: 1.15em; opacity: 0.92; margin-bottom: 16px; } .header-banner .version-badge { display: inline-block; background: rgba(255,255,255,0.22); padding: 4px 16px; border-radius: 20px; font-size: 0.85em; margin-top: 6px; } /\* Meta Bar \*/ .meta-bar { display: flex; flex-wrap: wrap; gap: 12px; padding: 18px 40px; background: #f8f9fa; border-bottom: 2px solid #eee; justify-content: center; } .meta-item { background: #fff; border: 1px solid #dee2e6; border-radius: 8px; padding: 8px 18px; font-size: 0.9em; } .meta-item strong { color: #6B3FA0; } /\* TOC \*/ .toc { padding: 28px 40px; background: #faf8ff; border-bottom: 2px solid #eee; } .toc h2 { color: #6B3FA0; font-size: 1.2em; margin-bottom: 14px; } .toc-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 8px; } .toc a { color: #6B3FA0; text-decoration: none; font-size: 0.92em; padding: 4px 8px; border-radius: 4px; display: block; } .toc a:hover { background: #ece5ff; } /\* Sections \*/ .section { padding: 32px 40px; border-bottom: 1px solid #f0f0f0; } .section:last-child { border-bottom: none; } .section-title { color: #6B3FA0; font-size: 1.45em; font-weight: 700; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 3px solid #B5567A; display: flex; align-items: center; gap: 12px; } .section-num { background: #B5567A; color: #fff; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.85em; font-weight: 700; flex-shrink: 0; } /\* KPI Cards \*/ .kpi-row { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin: 20px 0; } .kpi-card { background: linear-gradient(135deg, #f8f6ff, #f0eaff); border: 1px solid #d4c8f0; border-radius: 12px; padding: 20px; text-align: center; } .kpi-card .kpi-value { font-size: 2em; font-weight: 800; color: #6B3FA0; } .kpi-card .kpi-label { font-size: 0.85em; color: #666; margin-top: 4px; } /\* Tables \*/ table { width: 100%; border-collapse: collapse; margin: 16px 0; font-size: 0.92em; } thead th { background: #6B3FA0; color: #fff; padding: 12px 14px; text-align: left; font-weight: 600; } tbody td { padding: 10px 14px; border-bottom: 1px solid #eee; } tbody tr:nth-child(even) { background: #f8fafc; } tbody tr:hover { background: #edf2f7; } /\* Layer Cards \*/ .layer-card { border-radius: 12px; margin: 20px 0; overflow: hidden; border: 2px solid #e0e0e0; } .layer-header { padding: 16px 24px; color: #fff; font-size: 1.1em; font-weight: 700; display: flex; align-items: center; gap: 12px; } .layer-body { padding: 20px 24px; background: #fff; } .layer-1 .layer-header { background: linear-gradient(135deg, #6B3FA0, #8B5FC0); } .layer-2 .layer-header { background: linear-gradient(135deg, #B5567A, #D06A8E); } .layer-3 .layer-header { background: linear-gradient(135deg, #C97B3A, #E09550); } .layer-4 .layer-header { background: linear-gradient(135deg, #2980b9, #3498db); } .layer-5 .layer-header { background: linear-gradient(135deg, #27ae60, #2ecc71); } .layer-icon { font-size: 1.5em; } /\* Flow Diagram \*/ .flow-container { background: #f8f6ff; border-radius: 12px; padding: 24px; margin: 20px 0; border: 1px solid #d4c8f0; } .flow-step { display: flex; align-items: flex-start; gap: 16px; margin: 12px 0; } .flow-arrow { text-align: center; color: #B5567A; font-size: 1.5em; margin: 8px 0; padding-left: 20px; } .flow-badge { min-width: 44px; height: 44px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; font-size: 0.9em; flex-shrink: 0; } .flow-content { flex: 1; } .flow-content strong { display: block; font-size: 1.05em; margin-bottom: 4px; } .flow-content .flow-detail { color: #666; font-size: 0.9em; } /\* Comparison Table \*/ .comparison-row { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 20px 0; } .comparison-card { border-radius: 12px; padding: 24px; } .compare-traditional { background: #fef5f5; border: 2px solid #e74c3c; } .compare-c16 { background: #f0fef5; border: 2px solid #27ae60; } .compare-title { font-weight: 700; font-size: 1.1em; margin-bottom: 12px; } /\* Quote Box \*/ .quote-box { background: linear-gradient(135deg, #f8f6ff, #f0eaff); border-left: 5px solid #6B3FA0; padding: 20px 24px; margin: 20px 0; border-radius: 0 12px 12px 0; font-style: italic; } .quote-box .attribution { font-style: normal; font-weight: 600; color: #6B3FA0; margin-top: 8px; } /\* Insight Box \*/ .insight-box { background: #f0fef5; border: 2px solid #27ae60; border-radius: 12px; padding: 20px 24px; margin: 20px 0; } .insight-box h4 { color: #27ae60; margin-bottom: 8px; } /\* Warning Box \*/ .warning-box { background: #fffaf0; border: 2px solid #e67e22; border-radius: 12px; padding: 20px 24px; margin: 20px 0; } .warning-box h4 { color: #e67e22; margin-bottom: 8px; } /\* Pie visual \*/ .contribution-bar { display: flex; height: 40px; border-radius: 20px; overflow: hidden; margin: 16px 0; } .contrib-segment { display: flex; align-items: center; justify-content: center; color: #fff; font-size: 0.8em; font-weight: 600; } /\* Code \*/ pre { background: #f5f5f5; border-left: 4px solid #B5567A; padding: 16px; border-radius: 0 8px 8px 0; overflow-x: auto; font-family: 'Consolas', 'Courier New', monospace; font-size: 0.88em; margin: 12px 0; } code { font-family: 'Consolas', 'Courier New', monospace; background: #f0eaff; padding: 2px 6px; border-radius: 4px; font-size: 0.9em; } /\* Tags \*/ .tag { display: inline-block; padding: 3px 12px; border-radius: 12px; font-size: 0.8em; font-weight: 600; margin: 2px 4px; } .tag-purple { background: #ece5ff; color: #6B3FA0; } .tag-pink { background: #fce5ef; color: #B5567A; } .tag-green { background: #e5fce9; color: #27ae60; } .tag-orange { background: #fff3e0; color: #e67e22; } .tag-blue { background: #e3f2fd; color: #2980b9; } /\* Footer \*/ .doc-footer { background: #2c3e50; color: #ccc; padding: 30px 40px; text-align: center; font-size: 0.85em; } .doc-footer a { color: #B5567A; text-decoration: none; } .doc-footer .footer-brand { font-size: 1.2em; color: #fff; font-weight: 700; margin-bottom: 8px; } /\* Mermaid \*/ .mermaid { margin: 20px 0; text-align: center; } /\* Print \*/ @media print { body { background: #fff; } .doc-wrapper { box-shadow: none; } .header-banner { -webkit-print-color-adjust: exact; print-color-adjust: exact; } .section { page-break-inside: avoid; } } /\* Responsive \*/ @media (max-width: 768px) { .header-banner { padding: 28px 20px; } .header-banner h1 { font-size: 1.5em; } .section { padding: 24px 20px; } .kpi-row { grid-template-columns: repeat(2, 1fr); } .comparison-row { grid-template-columns: 1fr; } .meta-bar { padding: 14px 20px; } } mermaid.initialize({startOnLoad:true, theme:'base', themeVariables:{primaryColor:'#6B3FA0',primaryTextColor:'#fff',primaryBorderColor:'#B5567A',lineColor:'#B5567A',secondaryColor:'#f8f6ff',tertiaryColor:'#faf8ff'}});
...
# How C16 Processes Natural Language Prompts

The 5-Layer Architecture — From "Payments Not Working" to Root Cause in 90 Seconds

📄 Technical Architecture Document — April 2026 — POC Reference

**Purpose:** Explain how C16 converts natural language into SAP investigation

**Audience:** Technical stakeholders, ABAP teams, IT leadership

**Classification:** POC Preparation Material

**Date:** 24 April 2026

## 📑 Table of Contents

[1\. The Core Question](#the-question) [2\. The 5-Layer Architecture](#five-layers) [3\. Layer 1 — LLM (The Brain)](#layer1) [4\. Layer 2 — System Prompt (The Playbook)](#layer2) [5\. Layer 3 — Live SAP Tools (The Hands)](#layer3) [6\. Layer 4 — Skills Library (The Specialists)](#layer4) [7\. Layer 5 — Learned Corrections (The Memory)](#layer5) [8\. Live Example: F110 Payment Failure](#live-example) [9\. Step-by-Step Processing Flow](#step-by-step) [10\. Layer Contribution Analysis](#contribution) [11\. C16 vs. Traditional Support](#comparison) [12\. The Honest Answer: "Is It Just an LLM?"](#honest-answer) [13\. What to Tell the Technical Team](#what-to-tell)

1 The Core Question

**"When a user types 'Vendor payments failing — F110 not picking up invoices', how does C16 know to check LFBK, LFB1, BSIK, REGUH, T042Z? Is it just an LLM?"**

— The question every technical stakeholder will ask

This is the most important question to answer transparently — especially for POC audiences who want to understand what's real versus marketing. This document explains **exactly** how C16 processes a natural language support ticket, layer by layer, with no hand-waving.
...
Specialist Skill Modules

Think of it like this: **An LLM alone is like a brilliant SAP consultant who is blindfolded and has no laptop.** They _know_ SAP inside out, but they can't see your system. C16 removes the blindfold and gives them the laptop.

2 The 5-Layer Architecture

graph TD A\["🧑 User Input  
Natural Language Ticket"\] --> B\["🧠 Layer 1: LLM  
SAP Domain Knowledge"\] B --> C\["📋 Layer 2: System Prompt  
Structured Methodology"\] C --> D\["🔌 Layer 3: Live SAP Tools  
RFC / ADT / OData"\] D --> E\["📚 Layer 4: Skills Library  
48 Specialist Modules"\] E --> F\["💾 Layer 5: Learned Corrections  
System-Specific Memory"\] F --> G\["📊 Final Output  
Root Cause + Evidence + Report"\] style A fill:#f0eaff,stroke:#6B3FA0,stroke-width:2px,color:#2c3e50 style B fill:#6B3FA0,stroke:#6B3FA0,stroke-width:2px,color:#fff style C fill:#B5567A,stroke:#B5567A,stroke-width:2px,color:#fff style D fill:#C97B3A,stroke:#C97B3A,stroke-width:2px,color:#fff style E fill:#2980b9,stroke:#2980b9,stroke-width:2px,color:#fff style F fill:#27ae60,stroke:#27ae60,stroke-width:2px,color:#fff style G fill:#f0fef5,stroke:#27ae60,stroke-width:2px,color:#2c3e50
...
SAP domain knowledge from training on billions of documents

The consultant's brain

C16 wouldn't understand "F110" or know which tables matter

Layer 2 System Prompt

Hand-crafted investigation playbooks by SAP experts

Standard operating procedures

LLM would be inconsistent — sometimes check LFBK, sometimes forget

Layer 3 Live Tools

Real-time RFC/ADT/OData connections to SAP

The laptop connected to SAP

LLM can only advise — can't see real data or fix real code

Layer 4 Skills

48 loadable domain expertise modules

Calling in a specialist consultant

Would handle common cases but fail on complex tasks

Layer 5 Corrections

System-specific memory from past interactions

Institutional knowledge

Would repeat the same mistakes on each interaction

3 Layer 1 — The LLM (The Brain)

🧠 Large Language Model — Where SAP Knowledge Lives

The LLM (Claude by Anthropic) was trained on **billions of pages** of text, which included extensive SAP-related content:
...
Table structures, T-codes, configuration paths, BAPI interfaces

SAP Community & Blogs

Real-world troubleshooting patterns, common errors, best practices

ABAP Documentation & Books

ABAP syntax, CDS views, RAP patterns, Clean Core principles

SAP Notes & KBAs

Bug fixes, migration guides, simplification items

Thousands of SAP Implementations

"When F110 fails, check LFBK, LFB1, BSIK..."

General IT & Business Knowledge

Accounting principles, procurement processes, manufacturing

#### 💡 Key Insight

When you say **"F110 not picking up invoices"**, the LLM already knows:

*   F110 = automatic payment program
*   It reads BSIK for open items
*   It checks LFBK for bank details
*   It checks LFB1 for payment methods and terms
*   It checks T042Z for payment method configuration
*   Common failures: missing bank details, blocked vendor, wrong payment terms

**This is pattern recognition from training data** — the same way an experienced consultant "just knows" what to check. The LLM absorbed that experience from millions of SAP-related documents.

4 Layer 2 — System Prompt (The Playbook)

📋 Curated SAP Expertise — Hand-Crafted by Domain Experts

The LLM's general knowledge is powerful but unfocused. Layer 2 is a **detailed instruction set** written by SAP consultants that provides structured investigation methodologies:

When investigating Accounts Payable:
  ├── Check BSIK (open items) — fields: LIFNR, BELNR, WRBTR, ZLSPR
  ├── Check BSAK (cleared items) — was anything ever paid?
  ├── Check REGUH (payment history) — has F110 ever run?
  ├── Check LFBK (bank details) — does vendor have bank master?
  ├── Check LFB1 (company data) — payment method, terms, blocks
  ├── Check LFA1 (general data) — central blocks, deletion flags
  └── Check T042Z (config) — payment methods configured?

When investigating Procurement:
  ├── Check EKKO / EKPO (PO header / items)
  ├── Check EKBE (GR/IR history)
  ├── Check EBAN (purchase requisitions)
  ├── Check T161 (document types)
  └── Check T024 (purchasing groups)

This is **not LLM training** — this is a structured knowledge base that SAP domain experts wrote and continuously refine:

What's in the System Prompt

Purpose

Table-to-process mappings

"For P2P, check these 12 tables in this order"

Field-level investigation guides

"ZLSPR = payment block, SPERR = central block, ZAHLS = payment block in LFB1"

Root cause decision trees

"If LFBK empty → bank details missing → F110 can't generate payment media"

Quality and zero-fabrication rules

"Never fabricate data. Always cite table + field + evidence."

Industry-specific patterns

How to interpret findings in manufacturing, pharma, retail context

Process investigation methodology

5-phase approach: Scope → Investigate → Analyze → Report → Recommend

#### ⚠️ Why This Layer Matters

Without the System Prompt, the LLM might check LFBK in one investigation but _forget_ to check it in the next. The System Prompt ensures **consistency** — every F110 investigation follows the same comprehensive checklist, every time.

5 Layer 3 — Live SAP Tools (The Hands)

🔌 Real-Time SAP Connectivity — RFC, ADT, OData

The LLM _knows_ LFBK stores bank details. But knowing and **reading** are different. Layer 3 provides actual tools that execute against the live SAP system:
...
Read any SAP database table (BSIK, LFA1, EKKO, etc.)

RFC over HTTPS

ADT REST APIs

Read source code, syntax check, deploy, activate

HTTPS to /sap/bc/adt/

OData Services

Read business objects (POs, vendors, materials)

HTTPS to /sap/opu/odata/

BAPI Calls

Execute business functions (create PO, change vendor)

RFC over SOAP

abapGit Sync

Deploy ABAP code to SAP system

HTTPS to ADT

❌ Without Layer 3 (Generic LLM like ChatGPT)

"You should check LFBK for bank details. Go to transaction FK03, select the vendor, click on Payment Transactions..."

→ Gives advice. User must do all the work.

✅ With Layer 3 (C16)

"LFBK is empty — zero bank details exist for all 10 vendors. Specifically, Tata Steel (100001), Reliance (100002), Infosys (100003) have no bank records. F110 cannot generate payment media."

→ Reads data. Gives evidence-based diagnosis.

**This is the critical difference** between a generic AI chatbot and C16. Layer 3 turns knowledge into action — reading, diagnosing, and fixing within the actual SAP system.

6 Layer 4 — Skills Library (The Specialists)

📚 48 Specialist Domain Modules — Loaded On Demand

C16 has **48 specialized skill modules** that can be loaded dynamically when needed. Each skill contains code templates, validation rules, and step-by-step procedures that go beyond general LLM training:
...
Clean Core Analysis (55 rules), Performance Optimization, ABAP Clean Code Guide

When analyzing Z-programs

Code Generation

RAP Build Guide, CDS Standards, Class Templates, abapGit Expert

When building/deploying code

Process Intelligence

P2P Analysis, O2C Analysis, FI Diagnostics, MM Consulting

When investigating business processes

Migration

S/4HANA Migration, SmartForm-to-Adobe Converter, WebDynpro Migrator

When modernizing legacy objects

Application Building

CAP Build Guide, Fiori App Generator, RAP Auth Handling

When building modern applications

#### 💡 Analogy

The LLM is a **general SAP consultant**. Skills make it a **specialist** — like calling in the FI expert when investigating payments, or the MM expert when investigating procurement. The right specialists are brought in automatically based on the problem domain.

For the F110 payment ticket, **no specialist skill was needed** — the LLM's general SAP knowledge (Layer 1) plus the investigation playbook (Layer 2) were sufficient. But if the user then said _"now analyze the Z-program that customizes F110"_, C16 would load the Clean Core Analysis skill with its 55 classification rules.

7 Layer 5 — Learned Corrections (The Memory)

💾 System-Specific Memory — Mistakes It Won't Repeat

Every time C16 makes an error (deployment failure, wrong field name, syntax error), the correction gets stored and applied to **all future interactions**:

CORRECTION #47:
  Error:   Used field KTOKK from LFA1 — failed on S/4HANA
  Cause:   KTOKK moved to BUT000 in S/4HANA (Business Partner migration)
  Rule:    Always verify DD03L before using ANY field, even standard tables
  Applied: All future code generation

CORRECTION #12:
  Error:   Generated CDS view for deployment on ECC 7.40 — activation failed
  Cause:   ADT lock/update for DDLS not supported on ECC 7.40
  Rule:    Never generate CDS views for deployment on ECC systems
  Applied: All future ECC interactions

CORRECTION #33:
  Error:   Used CHAR60 as data type — compilation failed
  Cause:   CHAR60 is a domain, not a data element; use TYPE c LENGTH 60
  Rule:    Never assume CHAR<n> types exist; always verify via DD03L
  Applied: All future code generation

Over time, C16 accumulates **institutional knowledge** specific to your SAP system — field migrations, naming conventions, system quirks, configuration patterns. This layer gets stronger with every interaction.

8 Live Example: F110 Payment Failure

Let's trace exactly what happens when a user types this ticket:

**User Input:** "Vendor payments failing — F110 not picking up invoices"

### Step 0 — Intent Classification Instant • No SAP call

C16's first action is to silently classify the request. No query is sent to SAP — this is pure AI reasoning:
...
→ **Domain: FI-AP (Accounts Payable)**

"F110"

→ **Process: Automatic Payment Program**

"not picking up invoices"

→ **Symptom: Open items not selected for payment**

No Z-program named

→ **Investigation type: Data/Config (not code review)**

### Step 1 — Root Cause Hypothesis AI Reasoning • No SAP call

The LLM generates a checklist of possible root causes based on its SAP domain knowledge:

F110 not picking up invoices → 9 possible root causes:

  1. No open items exist                → Check BSIK
  2. Items have payment blocks           → Check BSIK.ZLSPR
  3. Vendor missing bank details         → Check LFBK
  4. Vendor missing payment method       → Check LFB1.ZWELS
  5. Vendor missing payment terms        → Check LFB1.ZTERM
  6. Vendor centrally blocked            → Check LFA1.SPERR
  7. Vendor payment-blocked at co. code  → Check LFB1.ZAHLS
  8. Payment method not configured       → Check T042Z
  9. F110 never executed                 → Check REGUH

#### 💡 This Is the Key Moment

C16 translates the user's business problem into a **specific list of SAP tables and fields** to query. No human told it "check LFBK" — it knows from its SAP domain knowledge that F110 requires bank details to generate payment media.

### Step 2 — Live SAP Queries Real Queries • RFC to SAP

C16 now executes actual SQL-level reads against the SAP database via RFC:
...
`SELECT LIFNR, BUKRS, BELNR, WRBTR, BLDAT, ZLSPR FROM BSIK`

2

"Have any payments ever been made?"

`SELECT LIFNR, AUGDT, WRBTR FROM BSAK`

3

"Has F110 ever been executed?"

`SELECT LAUFD, LIFNR, RBETR FROM REGUH`

4

"Do vendors have bank details?"

`SELECT LIFNR, BANKS, BANKL, BANKN FROM LFBK`

5

"Are payment methods and terms maintained?"

`SELECT LIFNR, BUKRS, ZWELS, ZTERM, ZAHLS FROM LFB1`

6

"Are any vendors centrally blocked?"

`SELECT LIFNR, NAME1, SPERR, LOEVM FROM LFA1`

7

"Is payment method config in place?"
...
Each query returns **actual rows with real data** from the live SAP database.

### Step 3 — Cross-Table Pattern Matching AI Analysis • Over Real Data

C16 now has raw data from 8 tables. It cross-references the results:

RESULT: BSIK has 25 open items (₹5.7L)       → Open items EXIST           ✅
RESULT: BSAK is empty                          → Nothing ever paid          ❌ 
RESULT: REGUH is empty                         → F110 never executed        ❌
RESULT: LFBK is empty                          → ZERO bank details          ❌ 🔴 PRIMARY
RESULT: LFB1.ZWELS is blank for all vendors    → No payment method          ❌ 🔴 SECONDARY
RESULT: LFB1.ZTERM has values                  → Payment terms OK           ✅
RESULT: LFA1.SPERR = 'X' for 2 vendors        → 2 vendors blocked          ⚠️
RESULT: T042Z is empty                         → Payment config missing     ❌ 🔴 TERTIARY
RESULT: 3 items have ZLSPR blocks (A, R, B)    → Individual payment blocks  ⚠️

CONCLUSION: F110 cannot pay because:
  1. No bank details (LFBK empty)           — PRIMARY root cause
  2. No payment method on vendors (ZWELS)   — SECONDARY
  3. No payment method config (T042Z)       — TERTIARY  
  4. 3 items individually blocked           — ADDITIONAL
  5. 2 vendors centrally blocked            — ADDITIONAL

**This is pure AI reasoning** — connecting dots across 8 different tables to form a hierarchical diagnosis. No human mapped these specific data relationships for this specific dataset.

### Step 4 — Business Response Natural Language Output

C16 composes the final answer in business language:

**C16 Response:**

"F110 cannot process payments for 3 primary reasons:

1.  **🔴 LFBK is completely empty** — zero bank details exist for any vendor (Tata Steel, Reliance, Infosys, L&T, Wipro, Bosch, Siemens, Mahindra, HUL, ABB). F110 requires bank master data to generate payment media.
2.  **🔴 ZWELS (payment method) is blank** for all vendors in LFB1. No payment method assigned means F110 cannot determine how to pay.
3.  **🔴 T042Z is empty** — payment method configuration does not exist in the system.

Additionally, 3 invoices carry individual payment blocks (A, R, B) and 2 vendors (Wipro, HUL) are centrally blocked.

**Recommendation:** Maintain bank details in FK02 for all 10 vendors. Configure payment methods in FBZP. Release payment blocks on the 3 affected invoices via FBL1N."
...
"Vendor payments failing — F110 not picking up invoices"

▼

L1

**Layer 1: LLM Knowledge**

"F110 reads BSIK, needs LFBK bank details, checks LFB1 payment method, uses T042Z config. Common failures: missing bank, payment block, wrong terms."

**Source:** Trained on SAP documentation, blogs, implementation guides
...
"For AP investigation, check these tables in this order: BSIK → BSAK → REGUH → LFBK → LFB1 → LFA1 → T042Z. For each, check these specific fields. Cross-reference results. Never fabricate."

**Source:** Hand-crafted by SAP consultants

▼

L3

**Layer 3: Live SAP Tools**

→ RFC\_READ\_TABLE(BSIK) → 25 open items (₹5.7L)  
→ RFC\_READ\_TABLE(LFBK) → **EMPTY!**  
→ RFC\_READ\_TABLE(LFB1) → **ZWELS blank on all vendors!**  
→ RFC\_READ\_TABLE(REGUH) → **EMPTY — F110 never ran!**

**Source:** Real-time SAP database reads via RFC over HTTPS

▼

L4

**Layer 4: Skills (if needed)**

Not loaded for this investigation — standard AP investigation covered by Layers 1-3. Would load if user asked "now analyze the Z-program" or "generate a fix."

**Source:** 48 loadable specialist modules

▼

L5

**Layer 5: Learned Corrections**

"On this system, T042Z is empty — don't assume payment methods exist. Always verify LFBK before concluding bank details are present."

**Source:** Previous interactions with THIS specific SAP system
...
"Root cause: 3 issues found. (1) LFBK empty — no bank details. (2) ZWELS blank — no payment method. (3) 3 items payment-blocked. Recommendation: Maintain bank details in FK02..."

**\+ Optional:** Generate full HTML diagnostic report with evidence tables

10 Layer Contribution Analysis

Each layer contributes a different percentage of the total value. Remove any one and the system degrades significantly:
...
SAP domain knowledge, natural language understanding, cross-table reasoning
...
Structured methodology, consistency, quality enforcement

Investigation would be hit-or-miss — inconsistent across runs

Live Tools

**~25%**

Real data reads, code deployment, validation against live system

LLM can only give advice — becomes a generic chatbot

Skills

**~12%**

Deep specialist knowledge for complex tasks (RAP, Clean Core, forms)

Common cases work; complex technical tasks fail

Corrections

**~8%**

System-specific memory, error prevention, accumulated wisdom

Same mistakes repeated in each interaction

#### ⚠️ Key Takeaway

The LLM provides ~35% of the value (knowledge + reasoning). The other 4 layers provide the remaining ~65% (structure + connectivity + specialization + learning). **An LLM alone is necessary but not sufficient.** The combination of all 5 layers is what makes C16 an effective SAP support tool.

11 C16 vs. Traditional Support vs. Generic AI

Capability

Traditional Support Analyst

Generic AI (ChatGPT)

C16

**Understands "F110 not picking up invoices"**
...
**Knows which tables to check**

✅ Experienced analyst does

✅ Can list them

✅ Knows and has structured checklist

**Can READ the actual SAP data**

✅ Via SE16N, FK03, FBL1N

❌ **No — cannot connect to SAP**

✅ Via RFC\_READ\_TABLE, live queries

**Cross-references 8 tables**

⚠️ Manual, 30-60 minutes

❌ Can only describe what to check

✅ Automatic, ~90 seconds

**Produces evidence-based diagnosis**

✅ In an email after 1-2 hours

❌ Generic advice only

✅ With specific vendor IDs, amounts, dates

**Generates diagnostic report**

⚠️ Manual, 2-4 hours in Word

⚠️ Template-quality (no real data)

✅ Full HTML report in 2 minutes

**Fixes code issues**

✅ Manual coding in SE38, 2-8 hours

⚠️ Can suggest code (may have errors)

✅ Generates, deploys, validates in 10 min
...
**Total time: F110 ticket**

⚠️ **45-60 minutes**

❌ Cannot resolve (no data access)

✅ **~90 seconds**

12 The Honest Answer: "Is It Just an LLM?"

**No — but the LLM is the foundation.**

The LLM provides the SAP domain knowledge and reasoning ability. But without structured methodology (Layer 2), live SAP connectivity (Layer 3), specialist modules (Layer 4), and system-specific memory (Layer 5), it would be just another chatbot giving generic SAP advice.

The magic is in the **combination**. Five layers, each amplifying the others, producing a system that can investigate, diagnose, fix, and document — not just advise.
...
"F110 not picking up invoices"

"Check LFBK for bank details" _(advice only)_

_Doesn't know which table to read_

"LFBK is empty for all 10 vendors. Here's the fix." _(diagnosis + evidence)_

"Z\_REPORT is slow"

"Look for SELECT \* in LOOPs" _(generic tip)_

_Can read the code but doesn't know what to look for_

"Line 342: SELECT \* inside LOOP hits 500K rows. Score: 23/100. Here's optimized code." _(specific fix)_

"POs stuck in release"

"Check FRGKE and release strategy" _(textbook answer)_

_Can read EKKO but doesn't know FRGKE is the key field_

"50 POs have FRGKE blank — no release strategy configured for doc type NB." _(root cause)_

13 What to Tell the Technical Team

### 📋 Recommended Explanation for Daikin's Technical Stakeholders

_"C16 combines a large language model trained on SAP documentation with structured investigation methodologies, live RFC/ADT connectivity to your SAP system, 48 specialist skill modules, and a self-correcting feedback loop._

_The LLM provides the SAP domain expertise — knowing which tables, fields, and relationships matter for any given problem. The tooling layer lets it actually read your data and deploy code. The methodology layer ensures consistency — every investigation follows the same comprehensive checklist. The skills library adds specialist depth for complex tasks. And the correction layer means it gets better over time with your specific system._

_The result is an AI that doesn't just advise — it investigates, diagnoses, and acts."_
...
The LLM component can, but Layer 3 (live tools) grounds it in real data. Every finding must cite a specific table + actual value. The zero-fabrication policy prevents stating anything not backed by a live query.

"Does it modify our data?"

By default, C16 only **reads** data. Code deployment requires explicit user approval. No master data or transactional data is modified without a human confirming the action.

"Is our data sent to the cloud?"

The LLM processes the query text and SAP data in memory. No SAP data is stored or used for model training. SAP credentials are encrypted at rest (AES-256-GCM).

"What SAP access does it need?"

A service user with RFC + ADT roles (S\_RFC, S\_DEVELOP, S\_TABU\_NAM). No SAP\_ALL. Least-privilege model — we provide the exact role template.

"What if it gets something wrong?"

Every answer cites its evidence. If a finding says "LFBK is empty", the user can verify in FK03. The correction layer also ensures the same mistake isn't repeated.

"Does it replace our support team?"

No — it **augments** them. It handles the first 80% of investigation (data gathering, cross-referencing, root cause analysis) in 2 minutes. The support team focuses on decisions and complex fixes.

C16 — SAP Intelligence Platform

Technical Architecture Reference Document — POC Preparation

Generated: 24 April 2026 | Classification: Internal — POC Material

All data referenced in examples comes from live SAP system queries via RFC\_READ\_TABLE and ADT REST APIs.

Layer contribution percentages are approximate and vary by task type.
