  C16 — Change Request Management & Delivery Architecture Blueprint :root { --c16-primary: #6B3FA0; --c16-secondary: #8B5CF6; --c16-accent: #B5567A; --c16-gold: #C97B3A; --c16-dark: #1e1e2e; --c16-light: #f8f9fc; --c16-success: #27ae60; --c16-warning: #e67e22; --c16-danger: #e74c3c; --c16-info: #3498db; } \* { margin: 0; padding: 0; box-sizing: border-box; } body { font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Arial, sans-serif; background: #e9ecef; color: #2c3e50; line-height: 1.7; font-size: 15px; } .doc-wrapper { max-width: 1140px; margin: 30px auto; background: #ffffff; box-shadow: 0 4px 24px rgba(0,0,0,0.12); border-radius: 12px; overflow: hidden; } /\* Header Banner \*/ .header-banner { background: linear-gradient(135deg, #C97B3A, #B5567A, #6B3FA0); color: #fff; padding: 50px 60px; position: relative; overflow: hidden; } .header-banner::after { content: ''; position: absolute; top: -50%; right: -20%; width: 500px; height: 500px; background: rgba(255,255,255,0.05); border-radius: 50%; } .header-banner img { height: 55px; margin-bottom: 16px; border-radius: 8px; } .header-banner h1 { font-size: 2.2em; font-weight: 700; margin-bottom: 8px; letter-spacing: -0.5px; } .header-banner .subtitle { font-size: 1.15em; opacity: 0.92; font-weight: 400; margin-bottom: 20px; } .header-meta { display: flex; gap: 24px; flex-wrap: wrap; margin-top: 16px; } .header-meta .meta-item { background: rgba(255,255,255,0.15); padding: 6px 16px; border-radius: 20px; font-size: 0.88em; backdrop-filter: blur(4px); } /\* Document Body \*/ .doc-body { padding: 50px 60px; } /\* Classification Banner \*/ .classification-banner { background: linear-gradient(135deg, #1e1e2e, #2d2d44); color: #fff; padding: 14px 24px; text-align: center; font-size: 0.85em; letter-spacing: 2px; text-transform: uppercase; font-weight: 600; } /\* Table of Contents \*/ .toc { background: linear-gradient(135deg, #f8f4ff, #f0e8ff); border: 1px solid #e0d4f5; border-radius: 10px; padding: 30px 36px; margin-bottom: 40px; } .toc h2 { color: var(--c16-primary); font-size: 1.3em; margin-bottom: 16px; border-bottom: 2px solid var(--c16-accent); padding-bottom: 8px; } .toc ol { columns: 2; column-gap: 40px; padding-left: 20px; } .toc li { margin-bottom: 8px; font-size: 0.95em; break-inside: avoid; } .toc a { color: var(--c16-primary); text-decoration: none; font-weight: 500; } .toc a:hover { text-decoration: underline; } /\* Section Headers \*/ h2.section-title { color: var(--c16-primary); font-size: 1.55em; margin: 45px 0 20px 0; padding-bottom: 10px; border-bottom: 3px solid var(--c16-accent); display: flex; align-items: center; gap: 14px; } h2.section-title .num { background: var(--c16-accent); color: #fff; width: 34px; height: 34px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.75em; font-weight: 700; flex-shrink: 0; } h3 { color: var(--c16-primary); font-size: 1.2em; margin: 28px 0 14px 0; padding-left: 14px; border-left: 4px solid var(--c16-accent); } h4 { color: #4a3670; font-size: 1.05em; margin: 20px 0 10px 0; } /\* Tables \*/ table { width: 100%; border-collapse: collapse; margin: 16px 0 24px 0; font-size: 0.92em; } thead th { background: var(--c16-primary); color: #fff; padding: 12px 16px; text-align: left; font-weight: 600; font-size: 0.9em; text-transform: uppercase; letter-spacing: 0.5px; } tbody td { padding: 10px 16px; border-bottom: 1px solid #eee; vertical-align: top; } tbody tr:nth-child(even) { background: #f8fafc; } tbody tr:hover { background: #edf2f7; } /\* KPI Cards \*/ .kpi-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 18px; margin: 24px 0; } .kpi-card { background: linear-gradient(135deg, #f8f4ff, #fff); border: 1px solid #e0d4f5; border-radius: 10px; padding: 22px; text-align: center; transition: transform 0.2s; } .kpi-card:hover { transform: translateY(-3px); box-shadow: 0 6px 16px rgba(107,63,160,0.12); } .kpi-card .kpi-value { font-size: 2em; font-weight: 800; color: var(--c16-primary); margin-bottom: 4px; } .kpi-card .kpi-label { font-size: 0.85em; color: #666; font-weight: 500; } /\* Callout Boxes \*/ .callout { border-radius: 10px; padding: 20px 24px; margin: 20px 0; } .callout-vision { background: linear-gradient(135deg, #f0f8ff, #e8f4fd); border-left: 5px solid var(--c16-info); } .callout-principle { background: linear-gradient(135deg, #f6fef9, #e8f8ed); border-left: 5px solid var(--c16-success); } .callout-decision { background: linear-gradient(135deg, #fff8f0, #fef3e6); border-left: 5px solid var(--c16-warning); } .callout-critical { background: linear-gradient(135deg, #fff5f5, #fee); border-left: 5px solid var(--c16-danger); } .callout-purple { background: linear-gradient(135deg, #f8f4ff, #f0e8ff); border-left: 5px solid var(--c16-primary); } .callout h4 { margin-top: 0; margin-bottom: 8px; } /\* Architecture Diagram Boxes \*/ .arch-tier { border: 2px solid var(--c16-primary); border-radius: 10px; margin: 16px 0; overflow: hidden; } .arch-tier-header { background: var(--c16-primary); color: #fff; padding: 10px 20px; font-weight: 700; font-size: 1em; } .arch-tier-body { padding: 20px; background: #faf8ff; } /\* Flow Arrows \*/ .flow-arrow { text-align: center; font-size: 2em; color: var(--c16-accent); margin: 8px 0; } /\* Status Badges \*/ .badge { display: inline-block; padding: 3px 12px; border-radius: 12px; font-size: 0.82em; font-weight: 600; color: #fff; } .badge-available { background: var(--c16-success); } .badge-planned { background: var(--c16-info); } .badge-future { background: var(--c16-warning); } .badge-notstarted { background: #95a5a6; } .badge-functional { background: #2ecc71; } .badge-development { background: #3498db; } .badge-mixed { background: #9b59b6; } .badge-s { background: #27ae60; } .badge-m { background: #2980b9; } .badge-l { background: #e67e22; } .badge-xl { background: #e74c3c; } /\* Question Cards \*/ .question-section { margin: 30px 0; } .question-card { background: #fff; border: 2px solid #e0d4f5; border-radius: 10px; padding: 24px 28px; margin: 18px 0; position: relative; } .question-card::before { content: 'Q'; position: absolute; top: -12px; left: 20px; background: var(--c16-accent); color: #fff; width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 0.85em; } .question-card .q-id { font-weight: 700; color: var(--c16-primary); font-size: 1.05em; margin-bottom: 6px; } .question-card .q-text { font-size: 1em; margin-bottom: 12px; font-weight: 600; color: #2c3e50; } .question-card .q-options { background: #f8f9fc; border-radius: 8px; padding: 14px 18px; margin-top: 10px; } .question-card .q-options p { margin: 6px 0; font-size: 0.93em; } .question-card .q-context { font-size: 0.88em; color: #666; margin-top: 10px; font-style: italic; } .answer-box { background: #fff; border: 2px dashed #ccc; border-radius: 8px; padding: 14px 18px; margin-top: 12px; min-height: 50px; color: #999; font-style: italic; font-size: 0.9em; } /\* Code Blocks \*/ pre { background: #f5f5f5; border-left: 4px solid var(--c16-accent); padding: 16px 20px; border-radius: 6px; overflow-x: auto; font-family: 'Cascadia Code', 'Fira Code', 'Consolas', monospace; font-size: 0.88em; line-height: 1.5; margin: 14px 0; } code { font-family: 'Cascadia Code', 'Fira Code', 'Consolas', monospace; background: #f0ecf5; padding: 2px 6px; border-radius: 4px; font-size: 0.9em; color: var(--c16-primary); } /\* Pipeline Steps \*/ .pipeline { display: flex; flex-wrap: wrap; gap: 4px; margin: 20px 0; align-items: center; } .pipeline-step { background: linear-gradient(135deg, var(--c16-primary), var(--c16-secondary)); color: #fff; padding: 10px 18px; border-radius: 8px; font-size: 0.85em; font-weight: 600; text-align: center; min-width: 110px; } .pipeline-arrow { font-size: 1.4em; color: var(--c16-accent); font-weight: 700; } /\* Comparison Grid \*/ .compare-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 20px 0; } .compare-box { border: 2px solid #e0d4f5; border-radius: 10px; padding: 20px; background: #faf8ff; } .compare-box h4 { color: var(--c16-primary); margin-bottom: 12px; } /\* Footer \*/ .doc-footer { background: linear-gradient(135deg, #1e1e2e, #2d2d44); color: rgba(255,255,255,0.7); padding: 30px 60px; font-size: 0.85em; } .doc-footer a { color: var(--c16-secondary); text-decoration: none; } .doc-footer strong { color: #fff; } /\* Lists \*/ ul, ol { margin: 8px 0 16px 24px; } li { margin: 4px 0; } /\* Emphasis \*/ .highlight { background: #fff3cd; padding: 2px 6px; border-radius: 3px; } strong { color: #2c3e50; } /\* Print \*/ @media print { body { background: #fff; } .doc-wrapper { box-shadow: none; margin: 0; max-width: 100%; } .header-banner { -webkit-print-color-adjust: exact; print-color-adjust: exact; } .question-card { break-inside: avoid; } } /\* Responsive \*/ @media (max-width: 768px) { .header-banner, .doc-body, .doc-footer { padding: 24px; } .toc ol { columns: 1; } .kpi-grid { grid-template-columns: 1fr 1fr; } .compare-grid { grid-template-columns: 1fr; } .pipeline { flex-direction: column; align-items: stretch; } .pipeline-arrow { text-align: center; transform: rotate(90deg); } } :root{--c16-purple-1:#6B3FA0;--c16-purple-2:#8B5CF6;--c16-ink:#1f2937;--c16-sub:#4b5563;--c16-rule:#e5e7eb;--c16-accent:#faf5ff;}

INTERNAL — Architecture Review Draft — Not for External Distribution
...
# Change Request Management & Delivery Architecture

Enterprise Blueprint — How C16 Manages the Full CR Lifecycle from Intake to Go-Live

📋 Document Type: Architecture Blueprint 📅 Date: 01 May 2026 🔖 Version: 1.0 — Draft for Review 👥 Audience: Architecture & Delivery Team 📌 Status: Awaiting Feedback

## 📑 Table of Contents

1.  [Vision & Problem Statement](#vision)
2.  [CR Definition, Scope & Deliverables](#cr-definition)
3.  [Intake Channel Landscape](#intake-landscape)
4.  [Architecture Overview — 3-Tier Model](#architecture)
5.  [Tier 1: Universal Intake Parser](#tier1)
6.  [Tier 2: CR Classification Engine](#tier2)
7.  [Tier 3: CR Delivery Pipeline](#tier3)
8.  [Standard CR Envelope Schema](#cr-envelope)
9.  [Batch CR Processing](#batch)
10.  [Intake Modes — Detailed Walkthrough](#intake-modes)
11.  [Universal Semantic Field Mapping](#field-mapping)
12.  [Current Capabilities vs Roadmap](#capabilities)
13.  [Quality Gates & Governance](#quality-gates)
14.  [Risks, Constraints & Assumptions](#risks)
15.  [Decision Points — Questions for Review](#questions)

## 1 Vision & Problem Statement

#### 🎯 Vision Statement

C16 becomes the **single intelligent platform** that receives Change Requests from _any source_, in _any format_, classifies them, investigates the SAP system, designs the solution, generates the deliverables (Functional Specs, Technical Specs, ABAP Code, Config Guides, Test Scripts), deploys to SAP, and tracks completion — **reducing CR cycle time by 60-80%** while ensuring consistent enterprise-grade quality.

### The Problem

Enterprise SAP customers face a consistent pattern of friction in their Change Request lifecycle:
...
**Multi-channel intake chaos**

CRs lost, duplicated, or delayed in triage

CRs arrive via email, Jira, ServiceNow, Excel, documents, meetings — no single intake point

**Manual classification**

2-5 days wasted per CR on triage

Human effort to read, classify (Functional vs Dev), estimate effort, assign module

**Knowledge silos**

Design quality depends on who's available

Functional consultants and developers hold tribal knowledge not captured in systems

**Document generation overhead**

FS/TS/Test Scripts take 3-10 days per CR

Manual authoring from scratch; inconsistent templates; copy-paste errors

**SAP investigation bottleneck**

Analysis delayed waiting for system access

Consultants need to log into SAP, navigate multiple transactions, read config manually

**Code-test-deploy cycle**

Multiple iterations, regression risks

Manual coding without automated validation; deployment errors; missed dependencies

**No traceability**

Audit gaps, compliance risk

Requirement → Design → Code → Test mapping is informal or missing

### The C16 Proposition

C16 addresses every pain point by acting as an **AI-powered SAP delivery engine** that:

*   Accepts CRs from **any source system** — without requiring changes to the customer's existing tooling
*   Normalizes and classifies CRs **automatically** using semantic understanding
*   Investigates the **live SAP system** to understand current state before designing solutions
*   Generates **all deliverables** (FS, TS, Code, Tests, Docs) with traceability back to requirements
*   Deploys code to SAP and validates via **automated testing**
*   Provides a **consistent, auditable trail** from intake to go-live

## 2 CR Definition, Scope & Deliverables

### What is a Change Request?

A **Change Request (CR)** is a formal proposal to modify, enhance, or fix functionality in an existing SAP system that is in production. CRs are the primary mechanism through which enterprise customers evolve their SAP landscape post go-live.

#### FUNCTIONAL Functional Change Request

Changes to **business processes, configuration, master data rules, or standard SAP customizing** — handled without custom ABAP code.

**Scope:**

*   IMG Configuration (company codes, plants, pricing, output, number ranges)
*   Process Changes (order types, release strategies, movement types)
*   Master Data Rules (material types, account groups, field status)
*   Authorization (roles, org values, SoD)
*   Standard Reporting (variants, job scheduling)
*   Workflow (approval rules, agent determination)
*   Integration Config (IDoc profiles, RFC destinations)

#### DEVELOPMENT Development Change Request

Changes requiring **custom ABAP development, enhancements, interfaces, conversions, extensions, forms, or reports**.

**Scope:**

*   Reports (Z-programs, ALV, batch, extraction)
*   Enhancements (User Exits, BAdIs, Enhancement Spots)
*   Interfaces (IDoc, RFC, OData, file-based)
*   Conversions (LSMW, BDC, data migration)
*   Forms (SmartForms, Adobe Forms, SAPscript)
*   RAP / Fiori Apps (S/4HANA only)
*   Bug Fixes & Performance Optimization

### Deliverables per CR Type
...
C16 can generate **all 15 deliverables** today. The architecture challenge is not _what_ C16 can produce — it's _how CRs enter the system_ and _how delivery is orchestrated_ across a batch of CRs.

## 3 Intake Channel Landscape

Enterprise customers use a wide variety of tools to manage their CRs. C16's architecture must be **tool-agnostic** — it should work regardless of what ITSM, ALM, or project management platform the customer uses.

Category

Tools in the Ecosystem

How CRs Typically Arrive

Data Quality

**ITSM / Service Management**

ServiceNow, BMC Remedy, Zendesk, Freshservice, HP Service Manager, Ivanti

Structured tickets with fields, comments, attachments, approval chains

Medium — Often terse descriptions, missing technical context

**SAP Native**

SAP Solution Manager (ChaRM), SAP Cloud ALM, SAP Focused Build

Structured change documents with transport tracking, blueprints, test plans

High — Well-structured but complex to extract

**ALM / DevOps**

Jira, Azure DevOps, Rally, VersionOne, GitLab Issues, GitHub Issues

User stories, epics, bugs with custom fields, labels, sprints

Medium — Varies by team maturity

**Documents**

Word, PDF, PowerPoint, Google Docs, Confluence pages

Narrative requirement documents (BRD, URD, FS drafts)

High — Detailed but unstructured, needs extraction

**Spreadsheets**

Excel, Google Sheets, CSV exports

Tabular CR lists, requirement matrices, tracker sheets

Variable — From excellent to barely usable

**Collaboration**

Email, Microsoft Teams, Slack, SharePoint

Unstructured conversations, forwarded threads, attachments

Low — Scattered, needs consolidation

**Meetings / Verbal**

Teams/Zoom transcripts, meeting minutes, audio recordings

Verbal requirements, action items, decisions

Low — Ambiguous, requires interpretation

**Custom Portals**

Customer-built request portals, Google Forms, Power Apps

Web form submissions with customer-defined fields

Medium — Structured but non-standard

#### ⚠️ Critical Design Principle

**C16 must NEVER require customers to change their existing tooling.** If they use Jira — they keep using Jira. If they use Solution Manager — they keep using Solution Manager. C16 adapts to the customer, not the other way around.

## 4 Architecture Overview — 3-Tier Model

TIER 1 — INPUT CHANNELS (Any Source, Any Format)
...
C16 accepts CRs from ANY channel without requiring changes to the customer's existing tools.

▼

TIER 2 — UNIVERSAL CR PARSER (C16 Intelligence Layer)
...
Semantic field mapping — understands that "Priority: Highest" (Jira) = "Priority: 1" (ServiceNow) = "Very High" (SolMan)

▼

TIER 3 — STANDARD CR ENVELOPE (Uniform Output)
...
Same processing pipeline regardless of whether the CR came from Jira, Excel, a Word document, or a chat message.

## 5 Tier 1: Universal Intake Parser — Detailed Design

The Universal Intake Parser is the front door of C16's CR management. Its job is to accept _anything_ and produce a _standardized output_. The parser uses **semantic understanding** rather than rigid field mapping — it recognizes intent and meaning, not just structure.

### 5.1 Intake Mode: Document Upload (DOCX, PDF, PPTX)
...
User uploads document to C16 chat

Document content parsed (text, tables, images, embedded objects)

2

AI identifies document structure (headings, sections, appendices)

Structured content map

3

Extracts business requirements, rules, AS-IS/TO-BE, data mappings

Array of discrete requirements (R1, R2, R3...)

4

Detects SAP module from context (table names, transactions, terminology)

Module classification (MM, SD, FI, etc.)

5

Identifies gaps — ambiguous requirements, missing acceptance criteria

Clarification questions for user

6

Populates CR Envelope with extracted data

Normalized CR ready for pipeline

### 5.2 Intake Mode: Spreadsheet Upload (XLSX, CSV)
...
User uploads Excel/CSV to C16 chat

Tabular data parsed

2

AI detects column headers (or infers from data if no headers)

Column mapping

3

Determines format: one-CR-per-row vs one-requirement-per-row vs matrix

Format classification

4

Normalizes columns to CR Envelope fields (see §11 Field Mapping)

Array of CR Envelopes

5

Flags incomplete rows — missing priority, unclear scope, no module

Enrichment request to user

6

Presents summary dashboard: "Found 25 CRs: 8 MM, 6 SD, 5 FI..."

CR Portfolio Summary

### 5.3 Intake Mode: Pasted Ticket Content (Any ITSM / ALM Tool)

The user copies the ticket details from _any_ tool and pastes into C16 chat. C16 recognizes the format semantically:

Source Tool

Typical Paste Format

C16 Recognition Pattern

**Jira**

`PROJ-4521: Title` + Description + Priority + Labels

Detects Jira key pattern (ABC-1234)

**ServiceNow**

`INC0012345` + Short Description + Assignment Group

Detects SNOW number pattern (INC/CHG/REQ)

**Solution Manager**

`SMCR-2024-0089` + Change Description + Component

Detects SolMan structure + SAP component codes

**Azure DevOps**

`User Story #1234` + Acceptance Criteria

Detects ADO work item pattern

**BMC Remedy**

`CR000456` + Category + Description

Detects Remedy format

**Any other**

Freeform text with identifiable fields

Falls back to NLP extraction — finds title, description, priority from context

#### 💡 Design Principle: Graceful Degradation

Even if C16 cannot recognize the source tool format, it **always** falls back to NLP-based extraction. Any text — however unstructured — will produce a CR Envelope. The Envelope may be sparse (requiring enrichment), but the pipeline never rejects input.

### 5.4 Intake Mode: API / Webhook (Programmatic — Future)

For enterprise-scale integration, C16 would expose an API endpoint that accepts tickets programmatically:

POST /api/c16/cr-intake
Content-Type: application/json

{
  "source\_system": "jira",                  // or "servicenow", "solman", "azure\_devops", "custom"
  "source\_ticket\_id": "PROJ-4521",
  "fields": {                               // native fields from source (C16 maps them)
    "summary": "Add GSTIN validation on vendor creation",
    "description": "When creating vendor via XK01...",
    "priority": "High",
    "labels": \["MM", "Vendor", "India-Localization"\],
    "assignee": "functional.consultant@customer.com",
    "reporter": "business.user@customer.com"
  },
  "attachments": \[                          // optional file attachments
    { "filename": "URD\_GSTIN.docx", "url": "https://..." }
  \],
  "callback\_url": "https://customer.webhook.site/c16-updates"  // push status updates back
}

Response would include the normalized CR Envelope plus a C16 tracking ID. Status updates would be pushed back to the source system via the callback URL.

### 5.5 Intake Mode: Conversational (Direct Chat)
...
User describes requirement verbally in chat

Raw text captured

2

C16 decomposes into discrete requirements using NLP

R1, R2, R3... extracted

3

C16 asks structured follow-up questions to fill gaps

Enriched requirements

4

C16 presents back: "Here's what I understood — please confirm"

User validates understanding

5

CR Envelope populated and confirmed

Ready for pipeline

## 6 Tier 2: CR Classification Engine

Once a CR is normalized into the Standard CR Envelope, the Classification Engine auto-classifies it across five dimensions. This enables automated triage, effort estimation, and wave planning.
...
Functional Development Mixed

Functional: config, master data, authorization only. Development: code changes, enhancements, reports. Mixed: both config AND code needed.

**2\. SAP Module**

MM, SD, FI, CO, PP, PM, QM, HR, WM, BASIS, BC, Cross-Module

Detected from: table names mentioned, transaction codes, business terminology, process area keywords.

**3\. RICEFW Category**

**R**eport, **I**nterface, **C**onversion, **E**nhancement, **F**orm, **W**orkflow

Detected from requirement keywords: "report/list/display" → R, "inbound/outbound/integration" → I, "migrate/upload/convert" → C, "validate/check/modify behavior" → E, "print/output/PDF" → F, "approve/route/notify" → W

**4\. Complexity**

Simple (S) Medium (M) Large (L) Very Large (XL)

Based on: number of tables involved, cross-module impact, number of requirements, integration points, data volume

**5\. Risk Level**

Low, Medium, High, Critical

Based on: tables affected (financial = high risk), number of users impacted, cross-module dependencies, data migration involved
...
1-2 IMG steps, single config change

Bug fix, small enhancement (<200 lines), field addition

1-3 days

M — Medium

Multi-step config, new doc type, release strategy

New report, form modification, simple interface (<500 lines)

3-10 days

L — Large

Process change affecting multiple org units

Complex report, new interface, data migration, BAdI implementation (500-2000 lines)

2-4 weeks

XL — Very Large

Cross-module config, new business process end-to-end

Multi-program solution, complex integration, Fiori app (>2000 lines)

4-12 weeks

## 7 Tier 3: CR Delivery Pipeline

This is where C16's power materializes. For each classified CR, C16 executes a **9-phase delivery pipeline** — generating all deliverables automatically while maintaining traceability from requirement to deployment.
...
Reads CR content, decomposes into requirements, identifies SAP module & process, asks clarifying questions

Enriched CR Envelope with R1...Rn requirements

User confirms understanding, answers clarification questions

**② Investigate**

Queries live SAP system — reads current config, existing Z-programs, table structures, master data state, existing enhancements

Current State Assessment: what exists, what's configured, what's missing

None — fully automated

**③ Analyze**

Maps each requirement to standard SAP capability (Fit-to-Standard), identifies gaps, checks existing custom code for reuse

Fit-to-Standard Matrix, Reuse Analysis, Gap List

Architect reviews FIT/GAP classification

**④ Design (FS)**

Generates Functional Specification with process flows (Mermaid), business rules, field mappings, selection screen layout, output layout, validation rules

FS Document (HTML — downloadable)

**APPROVAL GATE:** Functional lead reviews & approves FS

**⑤ Design (TS)**

Generates Technical Specification with program design, class diagrams, table structures, algorithms, error handling strategy, performance considerations

TS Document (HTML — downloadable)

**APPROVAL GATE:** Tech lead reviews & approves TS

**⑥ Build**

Generates ABAP code (programs, classes, includes), config documentation, DDIC objects — following Clean Code standards, verified against live DD

Complete deployable code in C16 container

Code review by developer (C16 provides code review checklist)

**⑦ Test**

Generates functional test scripts, runs ABAP Unit tests, syntax checks, ATC quality checks, API tests for OData services

Test Results Matrix (pass/fail per layer)

QA team executes UAT scripts in QAS

**⑧ Deploy**

Syncs code to SAP DEV system, provides transport list with dependency order, generates deployment runbook

Deployed objects + Transport documentation

**APPROVAL GATE:** Change Advisory Board (CAB) approves transport to QAS/PRD

**⑨ Document**

Generates user documentation, release notes, training material, knowledge base articles

End-user deliverables package

Delivery lead reviews & distributes

#### 🔗 Traceability Chain

Every deliverable links back to the originating requirement. The FS references R1-Rn. The TS references the FS. The code references the TS. The test script validates requirements R1-Rn. This creates a **complete audit trail** from business need to deployed solution.

## 8 Standard CR Envelope Schema

The CR Envelope is the **canonical data model** that C16 uses internally. All intake channels produce this same structure — making the downstream pipeline source-agnostic.

{
  "cr\_id":             "C16-2026-0001",           // Auto-generated or from source
  "source": {
    "system":          "jira",                     // jira | servicenow | solman | azure\_devops | excel | document | chat | api
    "ticket\_id":       "PROJ-4521",                // Original ID in source system
    "url":             "https://jira.customer.com/browse/PROJ-4521"
  },
  "classification": {
    "type":            "development",              // functional | development | mixed
    "module":          "MM",                        // MM | SD | FI | CO | PP | PM | QM | HR | WM | BASIS
    "process\_area":    "P2P",                       // P2P | O2C | R2R | Manufacturing | HR | WM | etc.
    "ricefw":          "E",                         // R | I | C | E | F | W
    "complexity":      "M",                         // S | M | L | XL
    "risk":            "Medium",                    // Low | Medium | High | Critical
    "estimated\_effort": "5 days"
  },
  "business\_context": {
    "title":           "Add GSTIN validation on vendor creation",
    "justification":   "India GST compliance requires valid GSTIN before PO issuance",
    "requestor":       "Procurement Manager — India Operations",
    "priority":        "High",                      // Critical | High | Medium | Low
    "target\_golive":   "2026-06-30",
    "impacted\_users":  45,
    "org\_scope": {
      "company\_codes": \["1000", "2000"\],
      "plants":        \["IN01", "IN02"\],
      "purchasing\_orgs": \["1000"\]
    }
  },
  "requirements": \[
    {
      "id":            "R1",
      "description":   "Validate GSTIN format on XK01/XK02 vendor creation",
      "type":          "development",               // functional | development
      "acceptance":    "GSTIN field must match pattern: 2-digit state + 10-char PAN + 1-digit entity + 1 check digit",
      "priority":      "Must-have"
    },
    {
      "id":            "R2",
      "description":   "GSTIN mandatory for vendors with country = IN",
      "type":          "functional",
      "acceptance":    "Field status group must enforce mandatory GSTIN for Indian vendors",
      "priority":      "Must-have"
    }
  \],
  "current\_state": {
    "description":     "No GSTIN validation exists. Vendors can be created without GSTIN.",
    "existing\_programs": \[\],
    "existing\_exits":  \["EXIT\_SAPMF02K\_001 — currently empty"\],
    "workaround":      "Manual checking via email approval from tax team"
  },
  "desired\_state": {
    "description":     "System validates GSTIN format on save. Invalid GSTIN shows error.",
    "business\_rules":  \["Rule 1: ...", "Rule 2: ..."\],
    "output\_expectations": "Error message with specific validation failure reason"
  },
  "dependencies": {
    "related\_crs":     \["C16-2026-0002"\],
    "prerequisites":   \["GSTIN field must exist on LFA1 (check append structure)"\],
    "system\_constraints": \[\]
  },
  "metadata": {
    "created\_date":    "2026-05-01",
    "last\_updated":    "2026-05-01",
    "status":          "intake",                    // intake | analysis | design | build | test | deploy | complete
    "assigned\_to":     null,
    "phase\_history":   \[\]
  }
}

## 9 Batch CR Processing

Enterprise AMS engagements regularly deliver batches of 20-50+ CRs per quarter. C16 must handle **bulk intake, triage, and sequenced delivery** across the entire portfolio — not just one CR at a time.

### Phase 1: Bulk Intake & Parse

Customer uploads Excel with 30 CRs (or exports from Jira/SNOW/SolMan). C16 parses all rows into CR Envelopes.

### Phase 2: Auto-Classify & Triage

For each CR, the Classification Engine runs. Output: a **CR Portfolio Dashboard** showing:
...
GSTIN validation on vendor create
...
Vendor aging report with bank details
...
PO approval workflow for India
...
CRs grouped into delivery waves based on priority, dependencies, module grouping, and effort balancing:
...
Quick wins — config changes, bug fixes, small enhancements
...
Reports, form changes, moderate enhancements
...
New interfaces, complex reports, BAdI implementations
...
Cross-module solutions, Fiori apps, data migrations

~60 person-days

### Phase 4: Sequential Delivery

C16 processes each CR through the 9-phase delivery pipeline. A **master tracker** shows real-time status:
...
## 10 Intake Modes — Conversation Examples

### 10.1 Document Upload Example

**User:** "Here's the URD for our vendor master enhancement" _\[uploads Vendor\_Enhancement\_URD\_v2.docx\]_

**C16:** "I've read the document (24 pages). I extracted **12 requirements** across 3 areas:

*   4 requirements for GSTIN validation (Development — BAdI on XK01)
*   3 requirements for vendor classification fields (Mixed — config + append structure)
*   5 requirements for vendor report enhancements (Development — new ALV report)

⚠️ Requirements R4 and R7 are ambiguous — can you clarify: Does 'auto-populate state from GSTIN' mean the state field should be set automatically during creation, or should it just validate consistency?"

### 10.2 Excel Batch Upload Example

**User:** "Here are 25 CRs for this quarter" _\[uploads Q3\_Change\_Requests.xlsx\]_

**C16:** "Parsed 25 CRs from your spreadsheet. Here's the portfolio summary:

*   By Module: 8 MM, 6 SD, 5 FI, 4 PP, 2 BASIS
*   By Type: 10 Functional, 12 Development, 3 Mixed
*   By Size: 6 Simple, 10 Medium, 7 Large, 2 Very Large

⚠️ 5 CRs have insufficient detail for analysis (rows 8, 12, 15, 19, 23 — missing descriptions). Shall I ask about those, or should I skip them for now?"

### 10.3 Pasted Jira Ticket Example

**User:** "Here's the Jira ticket:  
PROJ-4521: Add GSTIN validation on vendor creation  
Priority: High | Labels: MM, Vendor, India-Localization  
Description: When creating vendor via XK01, system should validate GSTIN format..."

**C16:** "I recognize this as a Jira ticket (PROJ-4521). I've classified it as:

*   Module: MM (Vendor Master)
*   Type: Development (Enhancement)
*   RICEFW: E — Enhancement (BAdI/Exit on XK01)
*   Complexity: Medium

I've checked your SAP system — EXIT\_SAPMF02K\_001 exists but is empty. I can implement the GSTIN validation there. Shall I proceed with the Functional Specification?"

### 10.4 Solution Manager Paste Example

**User:** "From SolMan: SMCR-2024-0089 | Component: MM-PUR-PO | Delivery block check should prevent PO release when vendor has a delivery block in LFA1-LIFSP..."

**C16:** "Recognized Solution Manager change record (SMCR-2024-0089). This is an Enhancement (RICEFW: E) in MM-PUR-PO. I'll check the release strategy BAdI and LFA1 field LIFSP in your system..."

## 11 Universal Semantic Field Mapping

Rather than building rigid connectors per tool, C16 uses **semantic understanding** to map fields from any source system to the CR Envelope. This table shows how the same concept is expressed differently across tools — and how C16 normalizes them.
...
#### 💡 The Mapping is Semantic, Not Syntactic

C16 does not need a pre-configured mapping per tool. It uses **AI-powered semantic understanding** to infer that a column called "Urgency" means the same as "Priority" — even if no mapping table exists. This makes C16 future-proof against any new tool the customer might adopt.

## 12 Current Capabilities vs Roadmap
...
**Read uploaded documents** (DOCX, PDF, XLSX, PPTX)

Available Today

C16 reads and analyzes any uploaded file

**Parse pasted ticket content** from any tool

Available Today

Semantic NLP extraction from any text format

**Auto-detect SAP module** from context

Available Today

NLP-based module detection from keywords, tables, transactions

**Investigate live SAP system**

Available Today

Read tables, config, programs, enhancements, master data

**Fit-to-Standard analysis**

Available Today

Map requirements to standard SAP, identify gaps

**Generate Functional Specification**

Available Today

Full FS with process flows, field mappings, business rules

**Generate Technical Specification**

Available Today

Full TS with program design, class diagrams, algorithms

**Generate ABAP code**

Available Today

Complete programs, classes, includes — verified against live DD

**Deploy code to SAP**

Available Today

Automated deploy via abapGit HTTP/ADT with activation

**Run automated tests**

Available Today

Unit tests, syntax checks, ATC, API tests

**Generate test scripts**

Available Today

Functional test scenarios covering positive/negative/boundary

**Generate user documentation**

Available Today

Release notes, user guides, training materials

**Clean Core compliance analysis**

Available Today

Full CC1-CC8 analysis with score, findings, remediation

**SmartForm → Adobe conversion**

Available Today

Automated SmartForm to Adobe Form pipeline

— Future Capabilities (Require Development) —

**Native API connectors** (Jira, SNOW, SolMan, ADO)

Planned

Direct API integration to pull/push tickets programmatically

**Persistent CR state tracking** across sessions

Planned

CR database with status history, deliverable links

**Batch processing dashboard**

Planned

Visual portfolio view with wave planning, progress tracking

**Push deliverables back to source**

Planned

Attach FS/TS/code to Jira ticket, update ServiceNow status

**Multi-user collaboration** on same CR

Future

Multiple team members working on the same CR in parallel

**CR analytics & metrics**

Future

Cycle time analysis, throughput metrics, quality trends

**Automated UAT execution**

Future

Browser automation to execute test scripts in SAP GUI/Fiori

## 13 Quality Gates & Governance

Quality gates define where **human review is mandatory** before C16 proceeds. This ensures enterprise-grade governance while maximizing automation.
...
CR Envelope accuracy, requirement completeness, priority

Yes — for repeat/template CRs

**G1 — Analysis Approval**

③ Analyze

Functional Lead

Fit-to-Standard results, gap classification, approach decision
...
Functional Lead + Business

Business rules, process flows, field mappings, validation logic

No — always requires human sign-off
...
Program design, table structures, algorithms, error handling

Yes — for Simple CRs with standard patterns
...
Code quality, Clean Core compliance, performance, security

No — always requires human review
...
Unit test results, SIT results, UAT pass/fail

No — always requires human sign-off

**G6 — Deploy Approval (CAB)**

⑧ Deploy

Change Advisory Board

Transport list, deployment runbook, rollback plan, risk assessment

No — always requires CAB approval

#### 🔶 Decision Point: Gate Flexibility

Should the gate model be **fixed** (all gates mandatory for all CRs) or **risk-based** (Simple/Low-risk CRs skip some gates, Complex/High-risk CRs go through all)?

See **Question Q7** in the Decision Points section.

## 14 Risks, Constraints & Assumptions

### Assumptions

*   C16 has connectivity to at least one SAP system (DEV minimum) via the existing HTTP/ADT channel
*   Users can upload files (DOCX, PDF, XLSX, PPTX) to C16 chat — this capability exists today
*   Users can paste text from any source tool — no clipboard restrictions
*   The customer's change management process allows C16-generated deliverables (FS, TS, code) as valid project artifacts
*   Transport management follows standard SAP practice (DEV → QAS → PRD)
...
**Session-based conversations** — C16 doesn't persist state across sessions today

CR context lost if session ends mid-delivery

Planned: CR state database with session-resume capability

**No native API connectors** — Jira/SNOW/SolMan integration requires copy-paste today

Manual step for ticket intake

Phase 2: Build REST API intake endpoint with configurable field mappings

**Single SAP system** — C16 connects to one system at a time

Cannot directly compare DEV vs QAS vs PRD

User switches system connection as needed; transport docs bridge the gap

**No automated SAP GUI interaction** — C16 uses ADT/HTTP, not GUI scripting

Cannot execute IMG config steps or run transactions automatically

Generates step-by-step config guides with screenshots for human execution

**Approval gates require human action** — C16 cannot approve its own work

Pipeline pauses at each gate waiting for human sign-off

Clear notification mechanism; pre-formatted approval checklists
...
**Incomplete CR information** — CRs arrive with insufficient detail

High

Medium

C16 asks structured clarification questions; flags gaps before proceeding

**Misclassification** — AI classifies CR in wrong module or type

Low

Medium

Human review at G0/G1 gates catches misclassification before effort is spent

**Code quality concerns** — Generated code may not meet customer standards

Low

High

Mandatory code review (G4); Clean Core analysis; ATC checks; customer coding standards loaded as skill

**Cross-module dependencies** — CRs may have hidden dependencies

Medium

High

SAP system investigation in Phase ② detects actual dependencies; wave planning respects dependency order

**Customer tool diversity** — New tools emerge that C16 hasn't seen

Low

Low

Semantic NLP parsing handles unknown formats gracefully; worst case = manual enrichment

## 15 Decision Points — Questions for Architect & Delivery Team

The following questions require input from the Architecture and Delivery teams before this blueprint can be finalized. Each question includes context, options, and implications. **Please document your answers or preferences next to each question.**

Q1 — Intake Channel Priority

Which intake channels should we support in Phase 1 (MVP), and which can wait for Phase 2+?

**Option A:** Phase 1 = Document upload + Excel + Chat paste only (works today, zero development needed)

**Option B:** Phase 1 = All of Option A + API endpoint for programmatic intake (moderate development)

**Option C:** Phase 1 = All of Option B + native connectors for top 2-3 tools: Jira + ServiceNow + SolMan (significant development)

Context: Options A works entirely with C16's current capabilities. Option B requires building an API layer. Option C requires building and maintaining tool-specific connectors that may break when tools update their APIs.

Your answer / preference:

Q2 — Connector Architecture (if API/webhooks are chosen)

If we build programmatic intake, should connectors be native (built into C16) or middleware-based (via iPaaS)?

**Option A:** Native connectors — C16 directly calls Jira/SNOW/SolMan APIs (tighter integration, more maintenance burden)

**Option B:** Middleware layer — Customer uses existing iPaaS (MuleSoft, Boomi, Workato, Power Automate) to push CRs to C16's API (loose coupling, customer manages connectors)

**Option C:** Hybrid — C16 exposes a standard webhook/REST endpoint + provides ready-made templates for popular iPaaS platforms

Context: Native connectors are faster to demo but become a maintenance burden across tool versions. Middleware delegates connector maintenance to the customer but adds architectural complexity. Hybrid offers the best of both but requires more upfront design.

Your answer / preference:

Q3 — CR State Persistence

Should C16 maintain persistent CR state across sessions, and if so, what's the storage model?

**Option A:** No persistence — each C16 session is independent. User re-provides context if they return to a CR (simplest, works today)

**Option B:** Session-linked persistence — C16 remembers CRs within a "project" or "engagement" context. User can resume where they left off.

**Option C:** Full CR database — C16 maintains a queryable CR store with status tracking, deliverable links, history, and dashboards. CRs persist indefinitely.

Context: Option A requires no development but loses continuity. Option B is moderate effort and solves the "I'll come back to this later" problem. Option C is a significant product feature that competes with ITSM tools — but provides unmatched traceability.

Your answer / preference:

Q4 — Batch Processing Depth

When a customer uploads 30 CRs at once, how deep should C16 go automatically?

**Option A:** Classify + Estimate only — produce a triage report (CR dashboard with module, type, size, risk). User then selects which CRs to process further.

**Option B:** Classify + FS for each — auto-generate Functional Specification for all 30 CRs (significant output volume).

**Option C:** Classify + FS + TS + Code for each — full delivery pipeline for all CRs (maximum automation, maximum token/compute cost).

**Option D:** User configurable — after triage, user selects per-CR depth: "CR-001: Full delivery, CR-002: FS only, CR-003: Skip"

Context: Generating 30 full deliverable sets in one session may exceed context/token limits. Option D is the most flexible but requires an interactive selection step. Consider cost implications — each CR's full pipeline uses significant AI compute.

Your answer / preference:

Q5 — Delivery Depth per CR Type

Should C16 deliver differently based on CR type (Functional vs Development)?

**Option A:** Uniform pipeline — all CRs go through all 9 phases regardless of type (simpler process, may generate unnecessary artifacts for simple config CRs)

**Option B:** Type-adaptive pipeline:

*   Functional CRs: Understand → Investigate → FS → Config Guide → Test Script (skip TS, Code, Deploy)
*   Development CRs: Full 9-phase pipeline
*   Mixed CRs: Full pipeline with both config guide AND code

**Option C:** Complexity-adaptive — Simple CRs skip phases, Complex CRs go through all

Context: A simple config change (new number range) doesn't need a Technical Specification or code deployment. But skipping phases creates complexity in the pipeline logic.

Your answer / preference:

Q6 — Output Format & Delivery

How should C16 deliver the generated artifacts?

**Option A:** HTML documents in C16 only — user views/downloads from C16 interface

**Option B:** Multi-format export — HTML + DOCX + PDF available for each deliverable

**Option C:** Push-back to source tool — attach deliverables to the original Jira/SNOW/SolMan ticket automatically

**Option D:** Customer SharePoint/Confluence integration — push deliverables to a shared documentation repository

**Option E:** All of the above — configurable per customer engagement

Context: Today C16 generates HTML. DOCX/PDF export is possible via conversion. Push-back to source tools requires API integration (same consideration as Q2). Many enterprise customers require deliverables in their standard document management system.

Your answer / preference:

Q7 — Quality Gate Model

Should quality gates be fixed (all gates for all CRs) or risk-based (gates vary by complexity)?

**Option A:** Fixed — All 7 gates (G0-G6) mandatory for every CR regardless of size (maximum governance, slower cycle time)

**Option B:** Risk-based with three tiers:

*   Simple/Low-risk: G0 → G2 (FS approval) → G6 (CAB) — 3 gates only
*   Medium: G0 → G1 → G2 → G4 (code review) → G5 → G6 — 6 gates
*   Complex/High-risk: All 7 gates mandatory

**Option C:** Customer-configurable — each customer defines their own gate policy

Context: Enterprise customers often have existing change management policies (ITIL, SAP Activate). C16's gate model should complement — not compete with — their existing process. Option C is most flexible but hardest to implement and support.

Your answer / preference:

Q8 — SAP System Interaction Scope

How deep should C16's interaction with the customer's SAP system go during CR delivery?

**Option A:** Read-only investigation — C16 reads tables, config, programs to inform design, but does NOT deploy code. User deploys manually using C16's generated code and runbook.

**Option B:** Full delivery to DEV — C16 deploys code to DEV system. Transport to QAS/PRD is manual (standard change management).

**Option C:** Full delivery to DEV + automated transport creation — C16 creates transport requests in DEV, user releases and imports to QAS/PRD.

**Option D:** End-to-end with gated promotion — C16 deploys to DEV → user approves → C16 assists with QAS testing → user approves → C16 provides PRD transport documentation.

Context: Most enterprise customers have strict separation of duties — the person who develops should NOT transport to production. Option B is the current C16 model. Option D requires multi-system connectivity which adds complexity.

Your answer / preference:

Q9 — CR Template Standardization

Should C16 mandate a standard CR template, or adapt to any format the customer sends?

**Option A:** Fully adaptive — C16 handles ANY format without requiring standardization (maximum flexibility, higher AI complexity)

**Option B:** Recommended template — C16 provides a standard Excel/DOCX template but also accepts non-standard formats (balanced approach)

**Option C:** Mandatory template — customer MUST use C16's standard template for batch uploads; free-form for individual CRs (simplest parsing, least flexible)

Context: Option A is the most user-friendly and the current design direction. Option B gives customers a choice while gently encouraging standardization. Option C simplifies parsing but may face customer pushback ("we already have our own template").

Your answer / preference:

Q10 — Deliverable Template Customization

Should C16's deliverable templates (FS, TS, test scripts) be standardized or customizable per customer?

**Option A:** Standard C16 templates — consistent format across all customers (easiest to maintain)

**Option B:** Customer-branded templates — C16 applies customer's logo, colors, header/footer, section structure (moderate effort)

**Option C:** Fully customizable — customer uploads their own FS/TS template, C16 fills in the content (maximum flexibility, significant effort)

Context: Many enterprise customers have mandatory document templates (e.g., Infosys FS template, Deloitte deliverable format). Using C16's template may require re-formatting or may not pass customer quality reviews. Option C would require template parsing and dynamic content injection.

Your answer / preference:

Q11 — Multi-System Support

Should C16 support multiple SAP systems simultaneously (DEV, QAS, PRD) or one at a time?

**Option A:** Single system — user switches connection manually (current model, simplest)

**Option B:** Multi-system with explicit switching — user says "switch to QAS" and C16 reconnects

**Option C:** Multi-system with landscape awareness — C16 knows about DEV/QAS/PRD simultaneously, can compare configs, track transport status across systems

Context: Enterprise CR delivery inherently spans DEV → QAS → PRD. Today C16 connects to one system. Option C is the most powerful but requires maintaining multiple concurrent SAP connections and understanding transport layers.

Your answer / preference:

Q12 — Pricing & Consumption Model

How should the CR delivery service be priced for enterprise customers?

**Option A:** Per-CR pricing — fixed price per CR based on complexity (S/M/L/XL)

**Option B:** Subscription — monthly/quarterly fee for unlimited CRs (volume-based tiers)

**Option C:** Per-deliverable — charge per FS, per TS, per code deployment (granular, complex billing)

**Option D:** Outcome-based — charge based on CR completion and customer satisfaction score

**Option E:** Hybrid — base subscription + per-CR overage (most common SaaS model)

Context: This affects architecture because pricing model influences: metering, usage tracking, cost optimization, and feature gating. Per-CR pricing requires accurate complexity classification. Subscription requires usage caps or fair-use policies.

Your answer / preference:

Q13 — Functional Configuration Execution

For Functional CRs, should C16 only DOCUMENT config steps, or actually EXECUTE configuration in SAP?

**Option A:** Document only — C16 generates step-by-step config guides with screenshots/transaction paths. Human executes in SAP. (Safe, current model)

**Option B:** Document + Verify — C16 generates guides AND verifies the config was applied correctly after human executes. (Read-only verification)

**Option C:** Direct execution — C16 executes config changes via BAPIs/RFC where possible (e.g., number ranges, output conditions). IMG steps remain manual. (Partial automation)

**Option D:** Full execution — C16 uses SAP GUI scripting or BTP automation to execute IMG config. (Maximum automation, highest risk)

Context: This is a significant architectural decision. Options C/D blur the line between "advisor" and "executor" and may raise governance concerns. However, many config changes ARE automatable via BAPIs (e.g., BAPI\_COMPANYCODE\_CREATE, number range maintenance).

Your answer / preference:

Q14 — Testing Depth

How deep should C16's automated testing go?

**Option A:** Technical only — syntax check, ATC, unit tests (current model, fully automated)

**Option B:** Technical + API — add OData/RFC endpoint testing for interfaces and services

**Option C:** Technical + API + UI — add browser-based Fiori/GUI automation for functional test execution

**Option D:** Full regression suite — C16 generates and maintains a regression test suite per customer that runs on every CR delivery

Context: C16 already does Options A and B today. Option C is partially available (browser automation exists but is limited). Option D is a significant product feature that requires persistent test suite storage and management.

Your answer / preference:

Q15 — Knowledge Accumulation

Should C16 learn from completed CRs to improve future delivery for the same customer?

**Option A:** No learning — each CR is independent (simplest, no data retention concerns)

**Option B:** Pattern library — C16 remembers successful patterns (e.g., "Customer X always uses release strategy pattern Y for India POs") and applies them to future CRs

**Option C:** Full knowledge base — C16 builds a customer-specific knowledge base: coding standards, naming conventions, preferred patterns, architectural decisions, common customizations

Context: Option C is the most powerful — it means CR #50 is delivered faster and better than CR #1 because C16 has learned the customer's landscape, standards, and preferences. However, it requires persistent storage and raises data retention/privacy questions.

Your answer / preference:

Q16 — SLA & Turnaround Commitments

What turnaround time should C16 target for each CR complexity level?

**Proposed SLAs (for discussion):**
...
Note: These are C16 processing times only. Human approval gates (G2, G4, G5, G6) add calendar time based on customer responsiveness.

Context: The SLAs above assume C16 active time only. Real end-to-end time depends heavily on human approval speed. Should we commit to "C16 active time" SLAs or "total elapsed time" SLAs (which we can't fully control)?

Your answer / preference:

Q17 — Scope Boundaries

What types of CRs are explicitly OUT OF SCOPE for C16?

**Proposed exclusions (for validation):**

*   ❌ BASIS / Infrastructure changes (kernel upgrades, OS patches, DB tuning)
*   ❌ SAP Support Package / Enhancement Package application
*   ❌ Security / Authorization redesign (new role framework, SoD remediation)
*   ❌ Data archiving strategy and execution
*   ❌ Greenfield implementation / go-live activities
*   ❌ Third-party tool integration where C16 has no access (e.g., middleware config in MuleSoft)
*   ❓ Landscape optimization (system copy, client management) — in or out?
*   ❓ Performance tuning of standard SAP code — in or out?
*   ❓ User training delivery (C16 generates materials, but who delivers?) — in or out?

Context: Clear scope boundaries prevent customer expectations from exceeding C16's capabilities. The "❓" items are borderline — your input will determine where we draw the line.

Your answer / preference:

Q18 — Engagement Model

How should C16 CR delivery be positioned — as a product, a service, or a hybrid?

**Option A:** Self-service product — Customer accesses C16 directly, uploads CRs, manages their own pipeline. C16 is the tool.

**Option B:** Managed service — Our delivery team operates C16 on behalf of the customer. Customer submits CRs to us, we deliver using C16.

**Option C:** Hybrid — C16 is a product that our delivery team uses. Customer interacts with delivery team; delivery team uses C16 as their accelerator.

**Option D:** Tiered — Simple CRs via self-service (Option A), Complex CRs via managed service (Option B)

Context: This fundamentally shapes the product. Self-service (A) requires polished UX and documentation. Managed service (B) is revenue-generating but needs headcount. Hybrid (C) positions C16 as an internal accelerator for delivery teams. Tiered (D) is the most flexible but complex to sell.

Your answer / preference:

Q19 — Compliance & Audit Requirements

What compliance and audit trail requirements should C16's CR management support?

**Option A:** Basic audit — who submitted, who approved, what was deployed, when (timestamps + user IDs)

**Option B:** Full traceability — Requirement → FS → TS → Code → Test → Deploy mapping with version history at each stage

**Option C:** Regulatory-grade — Full traceability + digital signatures + immutable audit log + SOX/GxP compliance markers + evidence packages

Context: Pharmaceutical, banking, and government customers may require SOX/GxP-compliant change documentation. This affects storage, retention, and tamper-proofing of C16's deliverables.

Your answer / preference:

Q20 — MVP Scope & Timeline

What should be in the Minimum Viable Product (MVP) for the first customer pilot?

**Proposed MVP (for discussion):**
...
Document upload intake (DOCX, PDF, XLSX)

✅ Yes

Works today, zero development
...
Auto-classification (type, module, complexity)

✅ Yes

AI-powered, works today

SAP system investigation
...
Code generation + deploy to DEV

✅ Yes

Works today

Automated testing (syntax + ATC + unit)

✅ Yes

Works today

Batch triage report (Excel → CR dashboard)
...
Moderate effort — needed for ITSM integration

Persistent CR tracking

❓

Requires database — critical for real engagements

Native tool connectors

❌ No

Phase 2 — high effort, tool-specific

Push-back to source tools
...
Phase 3 — significant architecture work

Customer knowledge base

❌ No

Phase 3 — requires persistent storage

**Do you agree with this MVP scope? What would you add or remove?**

Context: The MVP should be demonstrable to a pilot customer within 4-6 weeks. Anything requiring new development (API, persistence, connectors) needs engineering effort estimation.

Your answer / preference:

* * *

### Summary: Quick-Response Table

For convenience, here's a one-line-per-question summary for rapid review:
...
Phase 1 scope: doc+excel+chat vs +API vs +native connectors

Q2

Connector Architecture

Native vs middleware vs hybrid

Q3

CR State Persistence

No persistence vs session-linked vs full database

Q4

Batch Processing Depth

Triage only vs FS for all vs full delivery vs user selects

Q5

Pipeline by CR Type

Uniform vs type-adaptive vs complexity-adaptive

Q6

Output Format

HTML only vs multi-format vs push-back vs repository

Q7

Quality Gates

All gates always vs risk-based vs customer-configurable

Q8

SAP System Scope

Read-only vs deploy to DEV vs transport creation vs multi-system

Q9

CR Template

Fully adaptive vs recommended template vs mandatory template

Q10

Deliverable Templates

Standard vs customer-branded vs fully customizable

Q11

Multi-System

Single system vs switchable vs landscape-aware

Q12

Pricing Model

Per-CR vs subscription vs per-deliverable vs outcome vs hybrid

Q13

Config Execution

Document only vs verify vs partial execution vs full execution

Q14

Testing Depth

Technical only vs +API vs +UI vs regression suite

Q15

Knowledge Accumulation

No learning vs pattern library vs full knowledge base

Q16

SLA Commitments

Validate proposed turnaround times per complexity level

Q17

Scope Boundaries

Validate exclusions + decide on borderline items

Q18

Engagement Model

Self-service vs managed service vs hybrid vs tiered

Q19

Compliance & Audit

Basic vs full traceability vs regulatory-grade

Q20

MVP Scope

Validate proposed MVP feature set and timeline

**C16 — Change Request Management & Delivery Architecture Blueprint**

Version 1.0 — Draft for Architecture & Delivery Team Review

Generated: 01 May 2026 | Classification: Internal — Not for External Distribution

This document captures the proposed architecture for C16's end-to-end CR management capability. It is a **living document** — please annotate directly or provide feedback in a separate response. All answers will be incorporated into Version 2.0.

**Next Step:** Review team provides answers to Q1-Q20 → C16 incorporates feedback → Version 2.0 with finalized architecture → Implementation planning.
