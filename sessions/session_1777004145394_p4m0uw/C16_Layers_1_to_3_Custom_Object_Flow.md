  Layers 1–3: How Custom Objects Flow Through | C16 mermaid.initialize({startOnLoad:true, theme:'base', themeVariables:{ primaryColor:'#6B3FA0', primaryTextColor:'#fff', primaryBorderColor:'#8B5CF6', lineColor:'#B5567A', secondaryColor:'#f0e6ff', tertiaryColor:'#fef3f2' }}); @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap'); \* { margin: 0; padding: 0; box-sizing: border-box; } body { font-family: 'Inter', 'Segoe UI', Arial, sans-serif; background: #e9ecef; color: #2c3e50; line-height: 1.7; font-size: 15px; } .doc-wrapper { max-width: 1120px; margin: 30px auto; background: #fff; border-radius: 16px; box-shadow: 0 8px 32px rgba(0,0,0,0.08); overflow: hidden; } .header-banner { background: linear-gradient(135deg, #C97B3A, #B5567A, #6B3FA0); color: #fff; padding: 48px 56px; } .header-banner img { height: 50px; margin-bottom: 12px; border-radius: 8px; } .header-banner h1 { font-size: 2.2em; font-weight: 800; margin-bottom: 8px; } .header-banner .subtitle { font-size: 1.15em; opacity: 0.92; font-weight: 300; } .header-banner .badge { display: inline-block; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); padding: 4px 16px; border-radius: 20px; font-size: 0.85em; margin-top: 12px; } .content { padding: 48px 56px; } h2 { color: #6B3FA0; font-size: 1.6em; font-weight: 700; margin: 48px 0 20px; padding-bottom: 12px; border-bottom: 3px solid #B5567A; } h2:first-of-type { margin-top: 0; } h3 { color: #4a2d6e; font-size: 1.2em; font-weight: 600; margin: 32px 0 12px; } p { margin: 12px 0; } .layer-badge { display: inline-block; padding: 6px 18px; border-radius: 24px; font-weight: 700; font-size: 0.9em; color: #fff; margin-right: 8px; } .layer-1-badge { background: #6B3FA0; } .layer-2-badge { background: #B5567A; } .layer-3-badge { background: #C97B3A; } .layer-purpose { background: #f8f5ff; border-left: 5px solid #6B3FA0; padding: 16px 24px; border-radius: 0 12px 12px 0; margin: 16px 0 24px; font-size: 1.15em; font-weight: 500; color: #4a2d6e; } /\* Object cards \*/ .object-inventory { background: #1a1a2e; color: #e0e0e0; border-radius: 12px; padding: 32px; margin: 24px 0; font-family: 'Courier New', monospace; font-size: 0.88em; line-height: 1.8; } .object-inventory .inv-title { color: #8B5CF6; font-family: 'Inter', sans-serif; font-size: 1.1em; font-weight: 700; margin-bottom: 16px; letter-spacing: 0.5px; } .obj-card { background: rgba(255,255,255,0.06); border: 1px solid rgba(139,92,246,0.25); border-radius: 8px; padding: 14px 18px; margin: 10px 0; } .obj-type { display: inline-block; background: #6B3FA0; color: #fff; padding: 2px 10px; border-radius: 4px; font-size: 0.82em; font-weight: 700; margin-right: 10px; } .obj-type-exit { background: #e67e22; } .obj-type-badi { background: #2980b9; } .obj-type-append { background: #16a085; } .obj-type-form { background: #c0392b; } .obj-type-routine { background: #8e44ad; } .obj-name { color: #8B5CF6; font-weight: 700; } .obj-desc { color: #b0b0b0; margin-left: 4px; } .obj-detail { color: #888; font-size: 0.9em; margin-top: 4px; } /\* S/4 Delta cards \*/ .delta-section { background: #fef9f0; border: 2px solid #f0d9a8; border-radius: 12px; padding: 28px 32px; margin: 24px 0; } .delta-section h4 { color: #C97B3A; margin-bottom: 12px; font-size: 1.05em; } .delta-item { padding: 6px 0; border-bottom: 1px solid #f0e6d0; } .delta-item:last-child { border-bottom: none; } .delta-icon { margin-right: 8px; } /\* Match boxes \*/ .match-box { display: flex; align-items: stretch; margin: 24px 0; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 12px rgba(0,0,0,0.06); } .match-left { flex: 1; background: #f8f5ff; padding: 20px 24px; border-right: 4px solid #B5567A; } .match-arrow { display: flex; align-items: center; justify-content: center; background: #B5567A; color: #fff; padding: 0 20px; font-size: 1.4em; font-weight: 700; min-width: 60px; } .match-right { flex: 1; background: #fef9f0; padding: 20px 24px; } .match-label { font-size: 0.78em; text-transform: uppercase; letter-spacing: 1px; font-weight: 700; margin-bottom: 6px; } .match-left .match-label { color: #6B3FA0; } .match-right .match-label { color: #C97B3A; } .match-name { font-weight: 700; font-size: 1em; margin-bottom: 4px; } .match-detail { font-size: 0.88em; color: #666; } /\* Verdict badges \*/ .verdict { display: inline-block; padding: 4px 14px; border-radius: 20px; font-weight: 700; font-size: 0.82em; color: #fff; margin-top: 8px; } .verdict-fit { background: #27ae60; } .verdict-config { background: #3498db; } .verdict-extension { background: #e67e22; } .verdict-gap { background: #e74c3c; } .effort-badge { display: inline-block; padding: 3px 12px; border-radius: 12px; font-size: 0.78em; font-weight: 600; color: #fff; margin-left: 8px; } .effort-1 { background: #27ae60; } .effort-2 { background: #2ecc71; } .effort-3 { background: #f39c12; } .effort-4 { background: #e67e22; } .effort-5 { background: #e74c3c; } /\* Triage table \*/ table.triage { width: 100%; border-collapse: collapse; margin: 24px 0; font-size: 0.9em; } table.triage thead { background: #6B3FA0; color: #fff; } table.triage th { padding: 14px 16px; text-align: left; font-weight: 600; } table.triage td { padding: 12px 16px; border-bottom: 1px solid #eee; } table.triage tr:hover { background: #f8f5ff; } table.triage .section-row { background: #f0e6ff; font-weight: 700; color: #6B3FA0; } table.triage .section-row td { border-bottom: 2px solid #B5567A; } .lane-badge { display: inline-block; padding: 4px 14px; border-radius: 16px; font-weight: 700; font-size: 0.82em; color: #fff; } .lane-retire { background: #27ae60; } .lane-cc { background: #6B3FA0; } .lane-remed { background: #e67e22; } /\* Summary box \*/ .summary-box { background: linear-gradient(135deg, #f8f5ff, #fef9f0); border: 2px solid #B5567A; border-radius: 12px; padding: 28px 32px; margin: 32px 0; } .summary-box h4 { color: #6B3FA0; margin-bottom: 16px; font-size: 1.1em; } .summary-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin: 16px 0; } .summary-card { background: #fff; border-radius: 10px; padding: 20px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.06); } .summary-card .num { font-size: 2em; font-weight: 800; color: #6B3FA0; } .summary-card .label { font-size: 0.85em; color: #666; margin-top: 4px; } /\* Trace section \*/ .trace-box { background: #f0faf0; border: 2px solid #27ae60; border-radius: 12px; padding: 0; margin: 32px 0; overflow: hidden; } .trace-header { background: #27ae60; color: #fff; padding: 14px 24px; font-weight: 700; } .trace-layer { padding: 20px 24px; border-bottom: 1px solid #d0e8d0; } .trace-layer:last-child { border-bottom: none; } .trace-layer-badge { display: inline-block; padding: 3px 12px; border-radius: 12px; font-weight: 700; font-size: 0.8em; color: #fff; margin-right: 8px; } .trace-arrow { text-align: center; padding: 6px; color: #27ae60; font-size: 1.5em; } /\* Decision box \*/ .decision-box { background: #fff8e6; border: 2px solid #f0c040; border-radius: 12px; padding: 20px 28px; margin: 24px 0; } .decision-box h4 { color: #b8860b; margin-bottom: 8px; } /\* Progression bar \*/ .progression { display: flex; align-items: center; margin: 16px 0; gap: 0; } .prog-segment { height: 32px; display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; font-size: 0.82em; } .prog-a { background: #27ae60; } .prog-retire { background: #95a5a6; } .prog-remed { background: #e67e22; } /\* Footer \*/ .doc-footer { background: #f8f9fa; border-top: 2px solid #e9ecef; padding: 28px 56px; color: #888; font-size: 0.85em; } .callout { background: #f0faf0; border-left: 5px solid #27ae60; padding: 16px 24px; border-radius: 0 10px 10px 0; margin: 20px 0; } .callout.warning { background: #fff8e6; border-left-color: #f0c040; } .callout.insight { background: #f0f0ff; border-left-color: #6B3FA0; } @media print { body { background: #fff; } .doc-wrapper { box-shadow: none; margin: 0; } .match-box { break-inside: avoid; } table.triage { break-inside: avoid; } } :root{--c16-purple-1:#6B3FA0;--c16-purple-2:#8B5CF6;--c16-ink:#1f2937;--c16-sub:#4b5563;--c16-rule:#e5e7eb;--c16-accent:#faf5ff;}
...
# Layers 1–3: How Custom Objects Flow Through

From Discovery to Triage — A Visual Walkthrough

Enterprise S/4HANA Migration Framework — Appendix A
...
C16 scans ABB's ECC system. Finds every custom object touching the process. No judgement — just inventory.

Layer 2

**What does S/4 offer instead?**

C16 checks what S/4HANA 2025 provides — Fiori apps, Released APIs, Released BAdIs, new capabilities. Doesn't touch ABB's code.

Layer 3

**What do we do with each object?**

Takes each Layer 1 object, holds it against Layer 2's target, classifies it, and decides: Retire / Clean Core Now / Remediate & Schedule.

**Key principle:** You cannot do Layer 3 without completing Layers 1 and 2 first. You need to know BOTH sides (what you have AND what S/4 offers) before you can make triage decisions.

## The Visual Flow

graph LR L1\["**Layer 1**  
DISCOVERY  
12 objects found"\] L2\["**Layer 2**  
S/4 DELTA  
What S/4 offers"\] L3\["**Layer 3**  
TRIAGE  
Per-object decision"\] L1 -->|"Each object"| L3 L2 -->|"S/4 standard for  
that object type"| L3 L3 -->|"3 objects"| R\["🟢 RETIRE"\] L3 -->|"6 objects"| CC\["🟣 CLEAN CORE NOW"\] L3 -->|"3 objects"| RM\["🟠 REMEDIATE &  
SCHEDULE"\] style L1 fill:#6B3FA0,stroke:#4a2d6e,color:#fff style L2 fill:#B5567A,stroke:#8a3d5c,color:#fff style L3 fill:#C97B3A,stroke:#a06020,color:#fff style R fill:#27ae60,stroke:#1e8449,color:#fff style CC fill:#6B3FA0,stroke:#4a2d6e,color:#fff style RM fill:#e67e22,stroke:#c0611a,color:#fff

## Layer 1 Discovery — "What Do We Have?"

C16 connects to the ECC system and scans everything. User exits, BAdI implementations, Z-programs, custom appends, SmartForms, pricing routines, IDoc mappings. It finds objects the customer forgot existed. **Layer 1 doesn't judge. It just finds.**

Here's what C16 discovers for the Sales Order process — 12 custom objects:

LAYER 1 OUTPUT — Raw Inventory: Sales Order Process

PROG Z\_SD\_ORDER\_UPLOAD — BDC program, uploads orders via VA01 screens

800 lines │ Uses CALL TRANSACTION 'VA01' │ Reads Excel → plays BDC recording

EXIT USEREXIT\_SAVE\_DOCUMENT\_PREPARE — Credit check logic inside MV45AFZZ

200 lines │ Reads KNA1, KNB1, KNKK │ 3 hardcoded company-specific credit thresholds

CLAS ZCL\_SD\_PRICING\_ENGINE — Custom pricing calculation framework

1,800 lines │ Bypasses standard condition technique │ ABB's proprietary volume pricing

APPEND ZZ\_PROJECT\_ID on VBAP — Custom field for project tracking

1 field │ Used in 6 reports + 2 interfaces │ Populated via user exit at order entry

SMARTFORM ZSD\_ORDER\_CONFIRM\_SF — Order confirmation with ABB branding

Called via NACE output type ZSO1 │ Header, line items, terms & conditions, logo

PROG Z\_SD\_ECOMM\_INTEGRATION — RFC receiving orders from e-commerce portal

600 lines │ Creates SO via BAPI\_SALESORDER\_CREATEFROMDAT2 │ Already uses BAPI

EXIT USEREXIT\_FIELD\_MODIFICATION — Auto-populates plant based on sales org

40 lines │ Simple IF/ELSE mapping │ 5 sales org → plant rules

BADI Z\_SD\_ATP\_CUSTOM — Custom availability check with safety stock override

350 lines │ Implements BADI\_ATP\_CUST │ Reads KNA1 for customer priority class

PROG Z\_SD\_ORDER\_STATUS\_RPT — ALV report showing sales order status

500 lines │ SELECT from VBAK, VBAP, VBFA, LIKP │ CL\_SALV\_TABLE output

ROUTINE RV61A920 — Volume rebate pricing routine

80 lines │ Custom condition type ZRB1 │ Tiered discount by volume bracket

PROG Z\_SD\_EDI\_ORDER\_MAP — IDoc ORDERS05 custom segment mapping

400 lines │ Maps ZZ fields from EDI partner │ Populates ZZ\_PROJECT\_ID from E1EDP01Z

PROG Z\_SD\_MASS\_PRICE\_UPDATE — BDC program to mass-update pricing via VK11

300 lines │ Uses CALL TRANSACTION 'VK11' │ Reads price list from Excel

That's the complete inventory. **12 objects, no judgement, no classification.** Layer 1 simply answers: "Here's everything that exists."

## Layer 2 S/4HANA Standard Delta — "What Does S/4 Offer Instead?"

C16 checks what S/4HANA 2025 provides as standard replacements. Fiori apps, Released APIs, Released BAdIs, new capabilities. **Layer 2 doesn't touch ABB's code. It maps the target landscape.**

For the object types found in Layer 1, here's what S/4HANA 2025 offers:

#### 🖥️ Transactions → Fiori Apps

✅ VA01/VA02 → **Manage Sales Orders (F1814)**

✅ VK11/VK12 → **Manage Condition Records (F1893)**

✅ VL01N → **Create Outbound Deliveries (F1703)**

✅ VF01 → **Create Billing Documents (F0861)**

#### 🔌 Released APIs (OData & CDS Views)

✅ **API\_SALES\_ORDER\_SRV** — Create, read, update sales orders (replaces BDC)

✅ **API\_SLSPRICINGCONDITIONRECORD\_SRV** — Maintain pricing conditions (replaces BDC)

✅ **I\_SalesOrder / I\_SalesOrderItem** — CDS views for read access

✅ **I\_Customer** — Replaces direct KNA1 access

✅ **I\_CustomerCompany** — Replaces direct KNB1 access

#### 🔧 Released BAdIs (Extension Points)

✅ **SD\_SALES\_DOC\_CHECK** — Replaces USEREXIT\_SAVE\_DOCUMENT

✅ **SD\_SALES\_DOC\_FIELD\_MOD** — Replaces USEREXIT\_FIELD\_MODIFICATION

✅ **BADI\_ATP\_CUST** — Same BAdI, still released in S/4

#### ❌ Deprecated / Not Released for Cloud

❌ User exits in MV45AFZZ — not released, not cloud-compatible

❌ SmartForms — deprecated, Adobe Forms is the target

❌ BDC / CALL TRANSACTION — replaced by Released APIs

#### 🆕 New Capabilities (Not Available in ECC)

🆕 **Key User Extensibility** — Custom fields without code (replaces appends)

🆕 **Output Management 2.0** — Replaces NACE

🆕 **BRF+** — Business rules engine (replaces hardcoded IF/ELSE)

🆕 **Event Mesh** — Replaces custom RFC integrations

That's the target landscape. **Layer 2 tells us what's available. It doesn't decide what to use — that's Layer 3's job.**

## Layer 3 Triage — Matching Each Object to Its Fate

Layer 3 takes **each object from Layer 1**, holds it against **Layer 2's target landscape**, and makes a decision. This is where the work happens.

Watch each of the 12 objects get classified:

### Object 1: Z\_SD\_ORDER\_UPLOAD (BDC Upload)

Layer 1 — What We Have

Z\_SD\_ORDER\_UPLOAD

BDC program, 800 lines  
Plays VA01 screens to create orders  
Reads Excel, fills BDC table, CALL TRANSACTION

→

Layer 2 — What S/4 Offers

API\_SALES\_ORDER\_SRV

Released OData API  
Creates sales orders without screen recording  
One API call replaces entire BDC recording

🟢 FIT — RETIRE Effort: Zero — just switch off

Standard API completely replaces this program. No code needed — retire and redirect users to API or Fiori app F1814.

### Object 2: USEREXIT\_SAVE\_DOCUMENT\_PREPARE (Credit Check)

Layer 1 — What We Have

USEREXIT\_SAVE\_DOCUMENT\_PREPARE

User exit in MV45AFZZ, 200 lines  
Credit check: reads KNA1, KNB1, KNKK  
3 hardcoded company-specific thresholds
...
Same hook point, released container  
CDS views: I\_Customer, I\_CustomerCompany  
Replace KNA1/KNB1 direct access

🟠 FIT WITH EXTENSION Effort Level 3 — BAdI swap, 1-3 days

Move 200 lines into Released BAdI class. Replace KNA1→I\_Customer, KNB1→I\_CustomerCompany. Business logic stays the same — only the container and table references change.

### Object 3: ZCL\_SD\_PRICING\_ENGINE (Custom Pricing Framework)

Layer 1 — What We Have

ZCL\_SD\_PRICING\_ENGINE

Custom class, 1,800 lines  
Bypasses standard condition technique  
Proprietary volume pricing algorithm

→

Layer 2 — What S/4 Offers

Standard Pricing + Released BAdI

Condition technique still works in S/4  
But this code bypasses it entirely  
No direct standard replacement for proprietary logic

🔴 GAP Effort Level 5 — Full rebuild, 3-4 weeks

The entire approach is non-standard. Must redesign: move to standard condition technique with Released BAdI for custom logic, or rebuild as BTP extension. This is a significant effort.

### Object 4: ZZ\_PROJECT\_ID on VBAP (Custom Append Field)

Layer 1 — What We Have

ZZ\_PROJECT\_ID on VBAP

Custom append field  
Used in 6 reports + 2 interfaces  
Populated via user exit at order entry
...
Custom fields without code modification  
Maintained by business key users  
Automatically included in APIs and Fiori

🔵 FIT WITH CONFIG Effort Level 2 — Key User field setup, 2-4 hours

The append technically works on S/4, but Key User Extensibility is the Clean Core approach. Create as a custom field — it's automatically available in Fiori, APIs, and analytics without code.

### Object 5: ZSD\_ORDER\_CONFIRM\_SF (SmartForm)

Layer 1 — What We Have

ZSD\_ORDER\_CONFIRM\_SF

SmartForm for order confirmation  
ABB branding, header, line items, T&Cs  
Called via NACE output type ZSO1

→

Layer 2 — What S/4 Offers

Output Mgmt 2.0 + Adobe Forms

SmartForms are deprecated  
Adobe Forms (SFP) is the target  
Output Management 2.0 replaces NACE

🟠 FIT WITH EXTENSION Effort Level 4 — Form conversion, 1-2 weeks

SmartForm must be converted to Adobe Form. Layout, data bindings, and ABB branding all need to be recreated in SFP. C16 can auto-convert the structure.

### Object 6: Z\_SD\_ECOMM\_INTEGRATION (E-Commerce RFC)

Layer 1 — What We Have

Z\_SD\_ECOMM\_INTEGRATION

RFC program, 600 lines  
Receives orders from e-commerce portal  
Already uses BAPI\_SALESORDER\_CREATEFROMDAT2

→

Layer 2 — What S/4 Offers

API\_SALES\_ORDER\_SRV + Event Mesh

Released API replaces BAPI (minor swap)  
Event Mesh for async integration (strategic)  
Integration Suite for protocol modernisation

🔵 FIT WITH CONFIG Effort Level 2 (basic API swap) — 2-4 hours

The BAPI call works on S/4 (Level B). For basic Clean Core: swap to Released API (Level 2, cheap). For strategic: redesign to Event Mesh (Level 5, deferred to when BTP is ready).

### Object 7: USEREXIT\_FIELD\_MODIFICATION (Plant Auto-Population)

Layer 1 — What We Have

USEREXIT\_FIELD\_MODIFICATION

User exit, 40 lines  
5 IF/ELSE rules: sales org → plant  
...
Released BAdI: SD\_SALES\_DOC\_FIELD\_MOD

Direct replacement BAdI  
Same hook, released container  
Move 40 lines, done

🟠 FIT WITH EXTENSION Effort Level 1 — Container swap, 30 minutes

Move 40 lines from user exit into Released BAdI class. Logic identical. This is the simplest Clean Core conversion possible — costs the same as basic remediation.

### Object 8: Z\_SD\_ATP\_CUSTOM (Custom Availability Check)

Layer 1 — What We Have

Z\_SD\_ATP\_CUSTOM

BAdI implementation, 350 lines  
Implements BADI\_ATP\_CUST  
Reads KNA1 for customer priority class

→

Layer 2 — What S/4 Offers

BADI\_ATP\_CUST — Still Released ✅

Same BAdI, still released in S/4  
Just fix table references  
KNA1 → I\_Customer CDS view

🟠 FIT WITH EXTENSION Effort Level 2 — Fix table refs, 2-4 hours

Lucky case — the BAdI itself is already released. Only fix: change `SELECT FROM KNA1` to `SELECT FROM I_Customer`. Business logic unchanged.

### Object 9: Z\_SD\_ORDER\_STATUS\_RPT (ALV Status Report)

Layer 1 — What We Have

Z\_SD\_ORDER\_STATUS\_RPT

ALV report, 500 lines  
Shows order status from VBAK, VBAP, VBFA, LIKP  
CL\_SALV\_TABLE output

→

Layer 2 — What S/4 Offers

Fiori F1814 + Embedded Analytics

Manage Sales Orders has built-in status view  
I\_SalesOrder CDS provides all fields  
Analytical List Page for custom reporting

🟢 FIT — RETIRE Effort: Zero — standard Fiori replaces it

Standard Fiori app provides the same view with better UX. If ABB needs custom fields in the report, those come from the Key User custom field (Object 4). No custom report needed.

### Object 10: RV61A920 (Volume Rebate Pricing Routine)

Layer 1 — What We Have

RV61A920

Pricing routine, 80 lines  
Custom condition type ZRB1  
Tiered discount by volume bracket

→

Layer 2 — What S/4 Offers

Standard Condition Type BO01

Standard volume rebate condition exists  
Scale-based pricing in condition technique  
Configure scale → done

🔵 FIT WITH CONFIG Effort Level 1 — Config only, 30 minutes

Standard SAP already has volume rebate conditions. Replace custom condition type ZRB1 with standard BO01 and configure the scale brackets. No code needed.

### Object 11: Z\_SD\_EDI\_ORDER\_MAP (IDoc Mapping)

Layer 1 — What We Have

Z\_SD\_EDI\_ORDER\_MAP

IDoc mapping program, 400 lines  
Maps ZZ fields from EDI partner  
Custom segments in ORDERS05

→

Layer 2 — What S/4 Offers

IDoc ORDERS05 — Still Works

IDoc framework unchanged in S/4  
Some segment fields renamed/moved  
Fix field mapping, keep structure

🔵 FIT WITH CONFIG Effort Level 2 — Fix field mapping, 2-4 hours

IDoc framework survives S/4 migration. Fix the 3-4 fields that changed in segment E1EDP01 and update the ZZ field mapping. Functional testing with EDI partner required.

### Object 12: Z\_SD\_MASS\_PRICE\_UPDATE (BDC Mass Pricing)

Layer 1 — What We Have

Z\_SD\_MASS\_PRICE\_UPDATE

BDC program, 300 lines  
Plays VK11 screens to update pricing  
Reads Excel → fills BDC table

→

Layer 2 — What S/4 Offers

API\_SLSPRICINGCONDITIONRECORD\_SRV

Released OData API for pricing maintenance  
One API call replaces BDC recording  
Fiori F1893 for manual updates

🟢 FIT — RETIRE Effort: Zero — standard API replaces it

Same pattern as Object 1. BDC screen recording replaced by Released API. Retire the program, use API for mass updates or Fiori for manual updates.

## Layer 3 Final Output — The Triage Portfolio

All 12 objects are now classified. Here's the complete triage table — this is what the customer sees as the Layer 3 deliverable:
...
🟢 RETIRE — Standard S/4 Replaces These (3 objects, 0 effort)
...
🟣 CLEAN CORE NOW — Cheap to Do Right (6 objects, ~1.5 weeks)
...
🟠 REMEDIATE & SCHEDULE — Too Big for Now, Planned for Later (3 objects)

Z\_SD\_ECOMM\_INTEGRATION

CONFIG

Level 2 (basic) / Level 5 (Event Mesh)

YES — Cloud path

REMED + SCHED

Basic now, Event Mesh Wave 1
...
Wave 1 (Q1) — strategic but 4 weeks exceeds budget

## The Key Decisions in This Portfolio

Five decisions shaped this triage. Each one shows how effort level, strategic value, and budget interact:

#### Decision 1: ZCL\_SD\_PRICING\_ENGINE — Strategic + Level 5 → Remediate & Schedule Wave 1

**Strategic?** Yes — ABB's competitive differentiator.  
**Fits in budget?** No — 4 weeks alone exceeds the Clean Core budget.  
**Decision:** Make it work on S/4 now (basic remediation). Schedule full Clean Core rebuild for Wave 1 (first priority post-go-live, Q1). _Not abandoned — scheduled with a date._

#### Decision 2: Z\_SD\_ECOMM\_INTEGRATION — Strategic + Smart Split

**Strategic?** Yes — cloud path (Event Mesh target).  
**Insight:** This object has TWO effort levels. Basic API swap (Level 2, cheap) makes it Level A now. Event Mesh redesign (Level 5) is the strategic target but BTP isn't ready yet.  
**Decision:** Do the Level 2 swap now (4 hours). Schedule Event Mesh redesign for Wave 1 when BTP is available. _Smart split — get Clean Core now, get strategic later._

#### Decision 3: USEREXIT\_SAVE\_DOCUMENT — Strategic + Level 3 → Clean Core Now

**Strategic?** Yes — regulatory compliance (credit check).  
**Fits in budget?** Yes — only 3 days.  
**Decision:** Clean Core now. Regulatory objects can't wait — the legal risk of deferring outweighs the effort cost.

#### Decision 4: ZSD\_ORDER\_CONFIRM\_SF — NOT Strategic + Level 4 → Remediate & Schedule Wave 2

**Strategic?** No — it's a print form, not a business differentiator.  
**Decision:** SmartForm still works on S/4 (Level D but functional). Schedule Adobe Form conversion for Wave 2 (Q3). No urgency.

#### Decision 5: All Level 1-2 Objects → Clean Core Now, No Discussion

**Key insight:** Level 1-2 Clean Core costs the same as basic remediation. A 30-minute table swap or a 4-hour API change — the effort is identical whether you target Level C or Level A.  
**Decision:** Always do Clean Core for Level 1-2. No triage needed. Just do it right.

## Tracing One Object Through All 3 Layers

Let's follow **USEREXIT\_SAVE\_DOCUMENT\_PREPARE** (the credit check) from discovery to final decision:

📍 Object: USEREXIT\_SAVE\_DOCUMENT\_PREPARE (Credit Check User Exit)

LAYER 1 **Discovery — What is this?**

C16 scans ECC, finds this user exit inside include MV45AFZZ. Reads the source: 200 lines of credit check logic. Accesses tables KNA1 (customer general), KNB1 (customer company), KNKK (credit master). Contains 3 hardcoded company-specific credit thresholds. **No judgement. Just facts.**

▼

LAYER 2 **S/4 Delta — What does S/4 offer for this type of object?**

C16 checks: Released BAdI **SD\_SALES\_DOC\_CHECK** exists and replaces USEREXIT\_SAVE\_DOCUMENT. CDS views **I\_Customer** and **I\_CustomerCompany** replace direct KNA1/KNB1 access. User exits in MV45AFZZ are NOT released for cloud. **Replacement exists.**

▼

LAYER 3 **Triage — What do we do with it?**

**Classification:** FIT WITH EXTENSION  
**Effort Level:** Level 3 — BAdI swap, 1-3 days. Move 200 lines, change table references, keep business logic.  
**Strategic?** YES — regulatory compliance (credit check).  
**Fits in budget?** YES — only 3 days.  
**Decision:** CLEAN CORE NOW — go-live.  
**What to do:** Create Released BAdI implementation class. Move credit check logic. Replace KNA1→I\_Customer, KNB1→I\_CustomerCompany. Keep the 3 company-specific thresholds (or move them to BRF+ in Wave 1).
...
### Level A Progression — The Hero Metric

Here's how the Clean Core score improves through each phase:

At Go-Live (9 of 12 objects at Level A):
...
75% Level A at go-live

After Wave 1 — Q1 (11 of 12):
...
92% Level A after Wave 1

After Wave 2 — Q3 (12 of 12):

9 Level A

3 Retired

100% Level A after Wave 2 🎯

**The key takeaway:** 75% Level A at go-live with only ~2.5 weeks of effort. 100% Level A within 9 months of go-live. This is achieved by doing Level 1-2 Clean Core immediately (costs the same as remediation), triaging strategic Level 3+ objects by budget, and scheduling deferred objects in specific waves with dates.

**One sentence:** Layer 1 finds it. Layer 2 shows what S/4 offers instead. Layer 3 decides what to do with it — retire, clean core now, or remediate and schedule.

**C16 Enterprise S/4HANA Migration Framework** — Appendix A: Layers 1–3 Custom Object Flow  
Version 1.0 │ April 2026 │ Industry-agnostic — applicable to any customer, any process  
Examples use Sales Order (O2C) process for illustration. Same framework applies to P2P, R2R, MTO, HR, WM, PP, QM, PM.
