  Strategic Advisory — Clean Core Levels: What Actually Matters @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap'); \* { margin: 0; padding: 0; box-sizing: border-box; } body { font-family: 'Inter', 'Segoe UI', Arial, sans-serif; color: #1a1a2e; background: #f0f0f5; line-height: 1.7; font-size: 15px; } .doc-wrapper { max-width: 1000px; margin: 30px auto; background: #ffffff; border-radius: 16px; box-shadow: 0 4px 24px rgba(107, 63, 160, 0.08); overflow: hidden; } /\* Header \*/ .header-banner { background: linear-gradient(135deg, #1a1a2e 0%, #16213e 40%, #0f3460 70%, #533483 100%); color: #ffffff; padding: 50px 60px; position: relative; overflow: hidden; } .header-banner::before { content: ''; position: absolute; top: -50%; right: -20%; width: 500px; height: 500px; background: radial-gradient(circle, rgba(107,63,160,0.15) 0%, transparent 70%); border-radius: 50%; } .header-banner img { height: 45px; border-radius: 8px; margin-bottom: 16px; position: relative; z-index: 1; } .header-banner .doc-type { font-size: 0.75em; font-weight: 600; letter-spacing: 3px; text-transform: uppercase; color: #a78bfa; margin-bottom: 8px; position: relative; z-index: 1; } .header-banner h1 { font-size: 2em; font-weight: 800; line-height: 1.2; margin-bottom: 8px; position: relative; z-index: 1; } .header-banner .subtitle { font-size: 1.1em; color: #c4b5fd; font-weight: 300; position: relative; z-index: 1; } .header-banner .meta-line { margin-top: 20px; font-size: 0.8em; color: rgba(255,255,255,0.5); position: relative; z-index: 1; } /\* Content \*/ .content { padding: 50px 60px; } h2 { font-size: 1.5em; font-weight: 700; color: #1a1a2e; margin: 50px 0 20px 0; padding-bottom: 12px; border-bottom: 3px solid #6B3FA0; } h2:first-child { margin-top: 0; } h3 { font-size: 1.15em; font-weight: 600; color: #533483; margin: 30px 0 12px 0; } p { margin-bottom: 16px; color: #374151; } /\* Key Insight Boxes \*/ .insight-box { background: linear-gradient(135deg, #f5f3ff 0%, #ede9fe 100%); border-left: 5px solid #6B3FA0; border-radius: 0 12px 12px 0; padding: 24px 28px; margin: 24px 0; } .insight-box .label { font-size: 0.7em; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; color: #6B3FA0; margin-bottom: 8px; } .insight-box p { font-size: 1.05em; font-weight: 500; color: #1a1a2e; margin-bottom: 0; } .warning-box { background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-left: 5px solid #d97706; border-radius: 0 12px 12px 0; padding: 24px 28px; margin: 24px 0; } .warning-box .label { font-size: 0.7em; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; color: #92400e; margin-bottom: 8px; } .warning-box p { font-weight: 500; color: #78350f; margin-bottom: 0; } .decision-box { background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-left: 5px solid #059669; border-radius: 0 12px 12px 0; padding: 24px 28px; margin: 24px 0; } .decision-box .label { font-size: 0.7em; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; color: #065f46; margin-bottom: 8px; } .decision-box p { font-weight: 500; color: #064e3b; margin-bottom: 0; } /\* Tables \*/ table { width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 0.92em; border-radius: 10px; overflow: hidden; box-shadow: 0 1px 8px rgba(0,0,0,0.04); } thead th { background: #1a1a2e; color: #ffffff; padding: 14px 18px; text-align: left; font-weight: 600; font-size: 0.88em; letter-spacing: 0.3px; } tbody td { padding: 12px 18px; border-bottom: 1px solid #e5e7eb; vertical-align: top; } tbody tr:nth-child(even) { background: #f9fafb; } tbody tr:hover { background: #f3f0ff; } /\* Level Badges \*/ .level-a { display: inline-block; background: #059669; color: #fff; padding: 3px 14px; border-radius: 20px; font-size: 0.82em; font-weight: 700; } .level-b { display: inline-block; background: #2563eb; color: #fff; padding: 3px 14px; border-radius: 20px; font-size: 0.82em; font-weight: 700; } .level-c { display: inline-block; background: #d97706; color: #fff; padding: 3px 14px; border-radius: 20px; font-size: 0.82em; font-weight: 700; } .level-d { display: inline-block; background: #dc2626; color: #fff; padding: 3px 14px; border-radius: 20px; font-size: 0.82em; font-weight: 700; } /\* Status indicators \*/ .status-ok { color: #059669; font-weight: 600; } .status-warn { color: #d97706; font-weight: 600; } .status-block { color: #dc2626; font-weight: 600; } .status-na { color: #6b7280; font-weight: 500; } /\* Distribution Bar \*/ .dist-bar { display: flex; height: 40px; border-radius: 8px; overflow: hidden; margin: 16px 0; box-shadow: 0 2px 8px rgba(0,0,0,0.08); } .dist-bar .segment { display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; font-size: 0.82em; transition: all 0.3s; } .dist-bar .segment:hover { opacity: 0.85; } .dist-legend { display: flex; gap: 20px; flex-wrap: wrap; margin: 8px 0 20px 0; font-size: 0.85em; } .dist-legend span { display: flex; align-items: center; gap: 6px; color: #374151; } .dist-legend .dot { width: 12px; height: 12px; border-radius: 50%; display: inline-block; } /\* Collapsible \*/ details { margin: 16px 0; border: 1px solid #e5e7eb; border-radius: 10px; overflow: hidden; } summary { padding: 16px 20px; background: #f9fafb; cursor: pointer; font-weight: 600; color: #1a1a2e; font-size: 0.95em; user-select: none; display: flex; align-items: center; gap: 10px; } summary:hover { background: #f3f0ff; } summary::marker { color: #6B3FA0; } details\[open\] summary { background: #f3f0ff; border-bottom: 1px solid #e5e7eb; } details .detail-content { padding: 20px 24px; } /\* Code \*/ pre { background: #1a1a2e; color: #e2e8f0; padding: 20px 24px; border-radius: 10px; overflow-x: auto; font-family: 'Cascadia Code', 'Fira Code', monospace; font-size: 0.85em; line-height: 1.6; margin: 16px 0; } code { font-family: 'Cascadia Code', 'Fira Code', monospace; font-size: 0.9em; } /\* Mermaid \*/ .mermaid { text-align: center; margin: 24px 0; padding: 20px; background: #fafafa; border-radius: 12px; } /\* Scenario Cards \*/ .scenario-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin: 20px 0; } .scenario-card { border: 2px solid #e5e7eb; border-radius: 12px; padding: 24px; transition: all 0.2s; } .scenario-card:hover { border-color: #6B3FA0; box-shadow: 0 4px 16px rgba(107, 63, 160, 0.1); } .scenario-card .scenario-title { font-weight: 700; font-size: 1em; color: #1a1a2e; margin-bottom: 8px; } .scenario-card .scenario-verdict { font-size: 0.82em; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 10px; } .scenario-card p { font-size: 0.9em; color: #4b5563; margin-bottom: 0; } .card-green { border-color: #059669; } .card-green .scenario-verdict { color: #059669; } .card-amber { border-color: #d97706; } .card-amber .scenario-verdict { color: #d97706; } .card-red { border-color: #dc2626; } .card-red .scenario-verdict { color: #dc2626; } /\* Big Quote \*/ .big-quote { font-size: 1.3em; font-weight: 300; color: #6B3FA0; border-left: 4px solid #6B3FA0; padding: 16px 24px; margin: 30px 0; font-style: italic; background: #faf5ff; border-radius: 0 10px 10px 0; } /\* Footer \*/ .doc-footer { background: #1a1a2e; color: rgba(255,255,255,0.6); padding: 30px 60px; font-size: 0.8em; display: flex; justify-content: space-between; align-items: center; } .doc-footer strong { color: #a78bfa; } @media print { body { background: #fff; } .doc-wrapper { box-shadow: none; margin: 0; max-width: 100%; } .header-banner { -webkit-print-color-adjust: exact; print-color-adjust: exact; } details { break-inside: avoid; } details\[open\] { break-inside: auto; } } @media (max-width: 768px) { .header-banner, .content, .doc-footer { padding-left: 24px; padding-right: 24px; } .scenario-grid { grid-template-columns: 1fr; } h1 { font-size: 1.5em; } } :root{--c16-purple-1:#6B3FA0;--c16-purple-2:#8B5CF6;--c16-ink:#1f2937;--c16-sub:#4b5563;--c16-rule:#e5e7eb;--c16-accent:#faf5ff;}
...
# Clean Core Levels: What Actually Matters

A decision framework for S/4HANA migration strategy — when to remediate, when to rewrite, and when Level B is perfectly fine.

C16 Strategic Advisory • April 2026 • Industry-Agnostic • Applicable to all S/4HANA migration programmes

## 1\. The Four Levels — In Plain English

SAP classifies every piece of custom ABAP code into four levels based on the APIs and objects it uses. This classification determines where that code can run — and where it can't.
...
**Cloud-Ready.** Uses only SAP Released APIs. Can run anywhere — on-premise, private cloud, public cloud, BTP.

Driving on a highway — all roads open

`SELECT FROM I_SalesOrder`  
`CALL FUNCTION 'BAPI_SALESORDER_CREATEFROMDAT2'` (if released)

Level B

**Stable, Not Released.** Uses classic BAPIs and stable interfaces. Works perfectly on S/4 on-premise. Not certified for cloud.

Driving on a good local road — works fine, but can't access the motorway

`CALL FUNCTION 'REUSE_ALV_GRID_DISPLAY'`  
`CALL FUNCTION 'BAPI_PO_CREATE1'` (stable but not released for cloud)

Level C

**Non-Compliant.** Directly accesses SAP internal tables or uses unreleased interfaces. Works today, may break in future upgrades.

Driving off-road — works now, but no guarantee the path will exist tomorrow
...
**Deprecated / Critical.** Uses obsolete function modules, kernel-level access, or SAP modifications. Active S/4 migration blocker.

Driving on a road that's been officially closed — you might fall off a cliff

`CALL FUNCTION 'WS_UPLOAD'`  
SAPscript `OPEN_FORM`  
User exit in `MV45AFZZ`  
`EXEC SQL`

Key Insight

The level is determined by the WORST dependency in your code. If a 5,000-line program uses Released APIs everywhere except one `SELECT FROM KNA1` on line 3,200 — the entire program is Level C.

## 2\. Where Does ECC Code Actually Sit Today?

Most enterprises assume their ECC custom code is a mix of "good and bad." The reality is more specific — and more skewed towards Level C than most expect.

### Typical ECC Code Distribution
...
Level A (~5%) Level B (~20%) Level C (~50%) Level D (~25%)

This means **75% of a typical enterprise's custom code is Level C or D**. The 20% at Level B exists because some developers already used BAPIs and CL\_SALV\_TABLE — they accidentally wrote "good" code years ago. The 5% at Level A is essentially zero for most ECC systems, since Released API classification didn't exist until S/4HANA.

📋 Why Is Most ECC Code Level C?

When ECC was the primary platform (2004-2020), the **recommended development pattern** was direct table access:

\* This was "best practice" in ECC for 15 years:
SELECT \* FROM VBAK INTO TABLE lt\_orders
  WHERE vbeln IN s\_vbeln.

SELECT \* FROM KNA1 INTO TABLE lt\_customers
  WHERE kunnr IN s\_kunnr.

Every ABAP training course, every SAP cookbook, every consultant taught this pattern. It was correct for ECC. It happens to be Level C in the Clean Core classification because `VBAK` and `KNA1` are not Released APIs — they're internal SAP tables that SAP reserves the right to restructure.

This is not the customer's fault. It's a paradigm shift — what was right for 15 years is now classified as non-compliant.

📋 What Kind of ECC Code Is Already Level B?
...
Stable BAPI — works everywhere on-prem, not released for cloud

`CALL FUNCTION 'REUSE_ALV_GRID_DISPLAY'`

B

Classic ALV — works on S/4 on-prem, not available in ABAP Cloud

`cl_salv_table=>factory( )`

B

OO ALV — stable, works on S/4 on-prem

`CALL FUNCTION 'BAPI_PO_CREATE1'`

B

Stable purchasing BAPI

`CALL FUNCTION 'BAPI_ACC_DOCUMENT_POST'`

B

Stable FI posting BAPI

If a developer **already used BAPIs** instead of BDC or direct table writes, that code is Level B today without any work. These developers were ahead of their time.

## 3\. What Remediation Actually Achieves (And Doesn't)

"Remediation" means making ECC custom code **run on S/4HANA** with minimum changes. It fixes compatibility blockers — nothing more. Here's what actually happens to each level:
...
Replace obsolete FM with successor

C

`WS_UPLOAD` → `CL_GUI_FRONTEND_SERVICES=>GUI_UPLOAD`  
(still not a Released API)
...
SmartForm is also deprecated in S/4. Need Adobe Forms for Level B.

D

Fix user exit — can only fix syntax inside it

D

The user exit container itself (MV45AFZZ) is unreleased — you can't change that

C

Change KNA1 → BUT000 (BP table)

C

Different table, same pattern — still direct table access

C

Fix MATNR length 18 → 40 chars

C

Field length fixed, but `SELECT FROM MARA` is still Level C
...
BAPIs and CL\_SALV\_TABLE work as-is on S/4

Critical Understanding

Remediation moves **D → C** (removes migration blockers). It does NOT move code to Level B or A. After remediation, most custom code is **Level C** — it WORKS on S/4, but it's not cloud-ready and carries upgrade friction.

### The Post-Remediation Distribution
...
Notice: Level D reduced (blockers removed), Level C absorbed the D objects, Level A barely moved. **The system works, but 70% of code is still C/D territory.**

## 4\. The Strategic Question

Whether Level B (or even Level C) is acceptable depends on ONE strategic decision:

"Where is this enterprise heading in the next 5 years?"

Scenario 1: Stay on S/4 On-Premise

Level B is perfectly fine

Level B code compiles, runs, performs well, is supported by SAP, and upgrades cleanly on S/4 on-premise. Level C works too — with growing upgrade friction over time. No technical blocker. No business risk.

Scenario 2: RISE Private Cloud (Evaluating)

Level B mostly fine, some restrictions

SAP's managed private cloud tolerates most Level B code. Some classic APIs face restrictions in managed environments. Needs case-by-case evaluation. Not a blanket blocker.

Scenario 3: RISE Public Cloud

Level B will NOT work — Level A required

Public Cloud runs ABAP Cloud runtime only. Level B code (BAPIs, CL\_SALV, REUSE\_ALV) will not compile. Only Level A (Released APIs) code can execute. This is an absolute technical gate.

Scenario 4: BTP Extensions

BTP code must be Level A

Any code deployed to BTP ABAP Environment must use Released APIs only. Code running on S/4 can remain Level B, but anything extended to BTP requires Level A. Split architecture is possible.
...
**If cloud is NOT in your 5-year plan:** Level B is your target. Don't over-invest in Level A.  
**If cloud IS in your plan (or might be):** Triage — do the easy Level A conversions now, defer the expensive ones. Keep your options open.

## 5\. The Effort Spectrum — Clean Core Is NOT Always a Rewrite

The most common misconception in S/4HANA migration: **"Clean Core means rewriting everything from scratch."** This is wrong. Most Clean Core conversions are minor code changes — not rewrites.
...
**Level 1** — One-Line Swap

Change a table name or CDS view reference

30 minutes

~35%

**Level 2** — Small Block Replace

Swap an FM call with parameter remapping

2-4 hours

~25%

**Level 3** — BAdI / Container Swap

Move logic from user exit to Released BAdI class

1-3 days

~20%

**Level 4** — Significant Rewrite

Replace BDC with API, restructure approach

1-2 weeks

~12%

**Level 5** — Full Rebuild

Custom framework that deeply penetrates SAP internals
...
**80% of Clean Core conversion is NOT a full rewrite.** It's table swaps, API swaps, and container moves. The business logic — the actual rules your company relies on — stays the same.

🔍 Example: Level 1 — One-Line Swap (30 minutes)

**Before** (Level C — direct table access):

SELECT SINGLE kunnr name1 ort01 land1
  FROM kna1
  INTO ls\_customer
  WHERE kunnr = lv\_customer.

**After** (Level A — Released CDS view):

SELECT SINGLE Customer, CustomerName, CityName, Country
  FROM I\_Customer
  INTO @ls\_customer
  WHERE Customer = @lv\_customer.

**What changed:** Table name, field names. One line. The variable `ls_customer`, the logic around it, the output — all identical. Total effort: 30 minutes including testing.

🔍 Example: Level 2 — Small Block Replace (2-4 hours)

**Before** (Level C — unreleased FM):

CALL FUNCTION 'SD\_SALES\_ORDER\_CREATE'
  EXPORTING
    order\_header = ls\_header
  TABLES
    order\_items  = lt\_items
  EXCEPTIONS
    error        = 1.
...
CALL FUNCTION 'BAPI\_SALESORDER\_CREATEFROMDAT2'
  EXPORTING
    order\_header\_in  = ls\_header\_mapped
  TABLES
    order\_items\_in   = lt\_items\_mapped
    return           = lt\_return.

**What changed:** The FM name and parameter mapping. 10-15 lines. The business logic that BUILDS the header and items? Completely untouched. The 200 lines of validation before the call? Unchanged.

🔍 Example: Level 3 — BAdI Container Swap (1-3 days)

**Before** (Level D — classic user exit in MV45AFZZ):

FORM USEREXIT\_SAVE\_DOCUMENT\_PREPARE.
  " 200 lines of custom credit check logic
  SELECT SINGLE \* FROM knb1 WHERE kunnr = lv\_customer AND bukrs = lv\_bukrs.
  IF lv\_credit\_exposure > lv\_credit\_limit.
    sy-subrc = 4.  " block the sales order
  ENDIF.
ENDFORM.

**After** (Level A — Released BAdI):

CLASS zcl\_custom\_credit\_check DEFINITION PUBLIC FINAL CREATE PUBLIC.
  PUBLIC SECTION.
    INTERFACES if\_sd\_sales\_doc\_check.  " Released BAdI interface
ENDCLASS.

CLASS zcl\_custom\_credit\_check IMPLEMENTATION.
  METHOD if\_sd\_sales\_doc\_check~check.
    " SAME 200 lines of custom credit check logic
    " Moved into the Released BAdI container
    SELECT SINGLE \* FROM I\_CustomerCompany
      WHERE Customer = @lv\_customer AND CompanyCode = @lv\_bukrs
      INTO @ls\_credit.
    IF lv\_credit\_exposure > lv\_credit\_limit.
      " block using BAdI return structure
    ENDIF.
  ENDMETHOD.
ENDCLASS.

**What changed:** The **container** changed (user exit → Released BAdI class). The **logic** inside is 90% the same. You change the wrapper, fix a few table references (KNB1 → I\_CustomerCompany), and keep the business rules that your company spent years perfecting.

🔍 Example: Level 4 — Significant Rewrite (1-2 weeks)

**Before** (Level D — BDC screen recording):

\* 500 lines of BDCDATA filling, screen by screen:
PERFORM bdc\_field USING 'VBAK-VBELN' lv\_order.
PERFORM bdc\_field USING 'VBAP-MATNR' lv\_material.
PERFORM bdc\_field USING 'BDC\_OKCODE' '/11'.
CALL TRANSACTION 'VA01' USING lt\_bdcdata MODE 'N'.

**After** (Level A — Released API call):

DATA(lo\_order) = cl\_salesorder\_api=>create(
  EXPORTING
    is\_header = VALUE #( sales\_org = lv\_vkorg doc\_type = 'OR' )
    it\_items  = VALUE #( ( material = lv\_material quantity = lv\_qty ) )
).
IF lo\_order->is\_success( ).
  COMMIT WORK.
ENDIF.

**What changed:** Everything. BDC screen-recording is fundamentally incompatible with Fiori (no screens to record). The entire approach must change. But this is only ~12% of objects — and these objects were already the most fragile, maintenance-heavy code in your system.

🔍 Example: Level 5 — Full Rebuild (2-4 weeks)

**When this happens:** Custom frameworks that bypass standard SAP engines — custom pricing engines, custom ATP logic, custom posting frameworks that write directly to BSEG/BKPF. These deeply penetrate SAP internals and must be architecturally redesigned.

This is **rare** — typically 5-8% of objects. But each one is high-effort. The good news: these are usually well-known to the organisation ("our custom pricing engine") and are already on the migration risk radar.

## 6\. The Economics — When Clean Core Costs the Same as Remediation

This is the insight that changes the entire migration strategy:

The Crossover Insight

For Effort Level 1-2 objects (60% of your portfolio), Clean Core conversion costs **almost the same** as basic remediation. You're changing a table name either way — you might as well change it to the Released CDS view instead of another unreleased table.
...
→ Remediate now, Clean Core later
...
**For 60% of objects, the choice between remediation and Clean Core is a false dilemma — the effort is the same.** For another 20%, it's a business decision (strategic value vs timeline pressure). Only 20% truly needs to be deferred.

## 7\. The Triage Decision Engine

Based on the economics above, here is the decision tree for every custom object:

graph TD A\[Custom Object Found\] --> B{Does S/4 standard  
replace it?} B -->|Yes| C\["🟢 RETIRE  
No code work needed"\] B -->|No| D{What effort level  
for Clean Core?} D -->|Level 1-2| E\["🟢 CLEAN CORE NOW  
Same effort as remediation"\] D -->|Level 3| F{Is it strategic?  
Cloud plans?} F -->|Yes| G\["🟠 CLEAN CORE NOW  
Worth the +1-2 days"\] F -->|No / Urgent| H\["🔵 REMEDIATE NOW  
Schedule Clean Core post-go-live"\] D -->|Level 4-5| I\["🔵 REMEDIATE NOW  
Schedule Clean Core post-go-live"\] style C fill:#059669,color:#fff,stroke:#059669 style E fill:#059669,color:#fff,stroke:#059669 style G fill:#d97706,color:#fff,stroke:#d97706 style H fill:#2563eb,color:#fff,stroke:#2563eb style I fill:#2563eb,color:#fff,stroke:#2563eb
...
S/4 standard replaces it fully

Document retirement, decommission, validate standard covers all requirements
...
Effort Level 1-2 (trivial delta)  
OR Level 3 + strategic

Convert directly to Level A. Released APIs, Released BAdIs, CDS views.
...
Effort Level 4-5 (expensive)  
OR Level 3 + timeline pressure

Minimum fixes for S/4 compatibility. Level B/C is acceptable for go-live.

Scheduled in quarterly waves

20-30%

The Result

With this triage, a typical enterprise reaches **60-70% Level A at go-live** — with almost the same timeline as pure remediation. The remaining 20-30% Level B/C objects are scheduled for post-go-live quarterly conversion waves.

## 8\. The Progressive Journey

Clean Core is not a gate. It's a journey. You don't need 100% Level A to go live. You need everything **working**, with strategic objects at Level A and a roadmap for the rest.

gantt title Clean Core Progression Timeline dateFormat YYYY-MM-DD axisFormat %b %Y section Pre-Go-Live Triage & Assessment :a1, 2026-07-01, 30d Retire Objects :a2, after a1, 20d Clean Core Level 1-2 :a3, after a1, 40d Clean Core Level 3 Strategic :a4, after a2, 30d Remediate Level 4-5 :a5, after a1, 40d section Go-Live S4 Migration Go-Live :milestone, 2026-11-15, 0d section Post-Go-Live Wave 1 - Convert 10 objects :b1, 2027-01-15, 60d Wave 2 - Convert 10 objects :b2, 2027-04-15, 60d Wave 3 - Convert 5 objects :b3, 2027-07-15, 60d Wave 4 - Final objects :b4, 2027-10-15, 60d

### Progression KPI — The Hero Metric
...
Note: Some objects (5-10%) may permanently remain Level B/C — these are justified custom objects where no Released API exists and the business logic is genuinely unique. This is acceptable as long as it's documented and the enterprise understands the cloud deployment constraint.

## 9\. Is Level B a Problem? — The Honest Answer

This section addresses the most common executive question: _"If we get everything to Level B, are we done?"_

### The Short Answer

Enterprise Strategy

Is Level B Acceptable?

Recommendation

**S/4 On-Premise only**  
(no cloud plans for 5+ years)

✅ Yes — Level B is the correct target

Invest in Level B quality. Don't over-spend on Level A. Clean Core beyond B is waste if cloud isn't planned.

**S/4 On-Premise with BTP evaluation**  
(cloud might be in 3-5 year horizon)

⚠️ Acceptable for go-live, not as end state

Triage approach — do Level 1-2 Clean Core now (cheap insurance), defer Level 4-5. Keeps cloud option open at minimal cost.

**RISE Private Cloud planned**  
(within 2-3 years)

⚠️ Risky — evaluate per object

Some Level B APIs are restricted in managed environments. Prioritise Clean Core for objects likely to be affected. Get SAP's compatibility list for your specific RISE contract.

**RISE Public Cloud planned**  
(within 3-5 years)

❌ No — Level A is mandatory

Clean Core is not optional — it's a hard technical gate. Budget for full conversion. Use triage to prioritise within the timeline.

**We don't know yet**

⚠️ Keep options open

Triage approach — do the cheap Level A conversions now (60% of objects), defer the expensive ones. You invest minimally and retain maximum flexibility.

### The Hidden Risk of Level B Over Time

Even if Level B is acceptable today, there's a time dimension:

Year

What Happens to Level B

Impact

2025-2027

SAP continues supporting all Level B APIs

No impact — Level B is fully stable

2028-2030

SAP may deprecate some Level B APIs (reclassify to Level C/D)

Some upgrade friction — deprecation warnings, functional changes

2030+

SAP's long-term direction is ABAP Cloud (Level A only)

Growing technical debt if Level B objects aren't progressively converted

Important Nuance

SAP has **not announced** a hard deprecation date for Level B APIs. The risk is directional, not immediate. Enterprises on S/4 on-premise can safely operate at Level B for the foreseeable future. But the direction of travel is clear — Level A is where SAP is heading.

## 10\. Common Strategic Mistakes

❌ Mistake 1: "Clean Core Everything Before Go-Live"

**Why it happens:** Executive mandate — "We want to be cloud-ready from day one."

**Why it fails:**

*   3,000 objects × 15 days average = 45,000 person-days = **~200 person-years**
*   Every changed object needs full regression testing
*   Timeline extends by 2-3 years beyond what the business can tolerate
*   Business continuity risk — too many things changing at once

**The right approach:** Triage. 60% of objects cost almost nothing to make Level A. Do those. Defer the expensive 20%.

❌ Mistake 2: "Just Remediate Everything — Clean Core Is Phase 2"

**Why it happens:** Time pressure — "Let's just get to S/4, we'll clean up later."

**Why it fails:**

*   "Phase 2" never happens — budget moves to next project
*   You're paying to change table names ANYWAY (KNA1 → BUT000) — might as well change to I\_Customer (Level A) instead of BUT000 (Level C)
*   For 60% of objects, remediation and Clean Core cost the **same** — you're leaving free value on the table
*   Result: stuck at Level C for years with growing upgrade friction

**The right approach:** For Level 1-2 objects (60%), Clean Core IS remediation — same effort, better outcome. Only defer Level 4-5 objects.

❌ Mistake 3: "Level B Is Good Enough — We'll Never Go to Cloud"

**Why it happens:** Legitimate strategic position — on-premise is the plan.

**When it's correct:** If the enterprise has genuinely decided to stay on S/4 on-premise for 10+ years, Level B IS the right target. Don't over-invest.

**When it's risky:** When the decision is based on _today's_ strategy, not _tomorrow's_. Cloud adoption is accelerating. Board strategies change. A new CTO arrives and mandates cloud. Acquisition by a cloud-first parent company.

**The insurance policy:** The triage approach is cheap insurance. Level 1-2 conversions to Level A cost almost nothing extra. If you never go to cloud, you lost a few hours. If you do go to cloud, you saved months.

❌ Mistake 4: "We'll Use smartShift / Automated Tools for Clean Core"

**Why it's partially right:** Bulk conversion tools are excellent for Level 1-2 changes — table swaps, API remapping, syntax modernisation. They handle volume efficiently.

**Where it fails:** Level 3-5 changes require **understanding business logic**. Moving credit check logic from a user exit to a Released BAdI isn't a syntax transformation — it requires understanding what the code does, why it does it, and how to preserve that behaviour in a different container. Automated tools can't make these architectural decisions.

**The right combination:** Automated tools for Level 1-2 (bulk, fast, cheap). Intelligent analysis tools (C16) for Level 3+ (understand the code, design the target, generate the new architecture). Human review for Level 5 (business decisions that tools can't make).

## 11\. Executive Decision Framework

For the CTO / VP of IT / Programme Director — the decision reduces to three questions:

### Question 1: What's our cloud timeline?

Answer

Clean Core Investment Level

No cloud plans (5+ years)

Minimum — Level B target, only fix what's broken

Evaluating (3-5 years)

Moderate — Triage approach, cheap Level A conversions now

Committed (1-3 years)

Maximum — Aggressive Clean Core, accept timeline impact

### Question 2: What's our risk tolerance?

Answer

Triage Bias

Conservative (minimise change)

Bias towards Remediate Now — fewer objects change, less testing

Balanced

Triage as designed — Level 1-2 Clean Core, Level 4-5 remediate

Aggressive (maximise modernisation)

Bias towards Clean Core Now — extend to Level 3, accept timeline

### Question 3: What's our testing capacity?
...
Keep changes minimal — remediate Level 3-5, test less

Adequate testing team

Standard triage — balanced approach

Strong testing + automation

Aggressive Clean Core — testing capacity isn't the bottleneck

The Default Recommendation

For most enterprises: **Triage approach with balanced risk tolerance.** This delivers 60-70% Level A at go-live with almost the same timeline as pure remediation. The remaining 30-40% is scheduled for post-go-live quarterly waves. Clean Core is a journey — not a gate.
...
**Where does ECC code sit today?**

75% Level C/D. 20% Level B. 5% Level A. Most code is non-compliant — not because developers were bad, but because the rules changed.

**What does remediation achieve?**

Moves D → C (removes blockers). C stays C. B stays B. Everything WORKS on S/4, but nothing moves to Level A.

**Is Clean Core always a rewrite?**

**No.** 60% of objects need only a table swap or API swap (30 min - 4 hours). Only 20% need significant rewriting.

**Is Level B a problem?**

Not on S/4 on-premise. Yes for cloud (Public Cloud, BTP). Depends on your 5-year strategy.

**What's the right approach?**

**Triage.** Retire 30-40%. Clean Core the easy 30-40% (same cost as remediation). Remediate the hard 20-30% and schedule post-go-live conversion.

**What % Level A at go-live?**

60-70% with triage approach. 90%+ within 12-24 months post-go-live via quarterly waves.

**The one-sentence strategy**

_Go live with everything working. Go live with the easy stuff already Clean Core. Convert the hard stuff in quarterly waves. Track the % Level A as your hero metric._

Clean Core is a direction, not a destination. The question isn't "are we Clean Core?" — it's "what percentage are we, and what's our trajectory?"

**C16** Strategic Advisory — Clean Core Levels • April 2026

Industry-agnostic • Applicable to all S/4HANA migrations
