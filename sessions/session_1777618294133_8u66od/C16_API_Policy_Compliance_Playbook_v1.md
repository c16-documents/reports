  C16 — SAP API Policy Compliance Playbook mermaid.initialize({startOnLoad:true, theme:'base', themeVariables:{primaryColor:'#6B3FA0', primaryTextColor:'#fff', primaryBorderColor:'#5a2d91', lineColor:'#B5567A', secondaryColor:'#f3e8ff', tertiaryColor:'#fef3f2'}}); :root { --brand-deep: #6B3FA0; --brand-mid: #8B5CF6; --brand-accent: #B5567A; --brand-warm: #C97B3A; --green: #27ae60; --amber: #f39c12; --red: #e74c3c; --blue: #3498db; --bg-light: #f8f9fc; --text-primary: #1e293b; --text-secondary: #475569; } \* { margin: 0; padding: 0; box-sizing: border-box; } body { font-family: 'Segoe UI', system-ui, -apple-system, Arial, sans-serif; color: var(--text-primary); background: #e9ecef; line-height: 1.7; } .doc-wrapper { max-width: 1140px; margin: 24px auto; background: #fff; box-shadow: 0 4px 24px rgba(0,0,0,0.10); border-radius: 12px; overflow: hidden; } /\* Header \*/ .header-banner { background: linear-gradient(135deg, #C97B3A 0%, #B5567A 40%, #6B3FA0 100%); color: #fff; padding: 48px 56px; } .header-banner img { height: 52px; margin-bottom: 14px; border-radius: 8px; } .header-banner h1 { font-size: 2.1rem; font-weight: 700; margin-bottom: 6px; letter-spacing: -0.5px; } .header-banner .subtitle { font-size: 1.15rem; opacity: 0.92; margin-bottom: 18px; } .meta-pills { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 10px; } .meta-pills span { background: rgba(255,255,255,0.18); padding: 4px 14px; border-radius: 20px; font-size: 0.82rem; border: 1px solid rgba(255,255,255,0.25); } /\* Body \*/ .doc-body { padding: 40px 56px 56px; } /\* Section numbering \*/ .section-num { display: inline-flex; align-items: center; justify-content: center; width: 34px; height: 34px; background: var(--brand-accent); color: #fff; border-radius: 50%; font-size: 0.9rem; font-weight: 700; margin-right: 12px; flex-shrink: 0; } h2 { display: flex; align-items: center; font-size: 1.55rem; color: var(--brand-deep); border-bottom: 3px solid var(--brand-accent); padding-bottom: 10px; margin: 44px 0 20px; } h3 { font-size: 1.18rem; color: var(--brand-deep); margin: 28px 0 12px; padding-left: 8px; border-left: 4px solid var(--brand-mid); } h4 { font-size: 1.02rem; color: var(--text-primary); margin: 20px 0 8px; } p { margin-bottom: 14px; color: var(--text-secondary); } /\* Tables \*/ table { width: 100%; border-collapse: collapse; margin: 16px 0 24px; font-size: 0.88rem; } thead th { background: var(--brand-deep); color: #fff; padding: 11px 14px; text-align: left; font-weight: 600; } tbody td { padding: 10px 14px; border-bottom: 1px solid #e2e8f0; vertical-align: top; } tbody tr:nth-child(even) { background: #f8fafc; } tbody tr:hover { background: #edf2f7; } /\* Risk badges \*/ .risk-high { background: var(--red); color: #fff; padding: 2px 10px; border-radius: 12px; font-size: 0.8rem; font-weight: 600; white-space: nowrap; } .risk-medium { background: var(--amber); color: #fff; padding: 2px 10px; border-radius: 12px; font-size: 0.8rem; font-weight: 600; white-space: nowrap; } .risk-low { background: var(--green); color: #fff; padding: 2px 10px; border-radius: 12px; font-size: 0.8rem; font-weight: 600; white-space: nowrap; } .risk-none { background: #94a3b8; color: #fff; padding: 2px 10px; border-radius: 12px; font-size: 0.8rem; font-weight: 600; white-space: nowrap; } /\* Status badges \*/ .status-done { background: var(--green); color: #fff; padding: 2px 10px; border-radius: 12px; font-size: 0.8rem; } .status-partial { background: var(--amber); color: #fff; padding: 2px 10px; border-radius: 12px; font-size: 0.8rem; } .status-todo { background: var(--red); color: #fff; padding: 2px 10px; border-radius: 12px; font-size: 0.8rem; } .status-ok { background: var(--blue); color: #fff; padding: 2px 10px; border-radius: 12px; font-size: 0.8rem; } /\* Option cards \*/ .option-card { border: 2px solid #e2e8f0; border-radius: 10px; padding: 24px; margin: 16px 0; background: #fafbff; } .option-card.recommended { border-color: var(--green); background: #f0fdf4; } .option-card h4 { margin-top: 0; border-left: 4px solid var(--brand-mid); padding-left: 12px; } .option-card.recommended h4::after { content: ' ✦ RECOMMENDED'; color: var(--green); font-size: 0.8rem; font-weight: 700; } /\* Callout boxes \*/ .callout { padding: 18px 22px; border-radius: 8px; margin: 18px 0; font-size: 0.92rem; } .callout-warn { background: #fef3c7; border-left: 5px solid var(--amber); } .callout-info { background: #eff6ff; border-left: 5px solid var(--blue); } .callout-danger { background: #fef2f2; border-left: 5px solid var(--red); } .callout-success { background: #f0fdf4; border-left: 5px solid var(--green); } .callout strong { color: var(--text-primary); } /\* TOC \*/ .toc { background: var(--bg-light); border: 1px solid #e2e8f0; border-radius: 10px; padding: 24px 32px; margin: 20px 0 32px; } .toc h3 { border: none; margin-top: 0; padding-left: 0; } .toc ol { padding-left: 22px; } .toc li { margin-bottom: 5px; font-size: 0.9rem; } .toc a { color: var(--brand-deep); text-decoration: none; } .toc a:hover { text-decoration: underline; } /\* Checklist \*/ .checklist { list-style: none; padding-left: 0; } .checklist li { padding: 6px 0 6px 28px; position: relative; } .checklist li::before { content: '☐'; position: absolute; left: 0; color: var(--brand-mid); font-size: 1.1rem; } /\* Code \*/ pre { background: #f5f5f5; padding: 16px; border-radius: 8px; overflow-x: auto; font-size: 0.83rem; border-left: 4px solid var(--brand-accent); margin: 12px 0 20px; } code { font-family: 'Cascadia Code', 'Fira Code', Consolas, monospace; } .inline-code { background: #f1f5f9; padding: 2px 6px; border-radius: 4px; font-size: 0.85rem; color: var(--brand-deep); } /\* KPI row \*/ .kpi-row { display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin: 20px 0 28px; } .kpi-card { background: linear-gradient(135deg, #f8f4ff, #fff); border: 1px solid #e2e8f0; border-radius: 10px; padding: 18px; text-align: center; } .kpi-card .kpi-value { font-size: 2rem; font-weight: 700; color: var(--brand-deep); } .kpi-card .kpi-label { font-size: 0.8rem; color: var(--text-secondary); margin-top: 4px; } /\* Mermaid \*/ .mermaid { margin: 20px 0; } /\* Print \*/ @media print { body { background: #fff; } .doc-wrapper { box-shadow: none; margin: 0; } .header-banner { -webkit-print-color-adjust: exact; print-color-adjust: exact; } h2 { page-break-after: avoid; } table { page-break-inside: avoid; } } /\* Footer \*/ .doc-footer { background: #f8fafc; border-top: 2px solid #e2e8f0; padding: 28px 56px; font-size: 0.8rem; color: #94a3b8; } .doc-footer strong { color: var(--text-secondary); } :root{--c16-purple-1:#6B3FA0;--c16-purple-2:#8B5CF6;--c16-ink:#1f2937;--c16-sub:#4b5563;--c16-rule:#e5e7eb;--c16-accent:#faf5ff;}
...
# C16 — SAP API Policy Compliance Playbook

Detailed Steps to Achieve Full Compliance with SAP's April 2026 API Policy

📄 v1.0 — 01 May 2026 🔒 Classification: Internal + Customer-Shareable 👥 Audience: C16 Engineering · Customer Architects · GRC Officers 📋 Policy: SAP API Policy v4.2026a
...
Compliance Engineering Playbook

**Subject**

SAP API Policy (April 2026) — C16 compliance gap analysis, mitigation steps, and connectivity architecture options

**Primary policy reference**

SAP API Policy — [PDF (canonical)](https://help.sap.com/doc/sap-api-policy/latest/en-US/API_Policy_latest.pdf) · [Landing page](https://help.sap.com/docs/business-accelerator-hub/sap-business-accelerator-hub/sap-api-policy)

**Secondary policy reference**

SAP Business Accelerator Hub Terms of Use — [api.sap.com](https://api.sap.com) footer → "Terms of Use" (last updated 2025-10-08)

**Parallel technical enforcement**

[SAP Note 3255746](https://me.sap.com/notes/3255746) (ODP-RFC ban) · [SAP Note 3439624](https://me.sap.com/notes/3439624) (Self-assessment tool)
...
Active — Compliance Migration In Progress

### 📑 Table of Contents

1.  [Executive Summary](#executive-summary)
2.  [Policy Clause → Risk → Mitigation Matrix (Core Deliverable)](#policy-risk-matrix)
3.  [C16 Capability-Level Risk Register](#capability-register)
4.  [Connectivity Architecture Options (4 Patterns)](#connectivity-options)
5.  [ICF Endpoint Migration — Detailed Steps](#icf-migration)
6.  [Customer-Side Installation & Governance](#customer-install)
7.  [Removing the api.sap.com Dependency](#api-hub-removal)
8.  [Client-Side Rate Limiting & Self-Governance](#rate-limiting)
9.  [Compliance Dashboard Specification](#compliance-dashboard)
10.  [Migration Roadmap & Timeline](#migration-roadmap)
11.  [Long-Term: SAP Partnership / Endorsement Path](#sap-partnership)
12.  [Customer Decision Matrix — Which Connectivity Option to Choose](#decision-matrix)
13.  [References & Verification Sources](#references)

17

Total C16 Capabilities
...
In April 2026, SAP published an updated API Policy that formalises a hard contractual boundary between **Published APIs** (those listed on the SAP Business Accelerator Hub or in product-specific documentation) and **all other interfaces**. The policy is compact (one page), but its implications are substantial for any tool — including C16 — that interacts programmatically with SAP systems.

This playbook provides the **complete engineering plan** for making C16 fully compliant with every clause of the SAP API Policy. It covers:

*   **Clause-by-clause risk mapping** — every policy provision mapped to C16's current exposure with specific mitigation steps
*   **Capability-level register** — all 17 C16 capabilities classified by underlying transport, policy status, and migration status
*   **Four connectivity architecture options** — including alternatives for customers without SAP Cloud Connector
*   **Detailed ICF migration steps** — endpoint-by-endpoint engineering specifications
*   **Customer installation guide** — formalised process for customer-owned deployment
*   **Timeline and roadmap** — phased migration plan with dependencies

**Key finding:** The policy explicitly preserves a compliant path for C16. Section 1.2 states: _"customers may use custom-developed ABAP interfaces in private cloud and on-premise deployments."_ C16's migration to customer-owned ICF endpoints under /sap/bc/zc16/\* — wrapping only released SAP ABAP classes — is the exact pattern this exception describes.

**Important interpretive note:** The official SAP API Policy PDF does _not_ contain explicit, named anti-AI-agent language. The "AI agent" implications widely reported in industry coverage (SAPinsider, analyst briefings) are interpretive consequences of three policy provisions read together: the non-published API prohibition (§1.2), the bulk extraction control (§2), and the anti-circumvention clause (§3). This document treats AI implications as **interpretive, not verbatim**, and is explicit about which clauses are quoted vs. inferred.

## 2 Policy Clause → Risk → Mitigation Matrix

This is the core deliverable. Every relevant clause of the SAP API Policy is mapped to C16's specific exposure, the assessed risk severity, and the concrete mitigation action. All policy text is quoted verbatim from the [canonical PDF](https://help.sap.com/doc/sap-api-policy/latest/en-US/API_Policy_latest.pdf) (verified 2026-05-01).
...
_"APIs published on the SAP Business Accelerator Hub… or otherwise identified in product-specific Documentation ('Published APIs') are made available for the purposes described in that Documentation."_

C16 currently uses some APIs not listed on the API Hub (ADT REST APIs). These are documented by SAP for Eclipse ADT but not formally listed as "Published APIs" on api.sap.com.

HIGH

**Migrate all ADT-backed capabilities** to customer-owned ICF endpoints under /sap/bc/zc16/\* that wrap only released ABAP classes. For APIs that ARE on the Hub (OData, BAPIs), no change needed. See [Section 5](#icf-migration).

SAP API Policy §1.1

**P2**

_"Customer and third-party applications must not access, invoke, or interact in any manner with APIs that are not Published APIs, in particular those that are labeled internal, private, or with a similar designation."_

C16 currently calls ADT REST APIs (/sap/bc/adt/\*) for source code retrieval, activation, ATC, code search, OpenSQL preview, runtime dumps. ADT is not listed as a "Published API" for third-party consumption.

HIGH

**Replace every ADT dependency** with a customer-installed ICF endpoint. C16 has already migrated 7 of 13 required endpoints. Remaining 6 must be completed by Q3 2026. See [Section 3](#capability-register) for the full register.

SAP API Policy §1.2

**P3**

_"…except as permitted by the Documentation or otherwise authorized by SAP (e.g., customers may use custom-developed ABAP interfaces in private cloud and on-premise deployments)."_

This is C16's **primary compliance path**. C16-installed ICF endpoints are customer-developed, customer-owned, in the customer's Z-namespace, transported through normal change management.

LOW ✅

**Continue and accelerate the ICF migration.** Ensure all endpoints are: (a) in customer namespace (Z\*), (b) wrapping only released ABAP, (c) transported via standard change management, (d) owned by the customer. See [Section 6](#customer-install).

SAP API Policy §1.2 (exception clause)

**P4**

_"These interfaces may change or be removed without notice."_ (re: non-published APIs)

Any remaining ADT dependency C16 retains can break silently on any S/4HANA upgrade with no advance notice from SAP.

MEDIUM

**ICF migration is the structural fix.** For any remaining ADT dependency during migration: pin to known ADT API versions, build smoke tests that run pre/post-upgrade, implement graceful fallback behaviour. See [Section 5](#icf-migration).

SAP API Policy §1.2

**P5**

_"SAP may define… functional/technical use rate limits and quotas, data ingress/egress quotas, limits and preconditions for bulk extraction/replication, and other security/technical requirements."_

Heavy C16 workloads (full-package indexing, bulk where-used analysis, large refactoring runs) could trip rate limits. Code-mass operations (Zoekt index, package walks) match the "systematic extraction" pattern.

MEDIUM

**Implement client-side rate limiting:** batch calls, incremental indexing, exponential back-off on 429/503, payload size caps. Prefer in-system processing (analysis inside the ICF endpoint returning summaries) over mass code transfer. See [Section 8](#rate-limiting).

SAP API Policy §2

**P6**

_"SAP may monitor API usage and take reasonable enforcement actions, including throttling, suspension, or termination of access in the event of non-compliance."_

Sustained API usage by an external agent could draw enforcement attention, particularly on cloud-managed systems where SAP has telemetry.

MEDIUM

**Reduce SAP's visibility concern:** Route through customer-owned ICF endpoints (which present as normal customer custom code, not unusual external agent traffic). Maintain full audit log (ZC16\_API\_LOG) for GRC transparency. On cloud: use SAP Cloud Connector or SAP BTP Destination Service. See [Section 4](#connectivity-options).

SAP API Policy §3

**P7**

_"Customers, partners, and third parties must not bypass, disable, or otherwise circumvent API Controls, including through intermediary services, custom code or developments, proxies, gateways, impersonation techniques, or similar mechanisms."_

This is the clause critics cite as the "AI moat." Could in principle be read to constrain any automated agent layer — including C16 — that mediates between humans and SAP APIs. C16's custom Z-class could be characterised as "custom code" facilitating access.

MEDIUM (interpretive)

**Position C16 as a developer productivity tool calling customer-owned APIs, not as a shadow gateway to SAP's internal APIs.** The ICF migration directly addresses this: C16 calls the _customer's_ APIs, not SAP's hidden ones. No impersonation of SAP-internal processes. Full audit trail. Customer controls access. Route through SAP-endorsed connectivity where available. See [Section 4](#connectivity-options).

SAP API Policy §3

**P8**

_"This API Policy does not limit SAP's obligations to provide any data export or other data egress capabilities that may be expressly required by law."_

Preserves customer rights under GDPR data portability, EU Data Act, and legal record retention. Does not create a general right to use AI agents, but prevents SAP from blocking legally mandated data access.

N/A

**No action required.** Note for customer GRC teams: this clause can be cited if SAP ever attempts to restrict data export that the customer is legally entitled to.

SAP API Policy §4

**P9**

_"use any automated data gathering or extraction methods… (such as bots, scrapers, spiders, crawlers, Model Context Protocol (MCP), agent-frameworks, or any other text and data mining technology)"_

C16 has a tool (sap\_api\_hub\_search) that searches api.sap.com programmatically. Under the website Terms of Use, this constitutes an "agent-framework" accessing an "SAP Website."

HIGH

**Remove sap\_api\_hub\_search entirely.** Replace with C16's internal knowledge base for API/Fiori app recommendations. C16 already has sufficient domain knowledge to recommend standard APIs without querying api.sap.com. See [Section 7](#api-hub-removal).

API Hub Terms of Use, Section 3 clause (m) — [api.sap.com footer → Terms of Use](https://api.sap.com) (updated 2025-10-08)

**P10**

**(Interpreted, not verbatim)** — Industry analysts read §1.2 (non-published prohibition) + §2 (bulk extraction controls) + §3 (anti-circumvention) together as prohibiting _"(semi-) autonomous or generative AI systems that plan, select, or execute sequences of API calls"_ unless routed through SAP-endorsed architectures.

C16 is a generative AI system that plans and executes sequences of API calls. Under the strictest interpretive reading, C16's operating model falls within this combined prohibition.

MEDIUM (interpretive)

**Three-layer defence:** (1) Route through SAP-endorsed connectivity where available (Cloud Connector, BTP Destination). (2) Call only customer-owned ICF endpoints (Section 1.2 exception). (3) Position C16 as human-directed (every action user-initiated) rather than autonomous. See [Section 4](#connectivity-options) for connectivity options.

Industry interpretation — SAPinsider (2026-04-28); SAP Q1 2026 earnings call (Christian Klein); strategic analysis reports. **Not verbatim policy text.**

**Summary:** Of the 10 identified policy concerns, **3 require immediate engineering action** (P1: ICF migration, P2: ADT replacement, P9: api.sap.com removal), **4 require architectural governance** (P5: rate limiting, P6: audit trail, P7: positioning, P10: connectivity), **2 are already addressed by the ICF migration** (P3, P4), and **1 is informational only** (P8).

## 3 C16 Capability-Level Risk Register

Every C16 capability mapped to its underlying transport mechanism, policy classification, risk rating, and current migration status.
...
/sap/bc/zc16/data\_preview

✅ Migrated

N2

Runtime dump retrieval
...
/sap/bc/zc16/tr\_create, tr\_get, tr\_layers
...
ADT information system + Zoekt

Non-published

HIGH

/sap/bc/zc16/obj\_search
...
/sap/bc/zc16/atc\_run

❌ Not started

N12

Customer extension search
...
/sap/bc/zc16/obj\_inventory

⚠️ Partial

N13

OData testing (RAP/V2/V4)
...
Custom ICF (ZCL\_C16\_ABAPGIT)

Custom ABAP (§1.2)

LOW

/sap/bc/zc16/abapgit (re-root from ADT sub-path)
...
Published BAS APIs + UI

Mixed

LOW

Prefer published BAS APIs

✅ Mostly compliant

## 4 Connectivity Architecture Options (4 Patterns)

Not all customers have SAP Cloud Connector or SAP BTP. This section provides **four distinct connectivity patterns** — from strongest compliance to simplest deployment — so each customer can choose the option that fits their infrastructure.

#### Option A: SAP Cloud Connector + BTP Destination

**Prerequisites:** SAP BTP subaccount + SAP Cloud Connector installed at customer site

**How it works:** C16 connects to a BTP Destination Service endpoint. BTP routes the call through SAP Cloud Connector to the customer's on-premise SAP system. Cloud Connector enforces URL-level whitelisting, so only /sap/bc/zc16/\* and published OData paths are reachable.

graph LR A\[C16 Agent  
Cloud-hosted\] -->|HTTPS + OAuth2| B\[SAP BTP  
Destination Service\] B -->|TLS tunnel| C\[SAP Cloud Connector  
Customer-operated\] C -->|Whitelisted paths only| D\[Customer SAP System  
On-premise / Private Cloud\] D --> E\["/sap/bc/zc16/\*  
(Customer-owned ICF)"\] D --> F\["/sap/opu/odata/\*  
(Published OData)"\] style B fill:#6B3FA0,color:#fff style C fill:#27ae60,color:#fff style E fill:#3498db,color:#fff style F fill:#3498db,color:#fff
...
⭐⭐⭐⭐⭐ — **Strongest possible.** SAP's own connectivity product in the path. §2.2.2 "SAP-endorsed architecture" fully satisfied.

Customer control

⭐⭐⭐⭐⭐ — Cloud Connector ACLs, URL whitelisting, principal propagation, traffic monitoring.

Audit trail

⭐⭐⭐⭐⭐ — Three layers: Cloud Connector logs + ZC16\_API\_LOG + SAP Security Audit Log.

Anti-circumvention (§3)

⭐⭐⭐⭐⭐ — C16 goes through SAP's own product, not around it. Identical to how Joule connects.

Setup effort

Medium — Requires BTP subaccount, Cloud Connector installation, destination configuration.

Ongoing cost

BTP Destination Service charges (typically included in RISE; separate for standalone BTP).

Latency

Adds ~20-50ms per call (TLS tunnel + CC routing). Negligible for C16's workload.

Best for

Customers on **RISE with SAP**, customers with **existing BTP subaccounts**, regulated industries.

**Detailed setup steps:**

1.  Provision a BTP subaccount in the customer's global account (or use an existing one)
2.  Install SAP Cloud Connector on a server in the customer's network (can be the SAP host or a dedicated VM)
3.  In Cloud Connector admin: Create a mapping from a virtual host (e.g., c16-backend:443) to the real SAP system (sap-host:44300)
4.  Add access control entries: whitelist /sap/bc/zc16/ (prefix match) and /sap/opu/odata/ (prefix match). Block all other paths.
5.  In BTP cockpit: Create an HTTP Destination pointing to the virtual host, with authentication type = BasicAuthentication (for initial setup) or OAuth2SAMLBearerAssertion (for principal propagation)
6.  Configure C16 to use the BTP Destination endpoint URL instead of the direct SAP system URL
7.  Verify: C16 can reach /sap/bc/zc16/data\_preview but cannot reach /sap/bc/adt/

**Reference:** [SAP Help — Cloud Connector](https://help.sap.com/docs/connectivity/sap-btp-connectivity-cf/cloud-connector) · [SAP Help — HTTP Destinations](https://help.sap.com/docs/connectivity/sap-btp-connectivity-cf/http-destinations)

#### Option B: SAP Integration Suite API Management

**Prerequisites:** SAP Integration Suite license (API Management capability)

**How it works:** C16 calls a managed API proxy on SAP Integration Suite. The proxy enforces rate limits, payload quotas, and authentication — then forwards the call to the customer's SAP system (via Cloud Connector or direct VPN). SAP Integration Suite is an explicitly "SAP-endorsed architecture."

graph LR A\[C16 Agent\] -->|HTTPS + API Key| B\[SAP Integration Suite  
API Management\] B -->|Rate-limited,  
quota-enforced| C\[SAP Cloud Connector  
or VPN\] C --> D\[Customer SAP System\] D --> E\["/sap/bc/zc16/\*"\] style B fill:#6B3FA0,color:#fff style C fill:#27ae60,color:#fff style E fill:#3498db,color:#fff
...
⭐⭐⭐⭐⭐ — SAP Integration Suite is the most explicitly "SAP-endorsed" API management platform.

Customer control

⭐⭐⭐⭐⭐ — API policies, rate limits, quotas, analytics all configured by the customer.

Rate limiting (§2)

⭐⭐⭐⭐⭐ — Built-in rate limiting directly addresses §2 controls.

Setup effort

High — Requires Integration Suite license, API proxy configuration, policy rules.

Ongoing cost

Integration Suite license (significant — typically part of BTP Enterprise agreement).

Best for

Large enterprises already using **SAP Integration Suite**. Overkill for smaller customers.

**Reference:** [SAP Help — API Management](https://help.sap.com/docs/sap-api-management)

#### Option C: Direct HTTPS with Customer-Owned ICF Endpoints (No BTP Required)

**Prerequisites:** SAP system reachable via HTTPS (port 443/44300). No BTP, no Cloud Connector needed.

**How it works:** C16 connects directly to the customer's SAP system over HTTPS, calling _only_ the customer-owned ICF endpoints at /sap/bc/zc16/\*. No ADT paths, no SAP-internal APIs. The customer's ICF endpoints are the API contract.

graph LR A\[C16 Agent\] -->|HTTPS + Basic Auth  
or mTLS| B\[Customer SAP System  
On-premise / Private Cloud\] B --> C\["/sap/bc/zc16/\*  
(Customer-owned ICF)"\] B --> D\["/sap/opu/odata/\*  
(Published OData)"\] B -..->|BLOCKED by C16| E\["/sap/bc/adt/\*  
(ADT - NOT called)"\] style C fill:#3498db,color:#fff style D fill:#3498db,color:#fff style E fill:#e74c3c,color:#fff
...
⭐⭐⭐⭐ — Relies on §1.2 custom ABAP exception. Solid for on-premise/private cloud. No "SAP-endorsed architecture" in the transport path.

Customer control

⭐⭐⭐⭐ — ICF activation per endpoint, SAP authorization framework, firewall rules. Slightly less granular than Cloud Connector ACLs.

Anti-circumvention (§3)

⭐⭐⭐ — C16 calls customer's own APIs (not SAP's internal ones). But no SAP product in the path to demonstrate "endorsed" routing.

Setup effort

Low — Only requires ICF endpoint installation on the customer's SAP system. No additional infrastructure.

Ongoing cost

Zero additional — no BTP, no Cloud Connector license.

Latency

Lowest — direct connection, no intermediary routing.

Best for

**On-premise ECC/S4HANA customers without BTP.** Small/medium enterprises. Development/training systems.

**Additional hardening steps for Option C:**

1.  **Network-level restriction:** Customer firewall limits incoming HTTPS to C16's known IP range only
2.  **mTLS (mutual TLS):** Require client certificate from C16, verified by SAP ICM. Ensures only C16 can call the endpoints.
3.  **Dedicated service user:** Named SAP user (e.g., ZC16\_SVC) with minimum privileges — S\_RFC, S\_DEVELOP (read), S\_TABU\_DIS (read). No SAP\_ALL, no dialog logon.
4.  **C16-side ADT block:** C16 platform configuration explicitly disables all ADT API paths for this customer. Only /sap/bc/zc16/\* and /sap/opu/odata/\* are callable.
5.  **Full audit logging:** Every call logged to ZC16\_API\_LOG with correlation ID, timestamp, endpoint, parameters, outcome, duration.

**Legal positioning for Option C:** _"C16 connects to the customer's own SAP system using HTTPS, calling only customer-deployed, customer-owned ABAP interfaces (ICF services in the Z-namespace). These qualify under SAP API Policy §1.2 as 'custom-developed ABAP interfaces in private cloud and on-premise deployments.' C16 does not access any non-published SAP APIs. The customer controls which endpoints are installed, activated, and authorised."_

#### Option D: Customer-Hosted Reverse Proxy with Allowlisting

**Prerequisites:** Customer operates a reverse proxy (NGINX, HAProxy, AWS ALB, Azure Application Gateway) in their DMZ.

**How it works:** C16 connects to the customer's reverse proxy. The proxy allowlists _only_ the /sap/bc/zc16/\* and /sap/opu/odata/\* URL paths, blocking everything else. The proxy forwards allowed requests to the backend SAP system.

graph LR A\[C16 Agent\] -->|HTTPS| B\[Customer Reverse Proxy  
NGINX / HAProxy / AWS ALB\] B -->|"/sap/bc/zc16/\*" ALLOW| C\[Customer SAP System\] B -->|"/sap/opu/odata/\*" ALLOW| C B -..->|ALL OTHER PATHS DENY| X\[Blocked ❌\] C --> D\["/sap/bc/zc16/\*  
(Customer-owned ICF)"\] style B fill:#f39c12,color:#fff style D fill:#3498db,color:#fff style X fill:#e74c3c,color:#fff
...
⭐⭐⭐ — Same as Option C (§1.2 exception), but with added URL-level enforcement at the network layer. The proxy is NOT "SAP-endorsed" — it's customer infrastructure.

Customer control

⭐⭐⭐⭐⭐ — Strongest network-level control. Customer defines exactly which URL paths are reachable. Can add rate limiting, payload inspection, IP allowlisting at the proxy.

Anti-circumvention (§3)

⭐⭐⭐ — The reverse proxy is customer infrastructure (not SAP's). Could theoretically be characterised as a "gateway" under §3 — but since it's _restricting_ access (not bypassing controls), the argument is defensible.

Setup effort

Medium — Requires proxy infrastructure in customer's DMZ. Standard enterprise pattern.

Ongoing cost

Minimal — proxy infrastructure cost (typically already exists in enterprise DMZ).

Best for

Customers who **already have a DMZ proxy** and want network-level enforcement without BTP. Enterprise customers with strong network security teams.

**NGINX allowlist configuration example:**

```
# /etc/nginx/conf.d/sap-c16-proxy.conf
upstream sap_backend {
    server sap-host.customer.local:44300;
}

server {
    listen 443 ssl;
    server_name c16-sap.customer.com;

    ssl_certificate     /etc/ssl/c16-proxy.crt;
    ssl_certificate_key /etc/ssl/c16-proxy.key;

    # ALLOW: C16 custom ICF endpoints
    location /sap/bc/zc16/ {
        proxy_pass https://sap_backend;
        proxy_set_header Host $host;
        proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;
    }

    # ALLOW: Published OData services
    location /sap/opu/odata/ {
        proxy_pass https://sap_backend;
        proxy_set_header Host $host;
    }

    # DENY: Everything else (including ADT)
    location / {
        return 403 '{"error":"Path not allowlisted for C16 access"}';
    }
}
```

### Connectivity Options — Side-by-Side Comparison

Dimension

A: Cloud Connector + BTP
...
RISE customers, regulated industries

Large enterprises with IS

On-prem without BTP

Enterprises with DMZ proxy

**Overall compliance strength**
...
## 5 ICF Endpoint Migration — Detailed Steps

This section provides the engineering specification for each ICF endpoint that must be built to replace ADT dependencies. Every endpoint follows the same architectural pattern:

```
Customer ICF Endpoint Pattern:
─────────────────────────────────
  /sap/bc/zc16/{capability_name}
       │
       ▼
  ZCL_C16_{CAPABILITY}_HANDLER (implements IF_HTTP_EXTENSION)
       │
       ├── ZCL_C16_REST_BASE (framework: CSRF, content-type, error mapping)
       ├── ZCL_C16_AUTH_CHECK (authorisation: S_DEVELOP, S_TABU_DIS, etc.)
       └── Released ABAP class/FM (the actual SAP functionality)
              │
              └── Result → JSON response → C16 agent
```

### 5.1 Endpoints Already Migrated (Validate Only)

These 7 endpoints are built and operational. The required action is **validation** — confirm they produce identical results to the ADT equivalent, and wire up the auth-check helper consistently.
...
ADBC (released SQL executor)

S\_TABU\_DIS (table access)

Compare query results against ADT freestyle preview for 10 test queries

N2

/sap/bc/zc16/runtime\_dumps

SNAP tables + released dump reader

S\_ABAPDUMP

Compare dump list/detail against ADT dump viewer for 5 recent dumps

N3

/sap/bc/zc16/unit\_test

Released AUnit runner class

S\_DEVELOP (object access)

Run unit tests for 3 test classes, compare pass/fail results

N4

/sap/bc/zc16/activate

Released activation FMs

S\_DEVELOP (activity 02)

Activate a test PROG, verify active status matches ADT activation

N5

/sap/bc/zc16/sb\_publish

Released service binding APIs

S\_DEVELOP + S\_SERVICE

Publish a test SRVB, verify OData endpoint accessible

N6

/sap/bc/zc16/tr\_create, tr\_get, tr\_layers

Released CTS FMs (TRINT\_\*)

S\_TRANSPRT

Create transport, read it back, verify in SE09

N7

/sap/bc/zc16/pak\_validate

Released ABAP package APIs

S\_DEVELOP

Validate a test package, compare result with ADT package check

### 5.2 Endpoints to Complete (Partial Migration)
...
Full-text search across ABAP repository objects. **In-system search** — runs the query inside SAP and returns matching lines, avoiding bulk source extraction.

CL\_ABAP\_COMPILER (cross-reference), TADIR (repository), TRDIR (program directory), SEOCLASS (class metadata), DD02V (DDIC views)

S\_DEVELOP (read)

Replacing the Zoekt index (which requires full source extraction) with an in-system search that returns only matching results. May need to index incrementally on first run.

N9

/sap/bc/zc16/obj\_source

Read source code for programs, classes, includes, CDS views. Must enforce S\_DEVELOP authorization (unlike READ REPORT which doesn't authorize).

READ REPORT (programs), SEO\* (class source), DDIF\_\* (DDIC source). All wrapped with explicit S\_DEVELOP check.

S\_DEVELOP (activity 03 — display)

READ REPORT itself is not formally released but is the standard way to read ABAP source. Wrap with authorization check to add the security layer ADT provides.

N12

/sap/bc/zc16/obj\_inventory

List all custom objects in a package or namespace. Used for customer extension discovery.

TADIR (repository scan), TDEVC (package hierarchy), TRDIRT (program texts)

S\_DEVELOP (read)

Straightforward TADIR scan. Ensure no ADT dependency remains in the discovery chain.

N15

/sap/bc/zc16/abapgit

Re-root abapGit operations from /sap/bc/adt/zc16/abapgit/\* to /sap/bc/zc16/abapgit/\*. Already uses custom Z-class — just needs path migration.

ZCL\_C16\_ABAPGIT (existing), wrapping released serializers and deserializers

S\_DEVELOP (activity 01, 02)

Minimal — path change only. Ensure the new ICF node is registered in SICF with correct auth group.

### 5.3 Endpoints to Build (New Development)
...
Navigate to the definition of a class, method, FM, CDS view. Returns source URI + position + snippet. Read-only, low volume.

CL\_ABAP\_COMPILER (symbol resolution), SEOCLASS/SEOCOMPO (class metadata), TFDIR/FUPARAREF (FM metadata)

S\_DEVELOP (read)

P2 — Lowest priority. Used for code navigation during analysis. Can fall back to obj\_source + client-side parsing as interim solution.

N11

/sap/bc/zc16/atc\_run

Run ATC (ABAP Test Cockpit) checks on an object. Return findings with severity, line numbers, message text.

CL\_CI\_TESTS (check infrastructure), CL\_SATC\_\* (ATC runner classes — verify release status per S/4 version)

S\_DEVELOP (read) + S\_APPL\_LOG

P1 — Important for code quality validation. Need to verify which ATC runner classes are released vs. internal on each S/4 version.

## 6 Customer-Side Installation & Governance

For the Section 1.2 exception to hold, the ICF endpoints must be genuinely **customer-owned and customer-managed**. This means formal installation through the customer's standard change management process — not ad-hoc deployment into $TMP.
...
Customer approves C16 ICF installation

Customer Architect + GRC

Signed approval form / change request

—

2

Create transport request for C16 package

Customer Basis

Transport ID (e.g., DEVK900XXX)

SE09

3

Create development package ZC16\_API

Customer Developer

Package with transport layer

SE80 / ADT

4

Import C16 ABAP source into package

Customer Developer

Classes: ZCL\_C16\_REST\_BASE, ZCL\_C16\_AUTH\_CHECK, ZCL\_C16\_\*\_HANDLER

SE80 / abapGit

5

Create auth group ZC16\_API
...
Run ICF installer (ZCL\_C16\_ICF\_INSTALLER)

Customer Developer

ICF services registered in SICF

SICF (verify)

7

Create audit log table ZC16\_API\_LOG

Customer Developer

Transparent table (delivered with package)
...
User ZC16\_SVC with role ZC16\_AGENT\_ROLE

SU01

9

Assign minimum authorisations to service user

Customer Security

S\_RFC, S\_DEVELOP (03), S\_TABU\_DIS, S\_TRANSPRT, S\_ICF\_ADM (limited)

PFCG

10

Transport to QA → verify → transport to PROD

Customer Basis

Standard transport chain

STMS

11

Configure network access (firewall rules / Cloud Connector ACLs)

Customer Network team

Firewall rule: allow C16 IP range to port 443/44300

—

12

Deliver GRC compliance summary to customer

C16 team

One-page posture document (attachable to architecture review board submission)

—

### 6.2 Minimum Authorisation Profile for C16 Service User
...
RFC\_TYPE = FUNC, RFC\_NAME = RFC\_READ\_TABLE, STFC\_CONNECTION, etc.

Specific FMs only

RFC access for table reads

S\_DEVELOP

ACTVT = 03 (display), OBJTYPE = PROG, CLAS, FUGR, DDLS

Display only

Read source code, class metadata
...
Deploy customer code only (not SAP standard)

S\_TABU\_DIS

ACTVT = 03 (display), DICBERCLS = specific table groups

Read only

Read table data for analysis
...
ICF\_CLIIF = ZC16\_API

C16 auth group only

ICF service administration
...
**❌ Explicit exclusions (NEVER assign to C16 service user):**  
• SAP\_ALL — unrestricted access  
• S\_USER\_\* — user administration  
• S\_ADMI\_FCD — system administration  
• S\_BTCH\_ADM — batch administration  
• Dialog logon type — service user only (type = "System" or "Communication")

## 7 Removing the api.sap.com Dependency

The SAP Business Accelerator Hub website (api.sap.com) has its own Terms of Use (separate from the API Policy) that **explicitly names "agent-frameworks" and "MCP"** as prohibited automated access methods. C16 must not interact with this website programmatically.

### 7.1 Current Exposure

C16 has one tool — sap\_api\_hub\_search — that queries api.sap.com to find standard SAP APIs as alternatives to custom code. This is used during Clean Core analysis to recommend standard Fiori apps and released APIs.
...
**Remove sap\_api\_hub\_search**

Deactivate the tool from C16's active workflow. No agent call should reach api.sap.com.

Immediate (this week)

**Replace with internal knowledge base**

C16's AI engine already has comprehensive knowledge of standard Fiori apps (F4471, F0444, F2229, etc.), released BAPIs, CDS views, and OData services. Use this knowledge for recommendations instead.

Immediate

**Alternative: Offline catalog**

If a customer needs up-to-date API catalog data, the customer can download the catalog from api.sap.com themselves (as a human) and provide it to C16 as a reference file. This keeps the human in control.

Available on request

### 7.3 Post-Removal Verification

*   Confirm sap\_api\_hub\_search is not callable from any C16 workflow
*   Confirm no other C16 tool makes HTTP requests to api.sap.com, help.sap.com, or me.sap.com
*   Update customer-facing documentation to state: _"C16 does not access api.sap.com or any SAP website programmatically"_
*   Audit network logs to verify zero outbound traffic to \*.sap.com domains from C16 agent during customer sessions

**Reference:** SAP Business Accelerator Hub Terms of Use — Section 3, clause (m) — [api.sap.com footer → Terms of Use](https://api.sap.com) (last updated 2025-10-08)

## 8 Client-Side Rate Limiting & Self-Governance

SAP API Policy §2 reserves the right to impose rate limits, quotas, and data transfer thresholds. C16 must self-govern its API consumption to stay well within reasonable bounds — even when SAP has not yet published specific limits for on-premise systems.

### 8.1 Rate Limiting Controls
...
Max 5 concurrent API calls to any single SAP system

Prevents ICM thread exhaustion on smaller SAP systems

**Batch size cap**

Max 500 rows per RFC\_READ\_TABLE call; max 50,000 for explicit full exports

Prevents "mass data extraction" characterisation

**Exponential backoff**

On HTTP 429 or 503: wait 2s → 4s → 8s → 16s → abort with user notification

Respect server-side throttling signals

**Incremental indexing**

For code search: delta-only updates after initial index build

Avoids repeated full source extraction

**Session quota**

Max 200 API calls per user session

Caps total volume per analysis run

**Payload size cap**

Max 2MB per response payload (request larger datasets in pages)

Prevents single-call mass extraction

**In-system processing preference**

Where possible, run analysis inside the ICF endpoint and return summaries — not raw data

Minimises data egress from SAP system

### 8.2 Audit Logging Specification

Every C16 call to the customer's SAP system is logged in ZC16\_API\_LOG:
...
Links all calls within a single user request
...
ICF endpoint called (e.g., /sap/bc/zc16/data\_preview)
...
SAP user making the call

PARAMETERS

STRING

Request parameters (sanitised — no sensitive data)

RESPONSE\_CODE

INT4

HTTP response code (200, 403, 500, etc.)
...
SUCCESS / AUTH\_FAIL / ERROR / THROTTLED

**Retention:** Customer-configurable. Default 90 days. Entries can be archived or exported for SIEM integration.

## 9 Compliance Dashboard Specification

A per-customer compliance dashboard that C16 displays to platform administrators, showing the real-time compliance posture of the connection to each customer system.

```
┌──────────────────────────────────────────────────────────────┐
│  C16 Compliance Dashboard — Customer: ACME Corp (S4H-PROD)  │
├──────────────────────────────────────────────────────────────┤
│                                                              │
│  Overall Status: 🟢 COMPLIANT                                │
│  Connectivity:   Option A (Cloud Connector + BTP)            │
│  Policy Version: SAP API Policy v4.2026a                     │
│                                                              │
│  ┌─────────────────────┬───────────┬─────────┬────────────┐ │
│  │ Capability          │ Transport │ Status  │ Last Check │ │
│  ├─────────────────────┼───────────┼─────────┼────────────┤ │
│  │ Data Preview        │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Runtime Dumps       │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Unit Tests          │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Activation          │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ SB Publish          │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Transport CRUD      │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Package Validate    │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Code Search         │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Source Retrieval     │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Go-to-Definition    │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ ATC Runs            │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Extension Search    │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ abapGit Sync        │ ICF  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ OData Testing       │ Pub  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ BTP/CF Ops          │ Pub  ✅   │ 🟢      │ 2026-05-01 │ │
│  │ Fiori Generation    │ Local ✅  │ 🟢      │ 2026-05-01 │ │
│  │ BAS Access          │ Pub  ✅   │ 🟢      │ 2026-05-01 │ │
│  └─────────────────────┴───────────┴─────────┴────────────┘ │
│                                                              │
│  api.sap.com Access:     ❌ DISABLED                         │
│  ADT Direct Calls:       ❌ DISABLED                         │
│  Audit Log:              ✅ ZC16_API_LOG active              │
│  Rate Limiting:          ✅ 5 concurrent / 200 per session   │
│  Last Compliance Audit:  2026-05-01                          │
│  Next Scheduled Review:  2026-08-01                          │
│                                                              │
│  [📋 Export Compliance Report]  [🔄 Run Health Check]        │
└──────────────────────────────────────────────────────────────┘
```

## 10 Migration Roadmap & Timeline

gantt title C16 API Policy Compliance Migration dateFormat YYYY-MM-DD axisFormat %b %d section Phase 0: Immediate Remove api.sap.com dependency :crit, p0a, 2026-05-01, 3d Validate 7 migrated ICF endpoints :p0b, 2026-05-01, 10d Document compliance posture :p0c, 2026-05-05, 5d section Phase 1: Close Partial Migrations N8: Build obj\_search ICF endpoint :p1a, 2026-05-12, 15d N9: Build obj\_source ICF endpoint :p1b, 2026-05-12, 12d N12: Complete obj\_inventory endpoint :p1c, 2026-05-19, 8d N15: Re-root abapGit path :p1d, 2026-05-19, 5d Integration testing (Phase 1) :p1e, after p1b, 10d section Phase 2: New Endpoints N11: Build atc\_run ICF endpoint :p2a, 2026-06-09, 15d N10: Build goto\_def ICF endpoint :p2b, 2026-06-16, 12d Integration testing (Phase 2) :p2c, after p2b, 10d section Phase 3: Connectivity Options Cloud Connector setup guide :p3a, 2026-06-02, 10d Reverse proxy config templates :p3b, 2026-06-02, 8d Direct HTTPS hardening guide :p3c, 2026-06-09, 5d Customer install formalisation :p3d, 2026-06-16, 10d section Phase 4: Deprecate ADT Feature flag: disable ADT path :p4a, 2026-07-14, 5d Customer migration support :p4b, 2026-07-21, 20d ADT path fully deprecated :crit, p4c, 2026-08-18, 3d section Phase 5: Ongoing Compliance dashboard v1 :p5a, 2026-07-01, 20d Quarterly compliance review cycle :p5b, 2026-09-01, 5d SAP partnership exploration :p5c, 2026-06-01, 90d
...
api.sap.com removed, 7 endpoints validated, compliance posture documented

Zero outbound calls to \*.sap.com websites. All 7 migrated endpoints produce identical results to ADT.

**Phase 1: Close Partials**

May 12 – Jun 8, 2026

N8, N9, N12, N15 completed and tested

11 of 13 ICF endpoints operational. C16 can run full analysis workflow without ADT for search + source retrieval.

**Phase 2: New Endpoints**

Jun 9 – Jul 13, 2026

N10, N11 built and tested

All 13 ICF endpoints operational. Zero ADT dependencies remain.

**Phase 3: Connectivity**

Jun 2 – Jun 30, 2026

Setup guides for all 4 connectivity options. Formal customer installation process.

Any customer can follow a guide to deploy C16 compliantly, regardless of whether they have BTP.

**Phase 4: Deprecate ADT**

Jul 14 – Aug 20, 2026

ADT path disabled via feature flag. Customer migration support.

No C16 customer system uses ADT APIs. Feature flag set to "ICF-only" for all connections.

**Phase 5: Ongoing**

Jul 2026 onward

Compliance dashboard, quarterly reviews, SAP partnership exploration

Automated compliance monitoring. Proactive policy tracking.

## 11 Long-Term: SAP Partnership / Endorsement Path

The cleanest permanent resolution is for C16 to become a recognised participant in SAP's partner ecosystem. This eliminates interpretive ambiguity entirely.
...
**SAP PartnerEdge Technology**

Join SAP's partner programme as a technology partner. Get C16 recognised as a development tool that integrates via approved interfaces.

Medium

C16 becomes a known SAP partner. Customer conversations become easier.

6–12 months

**SAP Store Listing**

List C16 on the SAP Store as a certified development tool / extension.

High

Full SAP endorsement. Customers can procure C16 through SAP channels.

12–18 months

**SAP BTP Integration Scenario**

Offer C16 as a BTP application (or BTP-connected application) that consumes SAP services through standard BTP mechanisms.

High

C16 is architecturally indistinguishable from any BTP application. Full compliance by construction.

9–15 months

**Co-Innovation Agreement**

Formal agreement with SAP for developer tooling integration. SAP provides written authorisation under §1.2 for C16's specific use case.

Medium–High

Written SAP authorisation. Strongest legal defence.

6–9 months

**Customer-Driven Advocacy**

Have C16 customers request SAP to acknowledge C16 through their SAP account teams, ASUG, or DSAG channels.

Low (for C16)

Customer voice carries significant weight with SAP. Multiple requests create momentum.

Ongoing

## 12 Customer Decision Matrix — Which Option to Choose

Use this decision tree to determine the appropriate connectivity option for each customer:

graph TD A\[Does the customer have  
SAP BTP?\] -->|Yes| B\[Does the customer have  
Cloud Connector installed?\] A -->|No| C\[Does the customer have  
a DMZ reverse proxy?\] B -->|Yes| D\["✅ Option A  
Cloud Connector + BTP  
(RECOMMENDED)"\] B -->|No| E\[Is the customer willing  
to install Cloud Connector?\] E -->|Yes| D E -->|No| F\["Option B  
Integration Suite  
(if IS licensed)"\] C -->|Yes| G\["Option D  
Reverse Proxy + ICF  
(Good compliance)"\] C -->|No| H\["Option C  
Direct HTTPS + ICF  
(Baseline compliance)"\] style D fill:#27ae60,color:#fff style F fill:#6B3FA0,color:#fff style G fill:#3498db,color:#fff style H fill:#f39c12,color:#fff

### 12.1 Recommendation by Customer Type
...
RISE with SAP (any edition)

**Option A** (Cloud Connector + BTP)

BTP subaccount included with RISE. Cloud Connector is standard RISE component. Strongest compliance.

S/4HANA Cloud Private Edition

**Option A** (Cloud Connector + BTP)

Same as RISE. SAP manages infrastructure but customer controls Cloud Connector.

S/4HANA On-Premise + BTP

**Option A** (Cloud Connector + BTP)

Customer already has BTP. Add Cloud Connector if not present.

S/4HANA On-Premise, no BTP

**Option D** (Reverse Proxy) or **Option C** (Direct HTTPS)

No BTP = no Cloud Connector. Use existing DMZ proxy or direct connection with ICF hardening.

ECC On-Premise (maintenance mode)

**Option C** (Direct HTTPS + ICF)

ECC customers typically don't invest in BTP. Direct connection with customer-owned ICF endpoints. Lowest cost.

Regulated industry (banking, pharma)

**Option A** + **Option D** (both layers)

Maximum compliance. Cloud Connector for SAP-endorsed routing + Reverse proxy for network-level enforcement. Double audit trail.

Development / training system

**Option C** (Direct HTTPS + ICF)

Lowest friction for dev/training. Full compliance via ICF endpoints. No additional infrastructure.

## 13 References & Verification Sources

### 13.1 Primary SAP Sources (Authoritative)
...
SAP API Policy (canonical PDF)

[https://help.sap.com/doc/sap-api-policy/latest/en-US/API\_Policy\_latest.pdf](https://help.sap.com/doc/sap-api-policy/latest/en-US/API_Policy_latest.pdf)

✅ 2026-05-01

SAP API Policy (landing page)

[SAP Help Portal — API Policy](https://help.sap.com/docs/business-accelerator-hub/sap-business-accelerator-hub/sap-api-policy)

✅ 2026-05-01

SAP Business Accelerator Hub (Published API registry)

[https://api.sap.com/](https://api.sap.com/)

✅ Live

SAP Business Accelerator Hub — Terms of Use (website ToU, Section 3(m))

[api.sap.com footer → Terms of Use](https://api.sap.com)

✅ 2025-10-08 (last updated)

SAP Note 3255746 — Unpermitted usage of ODP Data Replication APIs

[https://me.sap.com/notes/3255746](https://me.sap.com/notes/3255746)

✅ 2026-05-01

SAP Note 3439624 — Self-Assessment for ODP Data Replication API access

[https://me.sap.com/notes/3439624](https://me.sap.com/notes/3439624)

✅ 2026-05-01

SAP Cloud Connector documentation

[SAP Help — Cloud Connector](https://help.sap.com/docs/connectivity/sap-btp-connectivity-cf/cloud-connector)

✅ Live

SAP Integration Suite — API Management

[SAP Help — API Management](https://help.sap.com/docs/sap-api-management)

✅ Live

SAP Business Data Cloud (BDC) — sanctioned data extraction alternative

[SAP Help — Business Data Cloud](https://help.sap.com/docs/portfolio-category/data-cloud)

Referenced

### 13.2 Industry & Analyst Sources
...
SAPinsider — "SAP's New API Policy Redefines Access in the AI Era"

[sapinsider.org](https://sapinsider.org/blogs/sap-api-policy-update-developers-partners/) (Adam Pitman, 2026-04-28)

Quotes Klein, Holland, Khan. Prompted this analysis.

SAP Q1 2026 Earnings Call — CEO Christian Klein

SAP Investor Relations (transcript)

"Customer's data is customer's data… accessing the IP, the domain knowhow — we are going to protect that."

DSAG position on API Policy

DSAG congress / press releases

Critical of API Hub as binding contract. Demanding transition periods and contractual clarity.

Strategic Analysis: SAP's April 2026 API Policy

Internal briefing document

Comprehensive 9-section analysis with 27 citations. Source of the "v4.2026a" reference and "Section 2.2.2" interpretive framework.

### 13.3 Internal C16 Sources

Reference

Purpose

C16 skill: custom-icf-api-blueprint

End-to-end pattern for replacing ADT API consumption with custom ICF endpoints

C16 skill: c16-icf-api-security

5-layer security model for hardening C16 ICF endpoints

C16 skill: c16-icf-api-unit-tests

Regression-test foundation for C16 ICF endpoints

C16 skill: clean-core-check

Verification methodology for ensuring underlying SAP classes are released

### 13.4 Honesty Note on Citations

**Transparency statement:** The official SAP API Policy PDF ([canonical link](https://help.sap.com/doc/sap-api-policy/latest/en-US/API_Policy_latest.pdf)) is a deliberately compact document (one page). It does **not** contain explicit, named anti-AI-agent language. References to "Section 2.2.2" and specific anti-AI sub-clauses that appear in third-party analysis (including the Strategic Analysis document in §13.2) are **interpretive frameworks** built from reading three policy provisions together — not verbatim policy text.  
  
This document distinguishes clearly between **verbatim policy quotations** (marked with quotation marks and section references) and **interpretive implications** (marked as such). All policy excerpts were verified against the published PDF on 2026-05-01.

**C16 — SAP API Policy Compliance Playbook v1.0**  
Generated: 2026-05-01 · Classification: Internal + Customer-Shareable  
Policy sources verified: SAP API Policy PDF (2026-05-01), API Hub Terms of Use (2025-10-08), SAP Notes 3255746/3439624 (2026-05-01)  
This document contains no fabricated data. All policy text is quoted verbatim or explicitly marked as interpretive. Connectivity architecture options are based on documented SAP product capabilities.  
  
_© 2026 C16. This document may be shared with customers and SAP representatives for compliance discussion purposes._
