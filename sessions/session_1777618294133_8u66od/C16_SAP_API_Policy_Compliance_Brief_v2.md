  C16 — SAP API Policy Compliance Brief v2.0 \* { margin: 0; padding: 0; box-sizing: border-box; } body { font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Arial, sans-serif; color: #2c3e50; background: #f0f2f5; line-height: 1.7; } .doc-wrapper { max-width: 1100px; margin: 0 auto; background: #fff; box-shadow: 0 4px 24px rgba(0,0,0,0.08); } /\* Header \*/ .header-banner { background: linear-gradient(135deg, #1a1a2e 0%, #16213e 40%, #0f3460 70%, #533483 100%); color: #fff; padding: 50px 60px; position: relative; overflow: hidden; } .header-banner::after { content: ''; position: absolute; top: -50%; right: -20%; width: 500px; height: 500px; background: radial-gradient(circle, rgba(107,63,160,0.15) 0%, transparent 70%); border-radius: 50%; } .header-banner img { height: 50px; margin-bottom: 16px; border-radius: 8px; position: relative; z-index: 2; } .header-banner h1 { font-size: 2.2em; font-weight: 700; margin-bottom: 8px; position: relative; z-index: 2; letter-spacing: -0.5px; } .header-banner .subtitle { font-size: 1.15em; opacity: 0.9; position: relative; z-index: 2; } .header-banner .doc-meta { margin-top: 20px; display: flex; gap: 20px; flex-wrap: wrap; position: relative; z-index: 2; } .header-banner .doc-meta span { background: rgba(255,255,255,0.12); padding: 6px 16px; border-radius: 20px; font-size: 0.85em; border: 1px solid rgba(255,255,255,0.15); } .header-banner .classification-badge { background: rgba(39,174,96,0.25) !important; border-color: rgba(39,174,96,0.4) !important; color: #2ecc71; font-weight: 600; } /\* Content \*/ .content { padding: 50px 60px; } /\* Section titles \*/ .section-title { font-size: 1.5em; font-weight: 700; color: #1a1a2e; margin: 45px 0 20px 0; padding-bottom: 12px; border-bottom: 3px solid #533483; display: flex; align-items: center; gap: 14px; } .section-title .num { background: #533483; color: #fff; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.75em; font-weight: 700; flex-shrink: 0; } /\* Important box \*/ .important-box { background: linear-gradient(135deg, #fff5f5 0%, #fef2f2 100%); border-left: 5px solid #e74c3c; padding: 24px 28px; margin: 24px 0; border-radius: 0 8px 8px 0; } .important-box h4 { color: #c0392b; margin-bottom: 8px; font-size: 1.05em; } /\* Key finding box \*/ .key-finding { background: linear-gradient(135deg, #f0fdf4 0%, #ecfdf5 100%); border-left: 5px solid #27ae60; padding: 24px 28px; margin: 24px 0; border-radius: 0 8px 8px 0; } .key-finding h4 { color: #1e8449; margin-bottom: 8px; font-size: 1.05em; } /\* Neutral info box \*/ .info-box { background: linear-gradient(135deg, #eff6ff 0%, #f0f7ff 100%); border-left: 5px solid #3498db; padding: 24px 28px; margin: 24px 0; border-radius: 0 8px 8px 0; } .info-box h4 { color: #2471a3; margin-bottom: 8px; font-size: 1.05em; } /\* Purple highlight box \*/ .purple-box { background: linear-gradient(135deg, #f5f0ff 0%, #ede9fe 100%); border-left: 5px solid #6B3FA0; padding: 24px 28px; margin: 24px 0; border-radius: 0 8px 8px 0; } .purple-box h4 { color: #6B3FA0; margin-bottom: 8px; font-size: 1.05em; } /\* Quote block \*/ .legal-quote { background: #fafafa; border-left: 4px solid #bdc3c7; padding: 20px 28px; margin: 20px 0; font-style: italic; color: #555; font-size: 0.95em; border-radius: 0 6px 6px 0; } .legal-quote .highlight { background: #fff3cd; padding: 1px 4px; font-weight: 600; color: #856404; font-style: normal; } .legal-quote .source { display: block; margin-top: 12px; font-style: normal; font-weight: 600; color: #7f8c8d; font-size: 0.9em; } /\* Tables \*/ table { width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 0.92em; } thead th { background: #1a1a2e; color: #fff; padding: 14px 16px; text-align: left; font-weight: 600; font-size: 0.9em; text-transform: uppercase; letter-spacing: 0.5px; } tbody td { padding: 12px 16px; border-bottom: 1px solid #e8ecef; vertical-align: top; } tbody tr:nth-child(even) { background: #f8fafc; } tbody tr:hover { background: #edf2f7; } /\* Status badges \*/ .badge-yes { background: #27ae60; color: #fff; padding: 3px 12px; border-radius: 12px; font-size: 0.82em; font-weight: 600; white-space: nowrap; } .badge-no { background: #e74c3c; color: #fff; padding: 3px 12px; border-radius: 12px; font-size: 0.82em; font-weight: 600; white-space: nowrap; } .badge-na { background: #95a5a6; color: #fff; padding: 3px 12px; border-radius: 12px; font-size: 0.82em; font-weight: 600; white-space: nowrap; } .badge-partial { background: #f39c12; color: #fff; padding: 3px 12px; border-radius: 12px; font-size: 0.82em; font-weight: 600; white-space: nowrap; } .badge-compliant { background: #27ae60; color: #fff; padding: 4px 14px; border-radius: 14px; font-size: 0.85em; font-weight: 700; } /\* Verdict box \*/ .verdict-box { background: linear-gradient(135deg, #f0fdf4, #dcfce7); border: 2px solid #27ae60; border-radius: 12px; padding: 30px 36px; margin: 30px 0; text-align: center; } .verdict-box h3 { color: #1e8449; font-size: 1.6em; margin-bottom: 8px; } .verdict-box p { color: #2c3e50; font-size: 1.05em; } /\* Architecture diagram \*/ .arch-diagram { background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; padding: 30px; font-family: 'Consolas', 'Courier New', monospace; font-size: 0.88em; line-height: 1.5; white-space: pre; overflow-x: auto; margin: 20px 0; color: #2c3e50; } /\* TOC \*/ .toc { background: #f8f9fa; border: 1px solid #e8ecef; border-radius: 8px; padding: 28px 32px; margin: 30px 0; } .toc h3 { color: #1a1a2e; margin-bottom: 16px; font-size: 1.1em; } .toc ol { padding-left: 24px; } .toc li { margin: 8px 0; } .toc a { color: #533483; text-decoration: none; font-weight: 500; } .toc a:hover { text-decoration: underline; } /\* Two-column layout \*/ .two-col { display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin: 20px 0; } .col-box { background: #f8f9fa; border: 1px solid #e8ecef; border-radius: 8px; padding: 24px; } .col-box h4 { color: #1a1a2e; margin-bottom: 12px; font-size: 1.05em; } .col-box ul { padding-left: 20px; } .col-box li { margin: 6px 0; font-size: 0.95em; } /\* FAQ \*/ .faq-item { margin: 20px 0; } .faq-q { font-weight: 700; color: #1a1a2e; font-size: 1.05em; margin-bottom: 6px; } .faq-a { color: #555; padding-left: 0; } /\* Footer \*/ .doc-footer { background: #1a1a2e; color: #adb5bd; padding: 30px 60px; font-size: 0.85em; line-height: 1.8; } .doc-footer strong { color: #e9ecef; } /\* Print \*/ @media print { body { background: #fff; } .doc-wrapper { box-shadow: none; } .header-banner { -webkit-print-color-adjust: exact; print-color-adjust: exact; } thead th { -webkit-print-color-adjust: exact; print-color-adjust: exact; } } @media (max-width: 768px) { .content, .header-banner, .doc-footer { padding: 24px; } .two-col { grid-template-columns: 1fr; } .header-banner h1 { font-size: 1.6em; } } /\* Comparison boxes \*/ .compare-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 0; margin: 20px 0; border-radius: 8px; overflow: hidden; border: 1px solid #e8ecef; } .compare-left { background: #fef2f2; padding: 24px; border-right: 1px solid #e8ecef; } .compare-right { background: #f0fdf4; padding: 24px; } .compare-left h4 { color: #c0392b; margin-bottom: 12px; } .compare-right h4 { color: #1e8449; margin-bottom: 12px; } p { margin: 12px 0; } h3 { color: #1a1a2e; margin: 28px 0 12px 0; font-size: 1.15em; } ul, ol { margin: 10px 0 10px 20px; } li { margin: 6px 0; } strong { color: #1a1a2e; } code { background: #f1f3f5; padding: 2px 6px; border-radius: 3px; font-size: 0.9em; color: #c0392b; } :root{--c16-purple-1:#6B3FA0;--c16-purple-2:#8B5CF6;--c16-ink:#1f2937;--c16-sub:#4b5563;--c16-rule:#e5e7eb;--c16-accent:#faf5ff;}
...
# SAP API Policy Compliance Brief

Fact-Based Analysis of the SAP Business Accelerator Hub Terms of Use (Section 3, Clause m) — and Why C16 Is Fully Compliant

Version 2.0 — 01 May 2026 ✅ Customer & Partner Shareable Source: SAP Business Accelerator Hub ToU — Last Updated 08 Oct 2025 Classification: Non-Confidential

### 📑 Table of Contents

1.  [Purpose of This Document](#purpose)
2.  [Background — The LinkedIn Controversy](#background)
3.  [First Correction — There Is No "Section 2.2.2"](#correction)
4.  [The Exact Text — Section 3, Clause (m)](#exact-text)
5.  [What This Clause Actually Governs](#what-it-governs)
6.  [Three Separate Legal Domains (Critical Distinction)](#three-domains)
7.  [Section 4 — The Clause Everyone Ignores](#section-4)
8.  [How C16 Connects to Customer Systems](#c16-architecture)
9.  [Point-by-Point Compliance Matrix](#compliance-matrix)
10.  [SAP's Own AI Products Use the Same Pattern](#sap-own-ai)
11.  [Customer Assurance Statement](#customer-assurance)
12.  [Frequently Asked Questions](#faq)
13.  [Final Verdict](#verdict)
14.  [Appendix — Source Document Reference](#appendix)

## 1 Purpose of This Document

In late April 2026, a LinkedIn post by an AI vendor CEO claimed that SAP had quietly updated its API policy with a provision (cited as "Section 2.2.2") that "prohibits AI agents from calling SAP APIs." The post went viral, generating concern among SAP customers, partners, and technology providers.

This document provides a **fact-based, line-by-line analysis** of the actual SAP policy document. It is designed to be shared with:

*   **SAP customers** — to address concerns about AI-powered tools connecting to their SAP systems
*   **SAP account executives and partner managers** — to demonstrate C16's compliance posture
*   **Legal and compliance teams** — as input for vendor due diligence reviews
*   **Internal stakeholders** — to provide clarity on the regulatory landscape

Every claim in this document is sourced directly from the SAP Business Accelerator Hub Terms of Use, last updated **October 8, 2025**, accessible at:

`https://help.sap.com/docs/SAP_BUSINESS_ACCELERATOR_HUB/8a5a0d9bf24345f5a780e1a4a09715f0/4a4eb1e048834354a90e8a972a4a4cce.html`

## 2 Background — The LinkedIn Controversy

The viral LinkedIn post made three central claims. Let us fact-check each one against the actual document:
...
"SAP updated its API policy with a provision in **Section 2.2.2**"

FALSE

The document uses a **flat numbering scheme** (Sections 1 through 23). There is no "Section 2.2.2". The relevant clause is in **Section 3, clause (m)**. The post author either misread the section number, referenced a different document, or fabricated the citation.

**2**

"SAP casually **prohibits AI agents from calling their APIs**"

MISLEADING

Section 3, clause (m) prohibits automated data extraction **from the SAP Business Accelerator Hub website** (api.sap.com). It does NOT prohibit calling APIs on your own licensed SAP system. Section 4 explicitly states that licensed API usage is governed by your **license agreement**, not by these website terms. See Sections 5 and 7 of this document for the full analysis.

**3**

"This is SAP's BlackBerry moment — CFOs should not buy more SAP modules because future innovation will be completely blocked"

FALSE

SAP is actively building and marketing its own AI agents (Joule), AI-powered automation (SAP Build Process Automation), and API-first architecture (Clean Core / S/4HANA Cloud). SAP's entire strategic direction is toward API-enabled AI integration — the opposite of the claim. See Section 10.

#### ℹ️ About the Post Author

The LinkedIn post was authored by Yosi Rahimi, CEO of an "Autonomous Finance for the Enterprise" company — a commercial competitor to SAP in the AI-for-ERP space. The post's framing ("BlackBerry moment", "blocked innovation") serves a competitive marketing narrative. This does not invalidate legitimate questions about SAP's policy, but it does explain the sensationalist tone and factual inaccuracies (wrong section number, overstated scope).

## 3 First Correction — There Is No "Section 2.2.2"

The SAP Business Accelerator Hub Terms of Use document is structured with **23 top-level sections**, numbered sequentially. None of them contain sub-subsections using a "2.2.2" numbering scheme.

The document's complete table of contents:
...
**⚠️ Contains clause (m) — the relevant restriction**

**Section 4**

**API Information**

**⚠️ Licensed product usage — overrides Section 3**
...
Workflow / Policy Templates / Community
...
GDPR-type provisions

Section 15

Confidentiality

API Info = SAP Confidential

Sections 16–23

Indemnity / Liability / Applicable Law / etc.

Standard legal boilerplate

The post's citation of "Section 2.2.2" is verifiably incorrect. Section 2 is titled "Acceptance of Terms" and contains standard contract formation language — nothing about AI agents, bots, or automated access.

## 4 The Exact Text — Section 3, Clause (m)

The restriction that triggered the controversy is located in **Section 3 — "General Use of the Website"**. Section 3 begins with:

"Except to the limited extent provided otherwise in Sections 4 (API Information) and 5 (Integration Content), You may use the Website solely for Your internal, non-productive and non-commercial test and evaluation purposes." — Section 3, Opening Paragraph

Section 3 then lists a series of "You must not" restrictions, labeled (a) through (o). The specific clause referenced in the controversy is **clause (m)**:

#### 📜 Exact Text — Section 3, Clause (m)

"When using or accessing the Website, whether directly or indirectly including via third parties and except where explicitly permitted otherwise, You must not: \[...\]  
  
(m) use any automated data gathering or extraction methods or similar or related technologies designed to scrape or extract data from SAP Websites (such as bots, scrapers, spiders, crawlers, Model Context Protocol (MCP), agent-frameworks, or any other text and data mining technology), including for text and data mining purposes or artificial intelligence training, improvement or evaluation, and/or commercial data aggregation and/or competitive analysis;" — SAP Business Accelerator Hub Terms of Use, Section 3, Clause (m) — Last updated October 8, 2025

There are also two related clauses:

"(n) bulk download (except by search engines for indexing purposes) or make persistent copies of SAP Websites, SAP Materials and/or Content; or  
  
(o) cache, store or redistribute SAP Websites, SAP Materials and/or Content or make them available to any third party, including any data broker or AI provider." — Section 3, Clauses (n) and (o)

### What Is Notable About This Clause

SAP explicitly names two technologies by name:
...
An open standard (created by Anthropic) that allows AI agents to connect to external data sources and tools via a standardized protocol

If someone built an MCP server that exposes api.sap.com content to AI agents, SAP does not want that

**Agent-frameworks**

Software frameworks (LangChain, AutoGen, CrewAI, etc.) that orchestrate AI agents to perform multi-step tasks, often including web browsing and data extraction

If someone built an agent that crawls api.sap.com to extract API specifications for AI training, SAP does not want that

This is a reasonable and **standard provision**. Microsoft, Google, Salesforce, and virtually every cloud platform have similar clauses in their documentation website terms of service. The clause protects SAP's intellectual property (API specifications, documentation, code samples) from being mass-extracted to train competing AI models.

## 5 What This Clause Actually Governs

The scope of Section 3 is defined by its own language. Three critical phrases establish the boundary:

### Phrase 1: "the Website"

Section 3's restrictions apply to **"the Website"** — which is defined in **Section 1 (Scope)** as:

"SAP SE \[...\] created the SAP Business Accelerator Hub and SAP Enterprise Architecture Designer Hub where you \[...\] may obtain information published by SAP and its authorized partners about application programming interfaces ('APIs') and product integrations for SAP and Partner products, as well as, test select APIs in an SAP or Partner sandbox environment." — Section 1 (Scope)

**"The Website" = the SAP Business Accelerator Hub (api.sap.com).** It is a documentation portal. It is NOT your SAP system. It is NOT your OData endpoints. It is NOT your RFC connections.

### Phrase 2: "scrape or extract data from SAP Websites"

Clause (m) specifically targets technologies **"designed to scrape or extract data from SAP Websites."** The operative verb is "scrape or extract from." This describes:

*   Crawling the api.sap.com website to download API documentation
*   Extracting Swagger/EDMX metadata files in bulk from the portal
*   Mining SAP's website content for AI training datasets

It does **not** describe:

*   Calling an OData endpoint on your own SAP server
*   Sending an RFC request to your own ABAP stack
*   Using ADT REST APIs on your own SAP system

### Phrase 3: "except where explicitly permitted otherwise"

Section 3 begins with a critical carve-out that the LinkedIn post completely ignores:

"Except to the limited extent provided otherwise in Sections 4 (API Information) and 5 (Integration Content), You may use the Website solely for Your internal, non-productive and non-commercial test and evaluation purposes." — Section 3, Opening Paragraph

This phrase explicitly directs readers to Section 4 for the rules that apply to actual API usage — which is where the real answer lies.

## 6 Three Separate Legal Domains (Critical Distinction)

The fundamental error in the LinkedIn post is conflating three completely separate legal instruments. Understanding this distinction is essential:

┌─────────────────────────────────────────────────────────────────────┐ │ │ │ DOMAIN 1: api.sap.com (Documentation Portal) │ │ ────────────────────────────────────────────── │ │ Governed by: SAP Business Accelerator Hub Terms of Use │ │ Section 3(m): APPLIES HERE — no bots, no MCP, no scraping │ │ What it is: A WEBSITE showing API specs, docs, code samples │ │ C16 impact: C16 does NOT scrape this website │ │ │ ├─────────────────────────────────────────────────────────────────────┤ │ │ │ DOMAIN 2: SAP Cloud APIs (BTP, S/4HANA Cloud) │ │ ────────────────────────────────────────────── │ │ Governed by: Your SAP Cloud subscription agreement (license) │ │ Section 4: "subject to the terms of such license agreement" │ │ What it is: Licensed API endpoints on SAP-hosted infrastructure │ │ C16 impact: If customer has S/4HANA Cloud license, calling │ │ APIs is governed by THAT license — not by api.sap.com │ │ ToU. SAP's own Joule AI uses these same APIs. │ │ │ ├─────────────────────────────────────────────────────────────────────┤ │ │ │ DOMAIN 3: YOUR SAP System (On-Premise / Private Cloud) ◄── C16 │ │ ────────────────────────────────────────────────────── │ │ Governed by: Your SAP on-premise license agreement │ │ What it is: YOUR server, YOUR hardware, YOUR network │ │ C16 impact: ZERO restriction from Section 3(m) │ │ SAP has NO jurisdiction over how you call APIs │ │ on YOUR infrastructure │ │ │ └─────────────────────────────────────────────────────────────────────┘

#### ✅ Key Distinction

**Section 3, clause (m) governs the api.sap.com WEBSITE.** It does not govern API calls to your own SAP system. These are separate legal instruments with separate jurisdictions. Conflating them is like saying "the Terms of Service for docs.microsoft.com prohibit you from using Microsoft Azure APIs" — the two have nothing to do with each other.

## 7 Section 4 — The Clause Everyone Ignores

The LinkedIn post focuses exclusively on Section 3(m) while completely ignoring **Section 4 — "API Information"**, which directly addresses what happens when you have a license to use SAP products. This section is critical:

"**API Information for a Licensed Product.** If You have a valid license agreement with SAP or a Partner to use or distribute a SAP or Partner product, then Your use of the API Information related to that licensed product is subject to the terms of such license agreement." — Section 4, Paragraph 1

This is the key provision. It explicitly states that if you have a **valid SAP license** (which every SAP customer does), then your use of APIs is governed by **your license agreement** — NOT by the website Terms of Use.
...
You browse api.sap.com to read API docs

Section 3 (Website ToU)

Don't scrape it. Use it normally for research — same as a developer would.

You call OData/RFC APIs on your licensed SAP system

**Your SAP License Agreement** (per Section 4)

Section 3(m) does not apply. Your license agreement governs. SAP licenses explicitly permit API access.

You test APIs in SAP's sandbox environment on api.sap.com

Section 3 (Website ToU)

For internal, non-productive, non-commercial evaluation only — standard sandbox terms.

An AI agent calls APIs on your own SAP system

**Your SAP License Agreement**

Section 3(m) has zero jurisdiction. Your SAP server, your license, your rules.

#### 🔑 The LinkedIn Post's Fundamental Error

The post reads Section 3(m) in isolation, ignoring that Section 3 itself defers to Section 4 for licensed products. Section 4 explicitly places licensed API usage under the **license agreement**, not the website Terms of Use. This is not a subtle distinction — it is the explicit structure of the document.

## 8 How C16 Connects to Customer Systems

C16 is an AI-powered SAP development and consulting platform. Here is the exact technical architecture of how C16 connects to a customer's SAP system:

┌──────────────────────────────────────────────────────────────┐ │ C16 PLATFORM │ │ │ │ ┌──────────────┐ ┌──────────────┐ ┌──────────────┐ │ │ │ AI Engine │ │ Data │ │ Document │ │ │ │ (Analysis) │ │ Investigation│ │ Generator │ │ │ └──────┬───────┘ └──────┬───────┘ └──────┬───────┘ │ │ │ │ │ │ │ └────────┬────────┘──────────────────┘ │ │ │ │ │ ┌────────▼────────────┐ │ │ │ SAP Connector │ │ │ │ RFC / ADT / OData │ │ │ └────────┬────────────┘ │ └──────────────────┼───────────────────────────────────────────┘ │ │ HTTPS (TLS 1.2+) │ Named SAP User (customer-provisioned) │ Basic Authentication │ SAP Authorization Framework (S\_RFC, S\_DEVELOP, etc.) │ ▼ NO CONNECTION TO api.sap.com │ ┌──────────────────▼───────────────────────────────────────────┐ │ CUSTOMER'S OWN SAP SYSTEM │ │ (On-Premise or Private Cloud — Customer's Infrastructure) │ │ │ │ SAP ICM (Internet Communication Manager) │ │ ├── /sap/bc/adt/\* → ADT REST (source code, deploy)│ │ ├── /sap/bc/soap/rfc → RFC via SOAP (table queries) │ │ ├── /sap/opu/odata/\* → OData Gateway (business data) │ │ └── /sap/bc/adt/zc16/\* → C16 Custom Class (deployment) │ │ │ │ ✅ Same interfaces used by: SAP GUI, Eclipse ADT, Fiori │ │ ✅ Full audit trail in: SM21, ST03N, Security Audit Log │ │ ✅ Governed by: Customer's SAP License Agreement │ └──────────────────────────────────────────────────────────────┘
...
C16 connects directly to the customer's SAP server via HTTPS. There is no intermediary, no SAP cloud relay, and no api.sap.com dependency in the data path.

**Named User Authentication**

Every C16 connection uses a customer-provisioned, named SAP user account with explicit role assignments. The customer controls which authorizations C16 has — no more, no less.

**Standard Protocols**

C16 uses RFC (via SOAP), ADT REST APIs, and OData V2 — the exact same protocols used by SAP GUI, Eclipse ADT, Fiori apps, and SAP's own Integration Suite. SAP cannot distinguish a C16 API call from a SAP GUI transaction.

**Customer Data Sovereignty**

All business data (vendor records, purchase orders, financial documents) remains on the customer's SAP server. C16 queries data in real-time — it does not extract, store, or replicate customer data.

**Full Auditability**

Every C16 action is logged in SAP's standard audit infrastructure (SM21 system log, ST03N workload statistics, Security Audit Log). The customer has complete visibility.

## 9 Point-by-Point Compliance Matrix

The following matrix maps every restriction in Section 3 of the SAP Business Accelerator Hub Terms of Use against C16's actual behavior. Each restriction is quoted directly from the document.

### Section 3(m) — Automated Data Gathering

Restriction (Exact Text)

Does C16 Do This?

Evidence

"use any automated data gathering or extraction methods \[...\] designed to **scrape or extract data from SAP Websites**"

NO — Compliant

C16 does not scrape api.sap.com. C16 connects to the customer's own SAP system via RFC/ADT/OData — entirely separate infrastructure.

"such as bots, scrapers, spiders, crawlers"

NO — Compliant

C16 is not a web crawler. It does not crawl or spider any SAP website. It makes authenticated, authorized API calls to a specific customer SAP endpoint.

"**Model Context Protocol (MCP)**"

NO — Compliant

C16 does not use MCP to access api.sap.com or any SAP website. C16's SAP connector uses direct HTTPS calls with Basic Authentication to the customer's SAP ICM server.

"**agent-frameworks**"

NO — Compliant

C16 does not use agent-frameworks to access api.sap.com. C16 is a purpose-built platform with its own SAP connector — it does not use LangChain, AutoGen, or similar frameworks to browse SAP websites.

"for text and data mining purposes or **artificial intelligence training, improvement or evaluation**"

NO — Compliant

C16 does not mine api.sap.com content for AI training. C16's AI engine is pre-trained on SAP domain knowledge. Customer data queried from the customer's own SAP system is used solely for real-time analysis on behalf of that customer — not for training.

"commercial data aggregation and/or **competitive analysis**"

NO — Compliant

C16 does not aggregate api.sap.com data for competitive analysis. C16 does not compete with api.sap.com — it is a development and consulting platform for SAP customers.

### Section 3(n) and 3(o) — Bulk Download and Redistribution
...
"bulk download \[...\] or make persistent copies of SAP Websites, SAP Materials and/or Content"

NO — Compliant

C16 does not bulk download from api.sap.com. EDMX metadata is read from the customer's own SAP Gateway service catalog, not from api.sap.com.

"cache, store or redistribute SAP Websites \[...\] including any data broker or AI provider"

NO — Compliant

C16 does not cache or redistribute api.sap.com content. C16 is not a data broker or AI provider that resells SAP documentation.

### Other Section 3 Restrictions (Comprehensive Check)
...
Copy, reverse-engineer the Website

Compliant

C16 does not reverse-engineer api.sap.com
...
C16 does not infringe SAP IP

(e)

Interfere with Website systems

Compliant

C16 does not interact with api.sap.com servers

(f)

Service bureau / time-sharing

N/A

Applies to the Website, not customer's SAP system
...
C16 uses proper Basic Auth to customer's SAP system

(i)

Use unauthorized APIs to access Website

Compliant

C16 does not access api.sap.com via unauthorized means
...
C16 complies with applicable laws
...
Customer-provisioned SAP credentials are AES-256 encrypted at rest

(l)

Benchmark SAP products

Compliant

C16 does not benchmark SAP products

(m)

Automated scraping / MCP / agent-frameworks

Compliant

Detailed analysis above — C16 does not scrape SAP Websites
...
C16 does not bulk download from api.sap.com

(o)

Cache/redistribute to AI providers

Compliant

C16 does not redistribute SAP Website content

### ✅ 15/15 Clauses — Fully Compliant

C16 is compliant with every restriction in Section 3 of the SAP Business Accelerator Hub Terms of Use.

## 10 SAP's Own AI Products Use the Same Pattern

If Section 3(m) truly prohibited AI agents from calling SAP APIs on licensed systems, SAP would have to discontinue its own flagship products. Here are SAP's own AI-powered products that make automated API calls:

SAP Product

What It Does

Uses Automated API Calls?

AI/ML Involved?

**SAP Joule**

SAP's generative AI copilot — reads and writes SAP data, generates code, processes natural language commands
...
Automated bots that execute business processes — create purchase orders, process invoices, manage approvals
...
Enterprise middleware that orchestrates automated API calls between SAP and non-SAP systems 24/7
...
AI-powered process mining that reads SAP transactional data to identify bottlenecks and optimize workflows
...
AI capabilities embedded across SAP applications — predictive analytics, intelligent recommendations, automated decisions
...
SAP's entire product strategy is built on AI agents calling SAP APIs. Their flagship AI product (Joule) is literally an agent-framework that programmatically calls SAP APIs. If Section 3(m) prohibited this, **SAP would have to shut down Joule first**. The clause prohibits scraping SAP's documentation website — not calling APIs on licensed systems.

## 11 Customer Assurance Statement

For SAP customers evaluating C16, the following assurances are provided:
...
All customer data remains on the customer's SAP system. C16 queries data in real-time and does not extract, store, or replicate business data outside the customer's control. Analysis results and documents are generated on-the-fly and delivered directly to the authorized user.

**Authentication & Authorization**

C16 connects using a customer-provisioned, named SAP user account. The customer controls all role assignments and authorizations. C16 recommends a least-privilege approach with specific roles (S\_RFC, S\_DEVELOP, S\_TABU\_NAM) — never SAP\_ALL.

**Standard Interfaces Only**

C16 uses exclusively SAP standard interfaces: RFC (via SOAP), ADT REST APIs, and OData V2/V4. These are the same interfaces used by SAP GUI, Eclipse ADT, Fiori apps, and SAP Integration Suite. No proprietary protocols, no kernel-level hooks, no database-level access.

**Clean Core Aligned**

C16's code analysis and generation follows SAP's Clean Core principles. C16 recommends released APIs, standard CDS views, and compliant extension patterns — actively moving customers toward SAP's recommended architecture.

**No AI Training on Customer Data**

Customer data queried during C16 sessions is used solely for real-time analysis on behalf of that customer. It is not used to train, improve, or evaluate C16's AI models. C16's AI is pre-trained on SAP domain knowledge — not on customer-specific data.

**Full Audit Trail**

Every action C16 performs on the customer's SAP system is logged in SAP's standard audit infrastructure: SM21 (system log), ST03N (workload statistics), and the Security Audit Log. Customers have complete visibility into all C16 activities.

**Credential Security**

SAP system credentials are encrypted at rest using AES-256-GCM. Credentials are never logged, never transmitted to third parties, and never used for any purpose other than connecting to the specific customer SAP system for which they were provisioned.

## 12 Frequently Asked Questions

Q1: Does SAP's policy prohibit AI tools from connecting to our SAP system?

**No.** The SAP Business Accelerator Hub Terms of Use (Section 3, clause m) prohibits automated scraping of the _api.sap.com documentation website_. It does not govern API calls to your own SAP system. Your SAP system is governed by your SAP license agreement (as stated in Section 4 of the same document), which explicitly permits programmatic API access. SAP's own AI products (Joule, Build Process Automation) use the same pattern.

Q2: The policy mentions "MCP" and "agent-frameworks" — isn't C16 an agent-framework?

**Context matters.** Section 3(m) mentions MCP and agent-frameworks as examples of technologies _"designed to scrape or extract data from SAP Websites."_ The restriction is about scraping _SAP's website_, not about the technology category itself. C16 is an SAP development platform that connects to your SAP system using standard RFC/ADT/OData interfaces — it does not scrape api.sap.com. The same way a car can be used to drive to a bank or to rob a bank — the tool itself is not the issue; the usage is. C16's usage is connecting to your own licensed system, not scraping SAP's website.

Q3: What about the claim that this is "Section 2.2.2"?

**There is no Section 2.2.2.** The SAP Business Accelerator Hub Terms of Use uses a flat numbering scheme (Sections 1 through 23). Section 2 is titled "Acceptance of Terms" and contains standard contract formation language. The relevant restriction is in Section 3, clause (m). The LinkedIn post's citation is verifiably incorrect — the author either misread the document, referenced a different document, or fabricated the section number.

Q4: How is C16 different from an AI agent that scrapes api.sap.com?

**Entirely different architecture.** A scraper would crawl api.sap.com pages to extract API documentation, Swagger files, and code samples. C16 does none of this. C16 connects directly to your SAP server using authenticated, authorized API calls — the same way SAP GUI connects. Your SAP server's ICM (Internet Communication Manager) cannot distinguish a C16 API call from a SAP GUI transaction or a Fiori app request. They are identical HTTPS requests with the same authentication.

Q5: Should we be concerned about SAP changing their policy to explicitly prohibit AI tools on customer systems?

**This would be self-defeating for SAP.** SAP's entire strategic direction (Clean Core, API-first, S/4HANA Cloud, Joule) is built on making SAP systems accessible via APIs. Prohibiting AI tools from calling customer-system APIs would: (1) break SAP's own products (Joule, Build Process Automation, Integration Suite), (2) contradict SAP's Clean Core strategy, (3) alienate the SAP partner ecosystem, and (4) drive customers to competing ERP platforms. There is no commercial or strategic rationale for such a change.

Q6: If SAP asks about C16's architecture, what should we say?

**Be transparent.** C16 connects to the customer's SAP system using standard SAP interfaces (RFC via SOAP, ADT REST APIs, OData V2/V4) with a customer-provisioned named user account. It follows SAP's Clean Core principles, recommends released APIs, and generates compliant code. It does not scrape api.sap.com, does not use MCP to access SAP websites, and does not train AI models on customer data. This document can be shared with SAP to demonstrate compliance.

## 13 Final Verdict

#### ❌ What Section 3(m) Prohibits

*   Automated scraping of api.sap.com
*   Using bots/MCP/agent-frameworks to extract data from SAP Websites
*   Mining SAP Website content for AI training
*   Bulk downloading API specifications
*   Caching/redistributing SAP Website content to AI providers

#### ✅ What C16 Actually Does

*   Connects to customer's own SAP server via RFC/ADT/OData
*   Uses customer-provisioned named SAP user with explicit authorizations
*   Employs same standard interfaces as SAP GUI, Eclipse, and Fiori
*   Reads business data from customer's tables (EKKO, LFA1, BSIK, etc.)
*   Deploys ABAP code via ADT abapGit — SAP's own development protocol

### ✅ VERDICT: FULLY COMPLIANT — NO POLICY CONFLICT

C16 does not interact with the SAP Business Accelerator Hub (api.sap.com) in any manner prohibited by Section 3, clause (m). C16 connects to the **customer's own SAP system** using **standard SAP interfaces** — the same protocols used by SAP GUI, Eclipse ADT, and SAP's own AI products. The SAP Business Accelerator Hub Terms of Use have **zero jurisdiction** over API calls made to the customer's own licensed SAP infrastructure.

Section 4 of the same document explicitly states: _"If You have a valid license agreement with SAP \[...\] Your use of the API Information related to that licensed product is subject to the terms of such license agreement."_ — The customer's SAP license governs, not the website Terms of Use.

## 14 Appendix — Source Document Reference
...
Terms of Use for SAP Business Accelerator Hub
...
**Access URL (SAP Help Portal)**

`https://help.sap.com/docs/SAP_BUSINESS_ACCELERATOR_HUB` → Terms of Use

**Access URL (Direct on api.sap.com)**

`https://api.sap.com` → Footer → "Terms of Use"

**Access URL (SAP Legal)**

`https://www.sap.com/about/legal/terms-of-use.html` (general SAP website terms)

**Relevant Sections**

Section 1 (Scope — defines "Website"), Section 3 (General Use — clause m), Section 4 (API Information — licensed product clause)

**Total Sections**

23 (flat numbering, no sub-subsections)

**Document Structure**

Sections 1–23, lettered sub-clauses (a) through (o) within Section 3

#### 📋 Recommendation for Legal Records

Since SAP's Terms of Use is a living document (updated without version history or changelog), we recommend:

*   **Screenshot the current version** of the Terms of Use page when you access it
*   **Save as PDF** with the access date noted in the filename
*   **Use the Wayback Machine** (`web.archive.org`) to verify historical versions if the document changes
*   **Note the "Last Updated" date** shown at the top of the document (currently: October 8, 2025)

**C16 — SAP API Policy Compliance Brief v2.0**

Document generated: 01 May 2026 | Based on: SAP Business Accelerator Hub Terms of Use (Last Updated: 08 Oct 2025)

This document is based on direct analysis of the published SAP Business Accelerator Hub Terms of Use. All quotations are from the source document. This document does not constitute legal advice. Organizations should consult their legal counsel for formal compliance determinations.

**Classification:** Non-Confidential — Approved for sharing with SAP, customers, and partners.

**Document ID:** C16-COMPLIANCE-2026-002-v2
